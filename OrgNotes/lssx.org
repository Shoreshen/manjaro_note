...
集合论语言为[[~/OneDrive/数理逻辑/sllj.org::MK104][一阶语言]]，除[[~/OneDrive/数理逻辑/sllj.org::MK105][固定符号]]外尤其仅有一个[[~/OneDrive/数理逻辑/sllj.org::MK110][谓词符号]] $\mathcal{A}_c=\{p_\in\}$ 其中根据[[~/OneDrive/数理逻辑/sllj.org::MK112][符号假定]]有 $\pi_P(p_\in)=2$
...
集合论的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]均遵循以上简写

*** 等式符号

语言规定[[~/OneDrive/数理逻辑/sllj.org::MK105][等式符号]] $\hat{=}$ 必须满足[[MK132][等价关系]]，由[[MK2][外延公理]]定义
...
其中 $n\in\mathbb{N}$ 是自然数， $\phi(p_1,...,p_n,x)$ 是[[~/OneDrive/数理逻辑/sllj.org::MK140][自由变元]]为 $p_1,...,p_n,x$ 且不包含 $U,S$ 的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]
...
设 $x$ 为一个集合 $\phi(a_1,...,a_n,z)$ 是[[~/OneDrive/数理逻辑/sllj.org::MK140][自由变元]]为 $a_1,...,a_n,z$ 且不包含 $x$ 的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]

则当 $a_1,...,a_n$ [[~/OneDrive/数理逻辑/sllj.org::MK154][赋值]]确定时，存在唯一的 $y$ 满足 $\forall z((z\in y)\leftrightarrow((z\in x)\land(\phi(a_1,...,a_n,z))))$
...
显然 $\lnot(z=z)$ 是[[MK1][集合论语言]]的合法[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]，则根据[[MK3][第一存在]]可得有集合 $x$
...
则对于[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]] $\forall x((x\in\varnothing)\leftrightarrow (x\in y))$ 来说对于任意 $x$ 均有 $x\in\varnothing$ 与 $x\in y$ 均不成立
...
当 $A=B$ 时，根据[[~/OneDrive/数理逻辑/sllj.org::MK9][外延公理]]，[[~/OneDrive/数理逻辑/sllj.org::MK49][等价等值式]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]有：
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK37][蕴含传递]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]有：
...
对于任意集合 $A$ ，都存在 $A\in U$ 其中 $U$ 为[[~/OneDrive/数理逻辑/sllj.org::MK118][全总域]]
...
显然，在已知 $X$ 表达式的情况下 $X$ 的滤子可用[[~/OneDrive/数理逻辑/sllj.org::MK129][一阶表达式]]描述
...
由于 $n<\infty$ 故可得 $|\phi_n(A)|<\infty$ 故已知 $A$ 的情况下 $\phi(A)$ 是[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]
...
定义 $\phi(A)$ 为 $A$ 是 $X$ 的[[MK36][滤子]]的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]，则定义 $D=\left\{E\big|E\in\rho(X)\land F\subset E\land \phi(E)\right\}$
...
利用[[~/OneDrive/数理逻辑/sllj.org::MK129][谓词公式定义]]描述集合中的元素。

例如 $A=\left\{x\big|P(x)\right\}$ 或 $A=\left\{x\big:P(x)\right\}$ 

定义为当且仅当[[~/OneDrive/数理逻辑/sllj.org::MK129][谓词公式]] $P(x)=1$ 时，有 $x\in A$ 即 $\forall x(P(x)\leftrightarrow x\in A)=1$ 。
...
若集合 $A$ 以[[MK51][归纳定义]]，若 $P(x)$ 是[[~/OneDrive/数理逻辑/sllj.org::MK129][谓词公式]]其中 $x$ 是命题变元。要证明 $\forall x(x\in A\rightarrow P(x))$ 仅需证明：
...
假设集合 $A$ 有[[MK51][归纳定义]]，[[~/OneDrive/数理逻辑/sllj.org::MK129][谓词公式]] $P$ 且两个条件均成立，即：
...
显然 $\forall c((c\in C)\rightarrow (x\in c))$ 是[[MK1][集合论语言]]的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]，又根据[[MK9][并集公理]]可得 $\bigcup C$ 存在
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK45][交换率]] $(\forall\lambda\in\Lambda\rightarrow x\not\in C_\lambda)\land x\in A$

根据[[~/OneDrive/数理逻辑/sllj.org::MK183][辖域变化]] $\forall\lambda\in\Lambda\rightarrow (x\not\in C_\lambda\land x\in A)$ 即有 $\forall\lambda\in\Lambda\rightarrow (x\in(A-C_\lambda))$  
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK47][分配率]]，[[MK49][描述法定义]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $x$
...
根据[[MK68][可数性质]]、[[~/OneDrive/数理逻辑/sllj.org::MK183][辖域变化]]、[[MK70][交换律]]以及[[MK57][运算定义]]
...
则根据[[MK45][成员定义]]，[[~/OneDrive/数理逻辑/sllj.org::MK186][德摩根律]]，[[~/OneDrive/数理逻辑/sllj.org::MK47][分配率]]，[[MK49][描述法定义]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $x$
...
根据[[MK45][成员定义]]，[[MK49][描述法定义]]，[[~/OneDrive/数理逻辑/sllj.org::MK186][德摩根律]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $x$
...
根据[[MK68][可数性质]]、[[MK57][运算定义]]、[[~/OneDrive/数理逻辑/sllj.org::MK48][蕴含等式]]、[[~/OneDrive/数理逻辑/sllj.org::MK186][德摩根律]]、[[~/OneDrive/数理逻辑/sllj.org::MK182][量词转换]]可得
...
**** [[~/OneDrive/数理逻辑/sllj.org::MK106][量词]]与运算<<MK80>>
...
即 $f$ 是 $(B\times\mathbb{N})\to A$ 的[[MK176][单射函数]]的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]。定义 $F=\left\{f\big|(\text{IsFunc}(f,B)\land B\subset A)\right\}$
...
即 $f$ 是 $A$ 到 $A\times A$ 的[[MK181][双射函数]]的[[~/OneDrive/数理逻辑/sllj.org::MK129][表达式]]，定义 $Y=\left\{f\big|A\subset X\land\text{IsFunc}(f,A)\right\}$
...
进一步根据[[~/OneDrive/高等代数/Algb-4-Multi-equ.org][因式、可约与根-根-根的个数]]可知 $f(x)$ 至多有 $n$ 个根，故 $\sigma$ 是[[MK179][满射]]
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK186][德摩根律]]、[[~/OneDrive/数理逻辑/sllj.org::MK47][分配率]]以及[[~/OneDrive/数理逻辑/sllj.org::MK45][交换律]]
...
此时当 $\exists y(xRy\land ySz)=1$ 根据[[~/OneDrive/数理逻辑/sllj.org::MK1][连词定义]]可得 $x\in A=1,z\in C=1$ 且 $\exists y(y\in B\land xRy\land ySz)=1$
...
故根据[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]以及[[MK49][描述法]]定义 $R\cdot S=\left\{<x,y>\big|\exists y(xRy\land ySz)\right\}$
...
根据[[MK118][定义]]，[[MK58][并运算]]，[[MK61][B不包含x]]，[[~/OneDrive/数理逻辑/sllj.org::MK45][交换律]]，[[~/OneDrive/数理逻辑/sllj.org::MK46][结合律]]，[[~/OneDrive/数理逻辑/sllj.org::MK47][分配率]]，[[~/OneDrive/数理逻辑/sllj.org::MK183][辖域变化]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]对于任意 $<x,y>$
...
根据[[MK118][定义]]以及[[MK117][逆]]运算，[[~/OneDrive/数理逻辑/sllj.org::MK3][交换律]]，[[~/OneDrive/数理逻辑/sllj.org::MK46][结合律]]对于任意 $<x,y>$
...
根据[[MK119][推论]]，[[MK118][关系定义]]，[[~/OneDrive/数理逻辑/sllj.org::MK185][量词交换]]，[[~/OneDrive/数理逻辑/sllj.org::MK183][辖域变化]]，[[~/OneDrive/数理逻辑/sllj.org::MK3][交换律]]，[[~/OneDrive/数理逻辑/sllj.org::MK46][结合律]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]对于任意 $<x,y>$
...
传递关系<<MK128>>：   $\forall x\forall y\forall z(\{x,y,z\}\subset A\land xRy\land yRz\rightarrow xRz)$ 
                    ...
                    又根据[[~/OneDrive/数理逻辑/sllj.org::MK114][量词顺序]] $\forall x\forall y\forall z(xRy\land yRz\rightarrow xRz){|\!\!\!=\!\!\!|}\forall x\forall z\forall y(xRy\land yRz\rightarrow xRz)$
...
当 $R\cap R\sim\subset E_A$ 时，根据[[MK117][逆运算]]，[[MK60][交运算]]，[[MK15][子集定义]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]对于任意 $<x,y>$
...
同理可证若 $x\in[b]_R\rightarrow x\in[a]_R$ 根据[[~/OneDrive/数理逻辑/sllj.org::MK49][等价等值式]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $x$ 有 $x\in[b]_R\leftrightarrow x\in[a]_R=1$
...
同理可证 $\forall y(y\in[b]_R\rightarrow y\in[a]_R)$ 故根据[[~/OneDrive/数理逻辑/sllj.org::MK49][等价等值式]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $y$ 有 $y\in[b]_R\leftrightarrow y\in[a]_R=1$
...
进一步根据[[~/OneDrive/数理逻辑/sllj.org::MK39][等价传递]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]有 $\forall x(x\in A\leftrightarrow x\in\cup\pi)$
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK49][等价等值式]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $b$ 均有 $b\in B\leftrightarrow b\in[a]_R$
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK49][等价等值式]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $x$ 均有 $xRy\leftrightarrow xR'y$ 
...
根据[[~/OneDrive/数理逻辑/sllj.org::MK46][结合律]]，[[MK58][并运算]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]，对于任意 $y$
...
根据[[MK188][逆函数定义]]，[[~/OneDrive/数理逻辑/sllj.org::MK45][交换律]]以及[[~/OneDrive/数理逻辑/sllj.org::MK40][替换原理]]可得对于任意 $<z,x>\in (f\cdot g)^{-1}$ 均有
...
即 $G\not\in\mathcal{H}\rightarrow \exists v\in V\left(d(v)<\frac{p}{2}\right)$ 则根据[[~/OneDrive/数理逻辑/sllj.org::MK182][量词转换]]以及[[~/OneDrive/数理逻辑/sllj.org::MK53][假言易位]]有：
...
除[[~/OneDrive/数理逻辑/sllj.org::MK105][固定符号]]外有：

（1） [[~/OneDrive/数理逻辑/sllj.org::MK109][函数符号]] $f_\times,f_+$ 分别表示乘法，加法

（3） [[~/OneDrive/数理逻辑/sllj.org::MK108][常元符号]] $c_0$

则有 $\mathcal{A}_\mathcal{R}=\{f_\times,f_+,c_0\}$ 进一步有 $\mathcal{L}_{\mathcal{A}_\mathcal{R}}$ 是环理论的[[~/OneDrive/数理逻辑/sllj.org::MK151][语言]]
...
对于任意 $\mathcal{L}_{\mathcal{A}_\mathcal{R}}$ 的[[~/OneDrive/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M}=\left<M,I\right>$ 及其[[~/OneDrive/数理逻辑/sllj.org::MK154][赋值]] $v$ 若满足 $\left<\mathcal{M},v\right>\vDash(\forall x_2(f_+(x_1,x_2)\hat{=}x_2))$

则对于其[[~/OneDrive/数理逻辑/sllj.org::MK154][赋值]] $v^*$ 满足 $v^*(x_2)=I(c_0),v^*(x_1)=v(x_1)$ 根据[[~/OneDrive/数理逻辑/sllj.org::MK158][满足]]有 $\left<\mathcal{M},v^*\right>\vDash(f_+(x_1,x_2)\hat{ =}x_2)$

根据[[~/OneDrive/数理逻辑/sllj.org::MK158][满足]] $v^*(x_1)=I(f_+)(v^*(x_1),v^*(x_2))$

根据[[MK334][公理（3）]]有 $\left<\mathcal{M},v^*\right>\vDash(f_+(x_1,x_2)\hat{=}x_1)$ 且 $\left<\mathcal{M},v^*\right>\vDash(x_1\hat{ =}f_+(x_1,x_2))$   

根据[[~/OneDrive/数理逻辑/sllj.org::MK158][满足]] $I(f_+)(v^*(x_1),v^*(x_2))=v^*(x_2)=I(c_0)$

即有 $v^*(x_1)\hat{=}I(c_0)$ 根据[[~/OneDrive/数理逻辑/sllj.org::MK158][满足]] $\left<\mathcal{M},v^*\right>\vDash(x_1\hat{ =}c_0)$ 又根据 $v^*(x_1)=v(x_1)$ 以及[[~/OneDrive/数理逻辑/sllj.org::MK168][局部确定]] $\left<\mathcal{M},v\right>\vDash(x_1\hat{ =}c_0)$

综上所述，对于任意 $\mathcal{L}_{\mathcal{A}_\mathcal{R}}$ 的[[~/OneDrive/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M}=\left<M,I\right>$ 及其[[~/OneDrive/数理逻辑/sllj.org::MK154][赋值]] $v$ 若 $\left<\mathcal{M},v\right>\vDash(\forall x_2(f_+(x_1,x_2)\hat{=}x_2))$

则 $\left<\mathcal{M},v\right>\vDash(x_1\hat{ =}c_0)$ ，则显然 $\left<\mathcal{M},v\right>\vDash((\forall x_2(f_+(x_1,x_2)\hat{ =}x_2))\to(x_1\hat{ =}c_0))$

又根据 $v$ 的任意性以及[[~/OneDrive/数理逻辑/sllj.org::MK158][满足]]有 $\left<\mathcal{M},v\right>\vDash(\forall x_1((\forall x_2(f_+(x_1,x_2)\hat{ =}x_2))\to(x_1\hat{ =}c_0)))$

综上所述，对于任意 $\mathcal{L}_{\mathcal{A}_\mathcal{R}}$ 的[[~/OneDrive/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M}=\left<M,I\right>$ 及其[[~/OneDrive/数理逻辑/sllj.org::MK154][赋值]] $v$

均有 $\left<\mathcal{M},v\right>\vDash(\forall x_1((\forall x_2(f_+(x_1,x_2)\hat{ =}x_2))\to(x_1\hat{ =}c_0)))$

故根据[[~/OneDrive/数理逻辑/sllj.org::MK255][完备性]]有 $T_\mathcal{R}\vdash(\forall x_1((\forall x_2(f_+(x_1,x_2)\hat{=}x_2))\to(x_1\hat{ =}c_0)))$
...
（1） [[~/OneDrive/数理逻辑/sllj.org::MK109][函数符号]] $f_\times,f_+,f_-$ 分别表示乘法，加法

（3） [[~/OneDrive/数理逻辑/sllj.org::MK108][常元符号]] $c_0,c_1$

则有 $\mathcal{A}_\mathbb{F}=\{f_\times,f_+,f_-,c_0,c_1\}$ 进一步有 $\mathcal{L}_{\mathcal{A}_\mathcbb{F}}$ 是环理论的[[~/OneDrive/数理逻辑/sllj.org::MK151][语言]]
...
同[[MK333][域语言]] $\mathcal{A}_\mathbb{F}=\{f_\times,f_+,f_-,c_0,c_1\}$ 为区分记作 $\mathcal{A}_{\text{ACF}}$ 即有 $\mathcal{L}_{\mathcal{A}_{\text{ACF}}}$ 是代数封闭域的[[~/OneDrive/数理逻辑/sllj.org::MK151][语言]

**** 多项式<<MK336>>

定义：

（1） $\tau^n$ 为[[~/OneDrive/数理逻辑/sllj.org::MK117][项]] $f_\times(\tau,f_\times(\tau,f_\times(...f_\times(\tau,\tau)...)))$ 即 $n$ 个 $\tau$ 相乘，其中 $\tau$ 亦为[[~/OneDrive/数理逻辑/sllj.org::MK117][项]]

（2） $\sum_{i=a}^{a+b}{\tau_i}$ 为[[~/OneDrive/数理逻辑/sllj.org::MK117][项]] $f_+(\tau_a,f_+(\tau_{a+1},f+(...f_+(\tau_{a+(b-1)},\tau_{a+b})...)))$

     即为 $\tau_a$ 到 $\tau_{a+b}$ 的连加，其中 $\tau$ 亦为[[~/OneDrive/数理逻辑/sllj.org::MK117][项]]
