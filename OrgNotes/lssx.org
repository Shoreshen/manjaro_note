...
定义 $\mathbb{Z}_p=\left<Z_p,I_p\right>$
...
******** 定义[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathbb{Z}_0=\left<\mathbb{Z},J\right>$ 

定义 $\mathbb{Z}_0=\left<\mathbb{Z},J\right>$ 其中 $\mathbb{Z}$ 是整数 $J$ 满足：
...
易证 $\mathbb{Z}_0$ 是 $\mathcal{L}_{\mathcal{A}_{\text{ACF}}}$ 下的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]]

******** 证明是[[~/文档/note/数理逻辑/sllj.org::MK460][极小结构]]

对于任意[[MK390][代数封闭域]] $\mathcal{M}=\left<M,I\right>$ 定义映射 $e:\mathbb{Z}\to M$ 满足对于任意 $a\in\mathbb{Z}$ 有：
...
根据[[MK416][推论]]可得 $\mathcal{T}_{\test{ACF}_0}$ 适合[[~/文档/note/数理逻辑/sllj.org::MK397][量词消去]]，根据上一步证明可得亦存在[[~/文档/note/数理逻辑/sllj.org::MK460][极小结构]]

则根据[[~/文档/note/数理逻辑/sllj.org::MK484][定理3]]可得 $\mathcal{T}_{\test{ACF}_0}$ 是[[~/文档/note/数理逻辑/sllj.org::MK264][完全理论]]
     
******* $p\ne 0$

******** [[MK417][ $\mathbb{Z}_p$ ]]是[[~/文档/note/数理逻辑/sllj.org::MK460][极小结构]]

对于任意[[MK390][代数封闭域]] $\mathcal{M}=\left<M,I\right>$ 定义映射 $e:Z_p\to M$ 满足对于任意 $a\in\mathbb{Z}$ 有：
...
根据[[MK416][推论]]可得 $\mathcal{T}_{\test{ACF}_p}$ 适合[[~/文档/note/数理逻辑/sllj.org::MK397][量词消去]]，根据上一步证明可得亦存在[[~/文档/note/数理逻辑/sllj.org::MK460][极小结构]]

则根据[[~/文档/note/数理逻辑/sllj.org::MK484][定理3]]可得 $\mathcal{T}_{\test{ACF}_p}$ 是[[~/文档/note/数理逻辑/sllj.org::MK264][完全理论]]
