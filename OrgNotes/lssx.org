...
（1） 根据[[MK430][性质1]]可得 $p$ 是素数根据[[MK419][定理3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是 $\mathcal{M},\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（2） 根据[[~/文档/note/数理逻辑/sllj.org::MK312][定理]]可得存在 $\mathcal{M}'=\left<M',I'\right>,\mathcal{N}' =\left<N',J'\right>$ 分别是 $\mathcal{M},\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]且与[[MK417][ $\mathbb{Z}_p$ ]]有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
显然由于 $\mathcal{M}',\mathcal{N}'$ 均与[[MK417][ $\mathbb{Z}_p$ ]]有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，故可得 $\mathcal{M}',\mathcal{N}'$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，由于是[[MK438][超越基]]，故[[MK445][代数无关]]
