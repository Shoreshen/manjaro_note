...
即显然 $\left[\frac{e^{-1}(b_1)}{e^{-1}(b_2)}\right]_\sim\in M_{[\div]}$ 即 $e^*$ 是[[MK179][满射]]
...
若有[[MK344][同态]]映射 $e$ 且为[[MK181][双射]]，则 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]
...
若 $\mathcal{M}=\left<M,I\right>$ 是 $\mathcal{N}=\left<N,J\right>$ 的[[MK341][子域]]满足：

（1） 有 $S\subset N$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]

（2） 有 $S'\subset N$ 满足在 $\mathcal{M}_{(S)}=\left<M_{(S)},I_{(S)}\right>$ 上[[MK445][代数无关]]

则 $S\cup S'$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]

********* 证明

********** 假设 $S\cup S'$ [[MK445][代数相关]]

假设在 $\mathcal{M}$ 上[[MK445][代数相关]]，则显然存在：

（1） $\{s_1,...,s_n\}\subset S\cup S'$

（2） 关于 $\vec{x}=\left<x_1...,x_n\right>$ 在 $\mathcal{M}$ 上的[[MK436][多项式]] $f(\vec{x})=\sum_{i\in P}\left(a_i\left(\prod_{j\in K_i}x_j^{k_{i,j}}\right)\right)\in M[\vec{x}]$

使得 $f(s_1,...,s_n)=J(c_0)$ 且 $f(\vec{x})\ne I[\vec{x}](c_0)$ 。不妨设 $f(\vec{x})$ 是[[MK446][最简式]]

由于 $S$ 在 $\mathcal{M}$ 上[[MK445][代数相关]]，故显然存在 $\{s_1,...,s_n\}\not\subset S$ 即存在 $\{s_{i_1},...,s_{i_m}\}= S'\cap\{s_1,...,s_n\}$

********** 定义 $f'(\vec{x}),f^*(\vec{x})$

（1） $S^*=\{i_1,...,i_m\}$

（1） $P^*=\left\{i\in P\big|K_i\cap S^*=\varnothing\right\}$

（2） $f'(\vec{x})=\sum_{i\in P-P^*}\left(\left(a_i\left(\prod_{j\in K_i-S^*}s_j^{k_{i,j}}\right)\right)\left(\prod_{j\in K_i\cap S^*}x_j^{k_{i,j}}\right)\right)+\sum_{i\in P^*}a_i\left(\prod_{j\in K_i}s_j^{k_{i,j}}\right)$

显然 $f'(\vec{x})\in M_{(S)}[\vec{x}]$ 又定义 $f^*(\vec{x})=\sum_{i\in P}\left(a_i\left(\prod_{j\in K_i-S^*}x_j^{k_{i,j}}\right)\right)\in M[\vec{x}]$

********** 证明 $f'(\vec{x})\ne I_{(S)}[\vec{x}](c_0)$ 或 $f^*(\vec{x})\ne I[\vec{x}](c_0)$

假设 $f'(\vec{x})=I_{(S)}[\vec{x}](c_0)$ 且 $f^*(\vec{x})=I[\vec{x}](c_0)$ 则 $f^*(\vec{x})$ 的[[MK446][最简式]]为 $I(c_0)$ ，

对于任意 $i\in P$ 定义 $I_{i}=\left\{p\big|p\in P\land (K_p-S^*)=(K_i-S^*)\land\left(\forall j\in K_i-S^*\left(k_{i,j}=k_{p,j}\right)\right)\right\}$ 

则显然有 $a'_{i}=\sum_{p\in I_{i}}a_p=I(c_0)$ 又由于 $f(\vec{x})$ 是[[MK446][最简式]]，故可得任意 $a_p\ne I(c_0),p\in P$

故可得对于任意 $i\in P$ 必有 $|I_i|>1$ 。

又由于 $f'(\vec{x})=I_{(S)}[\vec{x}](c_0)$ 则对于任意 $i\in P-P^*$ 可定义 $I'_{i}=\left\{p\big|p\in P-P^*\land (K_p\cap S^*)=(K_i\cap S^*)\land\left(\forall j\in (K_i\cap S^*)\left(k_{i,j}=k_{p,j}\right)\right)\right\}$

同理可得对于任意 $i\in P-P^*$ 必有 $a^*_{i}=\sum_{p\in I'_{i}}a_p\left(\prod_{j\in K_i-S^*}s_j^{k_{i,j}}\right)=I_{(S)}(c_0)$ 以及 $|I'_i|>1$ 。

若存在 $i\in P-P^*$ 满足 $|I'_i\cap I_i|>1$ 则对于任意 $p\in I_i\cap I'_i$ 均有 $K_p\cap S^*=K_i\cap S^*,K_p-S^*=K_i-S^*$ 显然 $K_p=K_i$

结合 $|I'_i\cap I_i|>1$ 易证与 $f(\vec{x})$ 是[[MK446][最简式]]矛盾

若不存在 $i\in P-P^*$ 满足 $|I'_i\cap I_i|>1$ ，则任取 $i\in P-P^*$ 则有 $|I'_i\cap I_i|=1$ 以及 $\sum_{p\in I'_{i}}a_p\left(\prod_{j\in K_i-S^*}s_j^{k_{i,j}}\right)=I_{(S)}(c_0)$

定义 $g(\vec{x})=\sum_{p\in I'_{i}}a_p\left(\prod_{j\in K_i-S^*}x_j^{k_{i,j}}\right)\in M[\vec{x}]$ 显然有 $i\in I_i,i\in I'_i$ 又根据 $|I'_i\cap I_i|=1$ 可得对于任意 $z\in I'_i-i$

根据 $I_i$ 定义均有 $(K_p-S^*)\ne(K_i-S^*)$ 或 $(K_p-S^*)=(K_i-S^*)\land (\exists j\in K_p-S^*(k_{i,j}=k_{z,j}))$

又 $f(\vec{x})$ 是[[MK446][最简式]]，故可得任意 $a_i\ne I(c_0)$ ，故根据[[MK473][生成步骤]]以及[[MK437][唯一性]]易证 $g(\vec{x})\ne I[\vec{x}](c_0)$

又根据 $\sum_{p\in I'_{i}}a_p\left(\prod_{j\in K_i-S^*}s_j^{k_{i,j}}\right)=I_{(S)}(c_0)$ 显然可得 $g(\vec{x})$ 的[[MK441][带入值]]为 $I_{(S)}(c_0)$ 又由于 $\{s_1,...,s_n\}-\{s_{i_1},...,s_{i_m}\}\subset S$

故与 $S$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]矛盾，故假设不成立，即 $f'(\vec{x})\ne I_{(S)}[\vec{x}](c_0)$ 或 $f^*(\vec{x})\ne I[\vec{x}](c_0)$

********** 推出矛盾

若 $f'(\vec{x})\ne I_{(S)}[\vec{x}](c_0)$ ，则显然与 $S'$ 满足在 $\mathcal{M}_{(S)}$ 上[[MK445][代数无关]]矛盾

若 $f'(\vec{x})=I_{(S)}[\vec{x}](c_0)$ 且 $f^*(\vec{x})\ne I[\vec{x}](c_0)$ 则根据[[MK437][定理]]可得对于任意 $\{z_1,...,z_n\}\subset N$ 均有 $f'(z_1,...,z_n)=J(c_0)$

进一步定义 $z_i=\begin{cases}s_i&i\not\in S^*\\J(c_1)&i\in S^*\end{cases}$ 则显然有 $f^*(a_1,...,a_n)=\sum_{i\in P}\left(a_i\left(\prod_{j\in K_i-S^*}z_j^{k_{i,j}}\right)\right)$

显然对于任意 $s_i,i\not\in S^*$ 有 $s_i\in S$ 且 $J*(c_1)=I(c_1)\in M$ ，则易证与 $S$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]矛盾

综上所述，假设不成立，即 $S\cup S'$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]
...
（2） 有 $S'\subset N$ 满足在 $\mathcal{M}_{(S)}=\left<M_{(S)},I_{(S)}\right>$ 上[[MK445][代数相关]]且 $S'\cap S=\varnothing$

则 $S\cup S'$ 在 $\mathcal{M}$ 上[[MK445][代数相关]]
...
满足 $f(s_1,...,s_n)=J(c_0)$ 且 $f(\vec{x})\ne I_{(S)}[\vec{x}](c_0)$ 根据[[MK445][定理2]]可得对于任意 $a_i$ 存在：
...
定义 $\vec{z}^*=\left<z_1,...,z_{n''},z_{n''+1},...,z_{n''+n}\right>$ 以及 $\vec{s}''=\left<s''_1,...,s''_{n''},s_1,...,s_n\right>$ 则扩展未知数后易证 $\left\{f_i^*(\vec{z}),g_i^*(\vec{z})\big|i\in P\right\}\subset M[\vec{z}]$

以及 $f^*_i(\vec{s}'')=f_i(s''_{\phi(i,1)},...,s''_{\phi(i,n_i)})=f_i(s_{i,1},...,s_{i,n_i}),g^*_i(\vec{s}'')=g_i(s''_{\phi'(i,1)},...,s''_{\phi'(i,m_i)})=g_i(s'_{i,1},...,s'_{i,m_i})$
...
即任意[[MK441][带入值]] $f(\vec{v}')=J(c_0)$ ，根据[[MK439][多项式环]]可得 $\mathcal{M}_{(S')}[x]$ 是[[MK362][非零幺环]]且满足乘法交换律，则根据[[MK301][性质]]可得乘法零元唯一

故易证 $f(\vec{x})=I_{(S)}[\vec{x}](c_0)$ 与 $f(\vec{x})\ne I_{(S)}[\vec{x}](c_0)$ 矛盾

故假设不成立，即 $f^*(\vec{z})\ne I_{(S)}[\vec{z}](c_0)$ 又由于 $\left\{f_i^*(\vec{z}),g_i^*(\vec{z})\big|i\in P\right\}\subset M[\vec{z}]$ 故根据加乘法封闭易证 $f^*(\vec{z})\in M[\vec{z}]$

********** 证明矛盾

综上所述，有 $f^*(\vec{s}'')=J(c_0)$ 且 $f^*(\vec{z})\in M[\vec{z}],f^*(\vec{z})\ne I_{(S)}[\vec{z}](c_0)$ 即 $S\cup S'$ 在 $\mathcal{M}$ 上[[MK445][代数相关]]，与假设矛盾

故假设不成立，即 $S\cup S'$ 在 $\mathcal{M}$ 上[[MK445][代数相关]]
...
（2） 若 $K\ne\varnothing$ 则超越基为 $K$ 的[[MK144][极大]]的[[MK445][代数无关]]子集
...
若 $K\ne\varnothing$ 则定义 $\rho'(K)$ 为 $K$ 上所有的[[MK445][代数无关]]子集的集合，定义 $L=\left<\rho'(K),\subset\right>$ 为 $\rho'(K)$ 上关于 $\subset$ 的[[MK143][偏序关系]]

则对于 $L$ 上的任意[[MK153][链]] $T$ 定义 $t^*=\bigcup_{t\in T}t$ 显然 $t^*$ 中所有元素均为 $\mathcal{M}$ 上的[[MK395][代数元]]，即 $t^*\subset K$

又根据 $T$ 是[[MK153][链]]，任意 $t\in T\subset \rho'(K)$ [[MK445][代数无关]]，则根据[[MK450][性质1]]可得 $t^*$ [[MK445][代数无关]]，即 $t^*\in\rho'(K)$

又根据 $t^*$ 定义可得对于任意 $t\in T$ 均有 $t\subset t^*$ 。即 $t^*$ 是 $T$ 的[[MK145][上界]]

又根据 $T$ 的任意性以及[[MK162][佐恩引理]]可得存在 $\rho'(K)$ 上的[[MK144][极大元]]，即为[[MK438][超越基]]
...
则根据[[MK476][性质2]]可得 $S\cup\{a\}$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]，即与 $S$ 的[[MK144][极大性]]矛盾
...
任意 $\mathcal{M}=\left<M,I\right>$ 是 $\mathcal{N}=\left<N,J\right>$ 的[[MK341][子域]]，则 $\mathcal{N}$ 在 $\mathcal{M}$ 上的任意[[MK438][超越基]]均[[MK29][等势]]
...
设[[MK438][超越基]]为 $S$ 是[[MK83][无限]]集，对于任意其他一组[[MK438][超越基]] $T$ 根据上一步证明可得 $T$ 亦为[[MK83][无限]]集
...
根据[[MK477][最小性]]易证必有 $T\subset\bigcup_{s\in S}T_s$ 根据[[MK16][自反性]]可得 $T=\bigcup_{s\in S}T_s$

*********** 定义 $T'_s$ 证明 $\bigcup_{s\in S}T'_s= T$ <<MK479>>

根据[[MK171][良序定理]]定义[[MK171][良序关系]] $\left<S,<\right>$ 对于任意 $s\in S$ 定义 $T'_s=T_s-\bigcup_{s'<s\land s'\in S}T_{s'}$

对于任意 $t\in T=\bigcup_{s\in S} T_s$ 存在非空 $S'\subset S$ 满足对于任意 $s\in S'$ 均有 $t\in T_s$

由于是[[MK171][良序关系]]，则存在[[MK144][最小元]] $s^*$ 进而有对于任意 $s'\in S$ 若有 $s'<s^*$ 则有 $s'\not\in S'$ 即 $t\not\in T_{s'}$

即可得 $t\in T_{s^*}-\bigcup_{s'<s^*\land s'\in S}T_{s'}$ 即有 $t\in T'_s$ ，则有 $T\subset\bigcup_{s\in S}T'_s$ ，显然有 $\bigcup_{s\in S}T'_s\subset T$

进而根据[[MK16][自反性]]可得 $\bigcup_{s\in S}T'_s= T$ 又根据第一步 $|T_s|<\infty$ 且显然 $T'_s\subset T_s$ 故可得 $|T'_s|<\infty$

*********** 任意 $t\in T$ 存在唯一 $s\in S$ 满足 $t\in T'_s$

根据上一步证明存在 $T'_s$ 满足 $t\in T'_s$ ，对于任意 $s'\in S$ 由于 $\left<S,<\right>$ 是[[MK171][良序关系]]，故为[[MK170][全序集]]
...
综上所述，对于任意 $\{t_1,t_2\}\subset T$ 满足 $t_1\ne t_2$ 均有 $\phi(t_1)\ne\phi(t_2)$ 即 $\phi$ 是[[MK176][单射]]

则根据[[MK29][等势]]可得 $|T|\leq|S\times\mathbb{N}|$ ，由于 $S$ 是[[MK83][无限]]集，则根据[[MK329][推论]]可得 $|\mathbb{N}|\leq|S|$

又根据[[MK422][推论]]可得 $|S\times\mathbb{N}|=\max(|S|,|\mathbb{N}|)=|S|$ 则根据[[MK327][定理6]]可得 $|T|\leq|S|$ 

*********** 证明 $|T|=|S|$ 

根据上面步骤同理可证 $|S|\leq|T|$ ，则根据[[MK34][伯恩斯坦定理]]可得 $|T|=|S|$ [[MK29][等势]]
...
（2） 有 $S_1,S_2$ 分别是 $\mathcal{M}_1,\mathcal{M}_2$ 上的[[MK445][代数无关]]集合且[[MK29][等势]] $|S_1|=|S_2|$
...
$\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}=\left<M,I\right>$ 的[[MK451][代数扩张]]，且 $M$ 是[[MK83][无限集]]则 $|M|=|N|$
...
根据[[MK444][性质1]]， $M$ 是[[MK83][无限集]]以及[[MK329][推论]]易证 $|M|=\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|$ ，显然 $M[x_1]\subset \bigcup_{n\in\mathbb{N}}M[\vec{x}_n]$ 根据[[MK33][定理5]]可得 $|M[x_1]|\leq|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]|$

又根据[[MK327][定理6]]可得 $|M[x_1]|\leq|M|$ 显然对于任意 $a\in M$ 亦有 $f(x_1)=a\in M[x_1]$ 故同理可得 $|M|\leq\left|M[x_1]\right|$

即根据[[MK34][伯恩斯坦定理]]可得 $|M|=\left|M[x_1]\right|$ ，根据[[MK29][等势]]存在[[MK181][双射]] $\psi:M\to M[x_1]$
...
又定义[[MK175][函数]] $v_{f(x_1)}:(N-M)\to\mathbb{N}$ 满足任意 $a\in N-M$ 且 $a$ 是 $f(x_1)$ 的[[MK389][根]]，则 $a$ 是该[[MK436][多项式]]的第 $v_{f_(x_1)}(a)$ 个[[MK389][根]]

则定义 $U_a=\left\{\left<f(x_1),v_{f(x_1)}(a)\right>\big|a\in R_{f(x_1)}\right\}$ 根据[[MK14][选择公理]]存在选择函数满足 $s(U_a)\in U_a$
...
综上所述易证 $\phi$ 是[[MK176][单射]]，显然任意 $a\in N-M$ 均有 $\phi(a)\in M[x_1]\times\mathbb{N}$ 根据[[MK29][等势]] $|N-M|\leq|M[x_1]\times\mathbb{N}|$

********* 证明结论

根据上上步可得 $|M|=\left|M[x_1]\right|$ 根据[[MK422][推论]]可得 $|M[x_1]\times\mathbb{N}|=\max\left(|M[x_1]|,|\mathbb{N}|\right)$ 根据 $M$ 是[[MK83][无限集]]以及[[MK329][推论]]易证 $|M[x_1]\times\mathbb{N}|=|M[x_1]|$ 

根据[[MK30][定理1]]可得 $|M[x_1]\times\mathbb{N}|=|M[x_1]|=|M|$ 根据[[MK327][定理6]]可得 $|N-M|\leq|M|$ 

又由于 $N=(N-M)\cup M$ 即有 $|N|=|(N-M)\cup M|$ 根据[[MK86][定理3]]易证 $|(N-M)\cup M|=\max(|N-M|,|M|)$

又根据[[MK30][定理1]]以及 $|N-M|\leq|M|$ 可得 $|N|=|(N-M)\cup M|=\max(|N-M|,|M|)=|M|$
...
由于 $|S_1|=|S_2|$ 故存在[[MK181][双射]] $\phi:S_1\to S_2$ ，对于任意 $a\in M_{1,S_1}$ 根据 $M_{1,S_1}$ 定义可得存在
...
则定义[[MK175][映射]] $e^*:M_{1,S_1}\to M_{2,S_2}$ 满足 $e^*(a)=\sum_{i\in P}\left(e(a_i)\left(\prod_{j\in K_i}\phi(s_j)^{k_{i,j}}\right)\right)$
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]有逆同构 $e^{-1}$ ，由于 $\phi$ [[MK181][双射]]则有[[MK188][逆函数]] $\phi^{-1}$ 显然有：
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]有逆同构 $e^{-1}$ ，由于 $\phi$ [[MK181][双射]]则有[[MK188][逆函数]] $\phi^{-1}$ ，则对于任意 $b\in M_{2,(S_2)}$
...
则定义 $f'_1(\vec{x})=f'_2(\vec{x})$ 的充要条件是存在[[MK181][双射]] $\phi:P'\to Q'$
...
存在唯一[[MK446][最简式]] $f'(\vec{x})=\sum_{i\in P'}\left(a'_i\left(\prod_{j\in K'_i}x_j^{k'_{i,j}}\right)\right)$ 对于任意 $\mathcal{M}$ 的[[MK341][扩张域]] $\mathcal{N}=\left<N,J\right>$ 以及任意 $\vec{s}=\left<s_1,...,s_n\right>\in N^n$
...
以及定义 $P^*=\left\{I_i\big|i\in P\right\}$ 由于 $|P|<\infty$ 则显然 $|P^*|<\infty$ ，则显然可构建[[MK176][单射]] $\phi:P^*\to\mathbb{N}$ 则定义 $P_0=\left\{\phi(p)\big|p\in P^*\right\}$
...
若不存在[[MK181][双射]] $\phi:P'\to Q'$ 由于 $|P'|<\infty,|Q'|<\infty$ 易证必有 $|P'|\ne |Q'|$ 由于所有相同的 $x_j$ 乘积项均合并

则必有 $i\in P'$ 满足不存在 $i'\in Q'$ 使得 $K'_i=L'_{i'}$ 且对于任意 $j\in K'_i$ 均有 $k'_{i,j}=l'_{i',j}$ 或反之

则根据[[MK356][性质4]]以及 $I(f_\times)(I(f_+)(I(c_1),I(c_1)),I(f_+)(I(c_1),I(c_1)))=\sum_{i=1}^4I(c_1)\ne I(f_+)(I(c_1),I(c_1))$

易证存在 $\{s_1,...,s_n\}\subset M$ 满足 $f'_1(s_1,...,s_n)\ne f_2'(s_1,...,s_n)$
...
根据[[MK447][相等]]可得存在[[MK181][双射]] $\phi:P'\to Q'$
...
（2） 对于任意 $i\in P$ 有 $I_{i}=\left\{p\big|K'_p=K'_i\land\left(\forall j\in K_i\left(k_{i,j}=k_{p,j}\right)\right)\right\}$ ， $P^*=\left\{I_i\big|i\in P\right\}$ ，[[MK176][单射]] $\phi:P^*\to\mathbb{N}$
...
其中对于任意 $k_{i,j}=0$ 定义 $s_j^{k_{i,j}}=I(c_1)$ ，对于任意 $K_i=\varnothing$ 则定义 $\left(\prod_{j\in K_i}s_j^{k_{i,j}}\right)=I(c_1)$
...
显然 $\phi$ 是[[MK175][函数]]且易证对于任意 $f_1(\vec{x})\ne f_2(\vec{x})$ 易证 $\phi(f_1(\vec{x}))\ne\phi(f_2(\vec{x}))$ 即 $\phi$ 是[[MK176][单射]]

根据[[MK29][等势]]有 $\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|\leq\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|$ 显然 $\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n$ 是[[MK83][无限集]]

故根据[[MK86][定理3]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|=\max\left(\left\{\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|\big|n\in\mathbb{N}\right\}\right)$

显然 $\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)$ 是[[MK83][无限集]]，根据[[MK88][定理5]]易证对于任意 $n\in\mathbb{N}$ 均有 $\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|=\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right|$

又根据[[MK422][推论]]可得 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right|=\max\left(|\mathbb{N}^n|,|M|,\left|\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right|\right)$

同理结合[[MK86][定理3]]以及[[MK88][定理5]]可得 $\left|\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right|=|\mathbb{N}^n|=|\mathbb{N}|$ 即有 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right|=\max\left(|\mathbb{N}|,|M|\right)$
 
根据[[MK30][等势等价]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}(\mathbb{N}\times\mathbb{N})^n\right)\right)^n\right|=\max\left(|\mathbb{N}^n|,|M|\right)$ 根据[[MK327][定理6]]有 $\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|\leq\max\left(|\mathbb{N}|,|M|\right)$ 
...
根据[[MK34][伯恩斯坦定理]] $\max\left(|\mathbb{N}|,|M|\right)=\left|\bigcup_{n\in\mathbb{N}}M[\vec{x}_n]\right|$
...
根据[[MK29][等势]]有 $\left|M[\vec{x}_n]\right|\leq\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|$ 显然 $\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n$ 是[[MK83][无限集]]

故根据[[MK86][定理3]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|=\max\left(\left\{\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|\big|n\in\mathbb{N}\right\}\right)$

显然 $\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)$ 是[[MK83][无限集]]，根据[[MK88][定理5]]易证对于任意 $n\in\mathbb{N}$ 均有 $\left|\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|=\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right|$

又根据[[MK422][推论]]可得 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right|=\max\left(|\mathbb{N}^n|,|M|,\left|\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right|\right)$

同理结合[[MK86][定理3]]以及[[MK88][定理5]]可得 $\left|\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right|=|\mathbb{N}|$ 即有 $\left|\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right|=\max\left(|\mathbb{N}|,|M|\right)$
 
根据[[MK30][等势等价]]可得 $\left|\bigcup_{n\in\mathbb{N}}\left(\mathbb{N}\times M\times\left(\bigcup_{n\in\mathbb{N}}\mathbb{N}^n\right)\right)^n\right|=\max\left(|\mathbb{N}^n|,|M|\right)$ 根据[[MK327][定理6]]有 $\left|M[\vec{x}_n]\right|\leq\max\left(|\mathbb{N}|,|M|\right)$ 

显然有 $|\mathbb{N}|\leq\left|M[\vec{x}_n]\right|,|M|\leq\left|M[\vec{x}_n]\right|$ 即亦有 $\max\left(|\mathbb{N}|,|M|\right)\leq\left|[\vec{x}_n]\right|$ 根据[[MK34][伯恩斯坦定理]] $\max\left(|\mathbb{N}|,|M|\right)=\left|M[\vec{x}_n]\right|$
...
显然 $f$ 是[[MK181][双射]]，根据[[MK188][求逆]]可得存在[[MK188][逆函数]] $g^{-1}:N\to N'$ ，定义 $J'$ 满足：
...
由于 $e:M\to N$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]则根据[[MK472][性质3]]可得 $e(f(\vec{x}))$ 可以根[[MK446][最简式]]，故 $e'$ 是[[MK175][函数]]

根据以下证明以及[[MK468][性质16]]可得 $e'$ 是 $\mathcal{M}[\vec{x}]$ 到 $\mathcal{N}[\vec{x}]$ 的[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]

******** 是[[MK175][函数]]

根据[[MK446][最简式]]对应的[[MK437][唯一性]]以及[[MK472][性质3]]可得 $e'$ 是[[MK175][函数]]
...
根据[[MK447][条件]]若不存在[[MK181][双射]] $\phi:P\to Q$ 满足对于任意存在 $i\in P$ 有 $K_i=L_{\phi(i)}$ 且对于任意 $i\in P,j\in K_i$ 有 $k_{i,j}=l_{\phi(i),j}$
...
由于 $e$ 是[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，故是[[MK181][双射]]，则存在[[MK188][逆函数]] $e^{-1}:N\to M$ 则对于任意 $f(\vec{x})=\sum_{i\in P}\left(b_i\left(\prod_{j\in K_i}x_j^{k_{i,j}}\right)\right)\in N[\vec{x}]$
...
若 $\mathcal{M}=\left<M,I\right>$ 是[[MK390][代数封闭域]]的[[MK339][特征]]均为 $p$ 由于是[[MK390][代数封闭域]]，故为[[MK338][域]]，则：

（1） 根据[[MK430][性质1]]可得 $p$ 是素数，根据[[MK431][性质3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是[[MK338][域]]，进一步根据[[MK419][定理3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（2） 若 $p=0$ 则根据[[MK429][定理7]]可得[[MK424][有理数域]] $\mathcal{Q}=\left<\mathbb{Q},I_\mathbb{Q}\right>$ 是 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（3） 根据[[~/文档/note/数理逻辑/sllj.org::MK312][定理]]可得存在 $\mathcal{M}'=\left<M',I'\right>$ 是 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]且与[[MK417][ $\mathbb{Z}_p$ ]]或 $\mathcal{Q}$ 有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
根据[[MK14][选择公理]]可得存在选择函数满足 $\psi(U_a)\in U_a$ 则对于任意 $a$ 定义 $\phi(a)=\psi(U_a)$ 以及 $\vec{x}_n=\left<x_1,...,x_n\right>,\vec{y}_m=\left<y_1,...,y_m\right>$

显然 $\phi$ 是 $M'_{(S)}$ 到 $\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\times\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)$ 的[[MK175][函数]]，对于任意 $a\ne b$ 且 $\{a,b\}\subset M'$

假设 $\phi(a)=\phi(b)$ 则有 $a=f(s_1,...,s_n)\left(g(y_1,...,y_m)\right)^{-1}=b$ 显然矛盾，故假设不成立。即 $a\ne b$ 必有 $\phi(a)\ne\phi(b)$

即 $\phi$ 是[[MK176][单射]]。故可得 $\left|M'_{(S)}\right|\leq\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\times\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)\right|$ 显然易证 $\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\right|=\left|\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)\right|$

根据[[MK422][推论]]可得 $\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\times\left(\bigcup_{m\in\mathbb{N}}\left(M'[\vec{y}_m]\times S^m\right)\right)\right|=\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\right|$

根据[[MK485][性质2]]可得对于任意 $n\in\mathbb{N}$ 有 $|M'[\vec{x}_n]|=\max(|M'|,|\mathbb{N}|)$ 由于 $\mathcal{M}'$ 与[[MK417][ $\mathbb{Z}_p$ ]]或 $\mathcal{Q}$ 有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，故存在[[MK181][双射]] $e:M'\to Z_p$ 或 $e:M'\to\mathbb{Q}$

结合[[MK96][推论]]以及[[MK29][等势]]可得 $|M'|\leq|\mathbb{N}|$ 即有 $|M'[\vec{x}_n]|=|\mathbb{N}|$ ，又根据[[MK422][推论]]以及[[MK30][等价性]]可得对于任意 $n\in\mathbb{N}$ 均有 $\left|M'[\vec{x}_n]\times S^n\right|=\max\left(|\mathbb{N}|,|S|\right)$

显然 $M'[\vec{x}_n]\times S^n$ 是[[MK83][无限集]]，则根据[[MK86][定理3]]可得 $\left|\left(\bigcup_{n\in\mathbb{N}}\left(M'[\vec{x}_n]\times S^n\right)\right)\right|=\max(|\mathbb{N}|,|S|)$ 最终可得 $\left|M'_{(S)}\right|\leq\max(|\mathbb{N}|,|S|)$ 

******* 证明（2）

根据结论（1）可得 $\left|M'_{(S)}\right|\leq|S|$ 显然有 $S\subset M_{(S)}$ 则根据[[MK33][定理5]]可得 $|S|\leq\left|M'_{(S)}\right|$ 根据[[MK34][伯恩斯坦定理]]有 $|S|=\left|M'_{(S)}\right|$

根据[[MK477][性质1]]可得 $\mathcal{M}$ 是 $\mathcal{M}'_{(S)}$ 的[[MK451][代数扩张]]，由于 $|\mathbb{N}|\leq |S|$ 故 $S$ 是[[MK83][无限集]]，进一步易证 $M'_{(S)}$ 亦为[[MK83][无限集]]

则根据[[MK486][定理4]]可得 $|M|=|M_{(S)}|$ 根据[[MK30][等价性]]有 $|M|=|S|$ 
...
***** [[MK390][代数封闭域]]的超越基/超越度<<M5496>>

任意 $\mathcal{M}=\left<M,I\right>$ 是[[MK390][代数封闭域]]的[[MK339][特征]]均为 $p$ 由于是[[MK390][代数封闭域]]，故为[[MK338][域]]，则：

（1） 根据[[MK430][性质1]]可得 $p$ 是素数，根据[[MK431][性质3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是[[MK338][域]]，进一步根据[[MK419][定理3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（2） 若 $p=0$ 则根据[[MK429][定理7]]可得[[MK424][有理数域]] $\mathcal{Q}=\left<\mathbb{Q},I_\mathbb{Q}\right>$ 是 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（3） 根据[[~/文档/note/数理逻辑/sllj.org::MK312][定理]]可得存在 $\mathcal{M}'=\left<M',I'\right>$ 是 $\mathcal{M}$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]且与[[MK417][ $\mathbb{Z}_p$ ]]或 $\mathcal{Q}$ 有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，进一步可得 $\mathcal{M}'$ 亦为[[MK338][域]]

即 $\mathcal{M}'$ 是 $\mathcal{M}$ 的[[MK341][子域]]，则根据[[MK495][存在性]]可得有 $S$ 是 $\mathcal{M}$ 关于 $\mathcal{M}'$ [[MK341][域扩张]]的[[MK438][超越基]]
...
对于任意[[MK390][代数封闭域]] $\mathcal{M}=\left<M,I\right>,\mathcal{N}=\left<N,J\right>$ [[MK339][特征]]均为 $p$ ，由于是[[MK390][代数封闭域]]，故为[[MK338][域]]，则：

（1） 根据[[MK430][性质1]]可得 $p$ 是素数，根据[[MK431][性质3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是[[MK338][域]]，进一步根据[[MK419][定理3]]可得[[MK417][ $\mathbb{Z}_p$ ]]是 $\mathcal{M},\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（2） 若 $p=0$ 则根据[[MK429][定理7]]可得[[MK424][有理数域]] $\mathcal{Q}=\left<\mathbb{Q},I_\mathbb{Q}\right>$ 是 $\mathcal{M},\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK300][嵌入]]

（2） 根据[[~/文档/note/数理逻辑/sllj.org::MK312][定理]]可得存在 $\mathcal{M}'=\left<M',I'\right>,\mathcal{N}' =\left<N',J'\right>$ 分别是 $\mathcal{M},\mathcal{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]且与[[MK417][ $\mathbb{Z}_p$ ]]或 $\mathcal{Q}$ 有[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]

则若 $\mathcal{M}$ 关于 $\mathcal{M}'$ 的[[MK438][超越基]] $S$ 与 $\mathcal{N}$ 关于 $\mathcal{N}'$ 的[[MK438][超越基]] $T$ [[MK29][等势]]，则有 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
则根据[[MK476][定理2]]可得 $\mathcal{M}'_{(S)},\mathcal{N}'_{(T)}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，且根据[[MK47][性质1]]可得 $\mathcal{M},\mathcal{N}$ 分别是 $\mathcal{M}'_{(S)},\mathcal{N}'_{(T)}$ 上的[[MK451][代数扩张]]
...
同[[MK488][定理5]]中符号定义，若 $\mathcal{M}$ 关于 $\mathcal{M}'$ 的[[MK438][超越基]] $S$ ， $\mathcal{N}$ 关于 $\mathcal{N}'$ 的[[MK438][超越基]] $T$ 均为[[MK83][无限集]]

则若 $|N|=|M|$ 则有 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]

******* 证明

由于[[MK339][特征]]均为 $p$ 且 $S$ 为[[MK83][无限集]]，则根据[[MK487][性质4]]可得 $|S|=|M|$ 同理可证 $|T|=|N|$ 根据[[MK30][等价性]]可得 $|S|=|T|$
...
又根据 $|M|=|N|$ 则根据[[MK30][等价性]]可得 $|S|=|T|$ ，即根据[[MK488][定理5]]可得 $\mathcal{M},\mathcal{N}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]
...
根据[[MK412][性质3]]可得 $\mathcal{T}_{ACF_p}$ 仅有[[~/文档/note/数理逻辑/sllj.org::MK221][无限模型]]，任取[[MK35][基数]] $|\mathbb{N}|<\kappa$ ，则根据[[MK494][推论2]]可得 $\mathcal{T}_{ACF_p}$ 是一个 $\kappa$ [[~/文档/note/数理逻辑/sllj.org::MK437][等势同构]]理论
...
由于任意 $\mathcal{O}\in K$ 均为[[MK338][域]]，故则根据[[MK483][偏序性]]易证 $\left<K,\prec\right>$ 是[[MK143][偏序集]]（显然自身是自身的[[MK451][代数扩张]]）

******* $\left<K,\prec\right>$ 上任意[[MK153][链]]都有[[MK145][上界]]

对于任意 $\left<K,\prec\right>$ 上的[[MK153][链]] $T\subset K$ 根据以下证明可得存在 $\mathcal{M}_T$ 满足任意 $\mathcal{O}\in T$ 均为 $\mathcal{M}_T$ 的[[MK341][子域]]

即 $\mathcal{M}_T$ 是 $T$ 上关于 $\prec$ 的[[MK145][上界]]
...
（2） 对于任意 $\{a_1,a_2\}\subset M_T$ 根据 $M_T$ 定义必有 $\{\mathcal{O}_1=\left<O_1,L_1\right>,\mathcal{O}_2=\left<O_2,L_2\right>\}\subset K$ 满足 $a_1\in O_1,a_2\in O_2$
     ...
     由于是[[MK153][链]]，故不妨设 $\mathcal{O}_1\prec\mathcal{O}_2$ ，则有 $\{a_1,a_2\}\subset O_2$
...
满足 $a_1\in O_1,a_2\in O_2$ 由于是[[MK153][链]]，故不妨设 $\mathcal{O}_1\prec\mathcal{O}_2$ ，显然 $\mathcal{O}_2$ 是[[MK338][域]]
...
根据上述证明以及[[MK162][佐恩引理]]，可得 $\left<K,\prec\right>$ 上存在[[MK144][极大元]] $\mathcal{N}=\left<N,J\right>$ 由于 $\mathcal{N}\in K$ 故为 $\mathcal{M}$ 的[[MK451][代数扩张]]
...
可得 $\mathcal{N}'$ 亦为 $\mathcal{M}$ 的[[MK451][代数扩张]]，即有 $\mathcal{N}'\in K$ 且 $\mathcal{N}\prec\mathcal{N}'$ 。与 $\mathcal{N}$ 是 $\left<K,\prec\right>$ 上存在[[MK144][极大元]]矛盾

故假设不成立，即 $\mathcal{N}=\left<N,J\right>$ 是[[MK390][代数封闭域]]

***** 定理7

对于任意[[MK390][代数封闭域]] $\mathcal{M}=\left<M,I\right>$ [[MK339][特征]]为 $p$ ，满足 $M$ 是[[MK89][可数集]]则 $\mathcal{M}$ 是[[~/文档/note/数理逻辑/sllj.org::MK394][饱和模型]]的充要条件是其[[MK496][超越基]] $S$ 满足 $|S|=|\mathbb{N}|$
...
对于任意 $X\subset M$ 满足 $|X|<|M|$ 由于 $|M|=|\mathbb{N}|$ 故可得 $X$ 是[[MK82][有限集]]

以 $X$ 对 $\mathcal{L}_{\mathcal{A}_{\test{ACF}}},\mathcal{M}$ 进行[[~/文档/note/数理逻辑/sllj.org::MK406][常元扩张]]可得 $\mathcal{L}_{\mathcal{A}_{\test{ACF}\cup X}},\mathcal{M}_X=\left<M,I_X\right>$ 并定义 $\text{Th}(\mathcal{M}_X)=\left\{\theta\big|\theta\in\Theta_X\land\mathcal{M}_X\vDash\theta\right\}$

其中 $\Theta$ 为 $\mathcal{L}_{\mathcal{A}_{\test{ACF}\cup X}}$ 下的所有[[~/文档/note/数理逻辑/sllj.org::MK144][语句]]，对于任意[[~/文档/note/数理逻辑/sllj.org::MK322][ $1$ 元类型]] $\Gamma(x_1)$ 满足 $\text{Th}(\mathcal{M}_X)\subset\Gamma(x_1)$ 可得存在 $b\in M$
...
根据[[~/文档/note/数理逻辑/sllj.org::MK242][引理11]]以及[[~/文档/note/数理逻辑/sllj.org::MK497][引理1]]可得存在 $\mathcal{N}_X=\left<N,J_X\right>$ 满足

（1） [[MK323][实现]] $\Gamma$

（2） $\mathcal{M}_X$ 是 $\mathcal{N}_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK301][同质嵌入]]，设[[~/文档/note/数理逻辑/sllj.org::MK301][同质嵌入映射]]为 $e$
...
（3） 根据[[~/文档/note/数理逻辑/sllj.org::MK492][定理1]]存在 $\mathcal{N}_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK287][同质子结构]]与 $\mathcal{M}_X$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，定义为 $\mathcal{N}'_X=\left<N',J'_X\right>$ 以及[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]为 $e:M\to N'$

******** 若 $a\in N'$

则 $v$ 是 $\mathcal{N}'_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]]，根据[[~/文档/note/数理逻辑/sllj.org::MK287][同质子结构]]可得 $\left<\mathcal{N}'_X,v\right>\vDash\Gamma$ 根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]可得存在[[MK188][逆函数]] $e^{-1}:N'\to M$
...
********* 定义 $\mathcal{M}^*_{(X)}$ 与 $\mathcal{N}^*_{(X)}$ 证明[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]

根据[[MK487][性质4]]可得存在 $\mathcal{M}'=\left<M',I'\right>$ 是：
...
进一步定义 $\mathcal{M}'_{(X)}=\left<M'_{(X)},I'_{(X)}\right>$ 为 $\mathcal{M}'$ 对于 $X$ 的[[MK341][扩张域]]，进一步定义 $\mathcal{M}^*_{(X)}=\left<M^*_{(X)},I^*_{(X)}\right>$ 为 $\mathcal{M}'_{(X)}$ 的[[MK497][代数闭包]]

显然 $\mathcal{M}^*_{(X)}$ 是 $\mathcal{M}_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]，则根据的[[~/文档/note/数理逻辑/sllj.org::MK503][引理2]]存在 $\mathcal{N}^*_{(X)}$ 是 $\mathcal{N}'_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]且域 $\mathcal{M}^*_{(X)}$ [[~/文档/note/数理逻辑/sllj.org::MK274][同构]]，易证亦是[[MK390][代数封闭域]]

********* 定义 $\mathcal{M}^{**}_{\left(X\cup\{b\}\right)},\mathcal{N}^{ * *}_{\left(X\cup\{a\}\right)}$ 证明[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]

根据[[MK487][性质4]] $\mathcal{M}^*_{(X)}$ 存在[[MK496][超越基]] $S_X$ 由于 $X$ 是[[MK82][有限集]]，则 $S_X$ 亦为[[MK82][有限集]]。结合 $|S|=|\mathbb{N}|$ 可得存在 $b\in S$ 满足 $b\not\in S_X$

显然易证 $b$ 在 $\mathcal{M}^*_{(X)}$ 上[[MK445][代数无关]]。根据[[~/文档/note/数理逻辑/sllj.org::MK296][定理1]]可得 $T_{\text{ACF}}\subset \text{Th}(\mathcal{M}_X)$ 则有 $\mathcal{M}_X\vDash T_\text{ACF}$ 根据[[~/文档/note/数理逻辑/sllj.org::MK274][同构]] $\mathcal{N}'_X\vDash T _\text{ACF}$ 即 $\mathcal{N}'_X$ 是[[MK390][代数封闭域]]

由于 $a\not\in N'$ 故显然 $a$ 不是 $\mathcal{N}_X$ 上的[[MK395][代数元]]，即 $a$ 在 $\mathcal{N}_X$ 上[[MK445][代数无关]]，易证 $a$ 在 $\mathcal{N}^*_{(X)}$ 上[[MK445][代数无关]]
...
取 $\mathcal{M}^{**}_{\left(X\cup\{b\}\right)}$ 与 $\mathcal{N}^{ * *}_{\left(X\cup\{a\}\right)}$ 分别为 $\mathcal{M}^*_{\left(X\cup\{b\}\right)}$ 与 $\mathcal{N}^*_{\left(X\cup\{a\}\right)}$ 的[[MK497][代数闭包]]
...
********* 证明 $\mathcal{N}^{ * *}_{\left(X\cup\{a\}\right)}\vDash\Gamma[a]$ <<MK499>>

由于：

（1） $\mathcal{N}^{ * *}_{\left(X\cup\{a\}\right)}$ 是 $\mathcal{N}_X$ 的[[~/文档/note/数理逻辑/sllj.org::MK282][子结构]]

（2） $\mathcal{N}^{ * *}_{\left(X\cup\{a\}\right)}\vDash T_\text{ACF}$ 是 $\mathcal{N}_X\vDash T_\text{ACF}$ 均为[[MK390][代数封闭域]]

（3） $\mathcal{T}_{\test{ACF}_p}$ 适合[[~/文档/note/数理逻辑/sllj.org::MK397][量词消去]]

根据[[~/文档/note/数理逻辑/sllj.org::MK502][引理3]]可得 $\mathcal{T}'_{\test{ACF}_p}=\left<\mathcal{L}_{\mathcal{A}_{\text{ACF}\cup X}},\mathbb{L}\cap\mathcal{L}_{\mathcal{A}_{\text{ACF}}\cup C_X},T_{\test{ACF}_p},T^*_{\test{ACF}_p}\right>$ 适合[[~/文档/note/数理逻辑/sllj.org::MK397][量词消去]]
...
根据[[~/文档/note/数理逻辑/sllj.org::MK275][引理]]可得存在 $e^{**}$ 的[[MK188][逆函数]] $\left(e^{ * *}\right)^{-1}$ 为逆[[~/文档/note/数理逻辑/sllj.org::MK274][同构映射]]，根据[[~/文档/note/数理逻辑/sllj.org::MK276][定理1]]可得 $\left<\mathcal{M}^{ * *}_{\left(X\cup\{a\}\right)},v\cdot \left(e^{ * *}\right)^{-1}\right>\vDash\Gamma$
...
$(\forall x_1(\forall x_2(\forall x_3(P_\times(x_1,x_2,x_3))\land P_\cdot(x_3,x_4,x_5))))$
