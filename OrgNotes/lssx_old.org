...
设集合 $X$ 非空，则 $U$ 是 $X$ 的超滤子当且仅当 $U$ 满足：
...
由于 $S$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]，故 $\mathcal{M}_{(S)}$ 是 $\mathcal{M}$ 的[[MK451][超越扩张]]，则根据[[MK509][推论2]]可得 $M_{(S)}$ 是[[MK83][无限集]]
...
则根据[[MK478][性质3]]可得 $S\cup\{a\}$ 在 $\mathcal{M}$ 上[[MK445][代数无关]]，即与 $S$ 的[[MK144][极大性]]矛盾
...
$\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}=\left<M,I\right>$ 的[[MK451][超越扩张]]，则 $N$ 是[[MK83][无限集]]
...
即存在 $S\subset N$ 满足是[[MK83][无限集]]，则显然 $N$ 是[[MK83][无限集]]
...
$\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}=\left<M,I\right>$ 的[[MK451][超越扩张]]，则[[MK454][维数]] $[\mathcal{N}:\mathcal{M}]\geq\infty$ 
...
根据[[MK484][定理6]]可得存在[[MK390][代数封闭域]] $\mathcal{N}=\left<N,J\right>$ 是 $\mathcal{M}$ 的[[MK341][扩张域]]，又根据[[MK412][性质3]]可得 $N$ 是[[MK83][无限集]]
...
任意[[MK338][域]] $\mathcal{M}=\left<M,I\right>$ 若 $M$ 是[[MK83][无限集]]，有关于 $\vec{x}=\left<x_1,...,x_{n}\right>$ 的[[MK446][最简式]] $f(\vec{x})=\sum_{i\in P}\left(a_i\left(\prod_{j\in K_i}x_j^{k_{i,j}}\right)\right)\in M[\vec{x}]$
...
若[[MK378][次数]]大于 $0$ ，则根据[[MK410][推论]] $f(x_1)$ 至多有 $n$ 个[[MK389][根]]，由于 $M$ 是[[MK83][无限集]]，故存在 $a\in M$ 不是 $f(x_1)$ 的[[MK389][根]]
...
则定义 $\left<a,b\right>\in \phi$ 

******* $\phi$ 是[[MK181][双射]]

******** 是[[MK175][函数]]

假设存在 $a\in N$ 使得 $\left\{\left<a,b_1\right>,\left<a,b_2\right>\right\}\subset\phi$ 且满足 $b_1\ne b_2$ 根据 $\phi$ 定义可得 $J(f_+)(a,J(f_-)(b_1))=J(c_0)，J(f_+)(a,J(f_-)(b_2))=J(c_0)$

根据

又由于 $\mathcal{M}$ 是[[MK390][代数封闭域]]，故可得存在 $b\in M$
...
（1） 有[[MK89][可数]]个不[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]] $\mathcal{M}_i=\left<M_i,I_i\right>,i\in\mathbb{N}$
...
根据[[MK487][性质4]]可得若 $\mathcal{M}$ 是 $\mathcal{T}_{\test{ACF}_p}$ 的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]，则其[[MK496][超越基]]必为[[MK89][可数]]

根据[[MK488][定理5]]可得任意两个 $\mathcal{T}_{\test{ACF}_p}$ 的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]，[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]的充要条件是[[MK496][超越基]]有[[MK29][等势]]

由于[[MK496][超越基]] $|S|\leq|\mathbb{N}|$ 故有且仅有[[MK89][可数]]种可能性，故有且仅有[[MK89][可数]]个不[[~/文档/note/数理逻辑/sllj.org::MK274][同构]]的[[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]
...
则根据[[MK29][等势]]存在 $S'_j\subset S_j$ 满足 $|S'_j|=|S_i|$ 则定义 $\mathcal{M}'_j$ 是[[MK496][超越基]]为 $|S'_j|$ 的 $\mathcal{T}_{\test{ACF}_p}$ [[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]
...
显然 $\mathcal{M}_\infty$ 是[[MK496][超越基]]为[[MK89][可数集]]的 $\mathcal{T}_{\test{ACF}_p}$ [[~/文档/note/数理逻辑/sllj.org::MK221][可数模型]]，即对于任意 $i\in\mathbb{N}\cup{\infty}$ 有 $|S_i|\leq |S_\infty|$
