...
由字符作为元素组成的[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]。
...
由[[MK1][字母表]] $V$ 中的元素组成的有限[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]]定义为字符串。特别定义 $\epsilon$ 是长度为零的字符串（空串）
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK152][定理]]可得字符串相等当且仅当每一个对应位置的字符相等。
...
定义四元[[~/文档/note/离散数学/Disc_Math.org::MK310][代数结构]] $G=<V_N,V_T,P,s>$ 为语法，定义 $V=V_T\cup V_N$ 表示文法[[MK1][符号集]]

**** 终结符<<MK8>>

定义为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $V_T$ ，是该文法所定义的语言的基本符号

对于任意 $v\in V_T$ 无法单独存在与[[MK10][产生式]]左部

**** 非终结符<<MK9>>

定义为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $V_N$ ，满足 $V_N\cap V_T=\varnothing$ 特别的 $V_N$ 不包含[[MK3][空字符串]]，即 $\epsilon\not\in V_N$

是用来表示语法成分的符号，亦称为语法符号

**** 产生式<<MK10>>

定义为[[~/文档/note/离散数学/Disc_Math.org::MK155][二元关系]] $P\subset V^+\times V^*$ ， $<\alpha,\beta>\in P$ 通常记作 $\alpha\to\beta$ 其中 $\alpha$ 称为产生式的左部， $\beta$ 称为其右部  
...
（1） $<M,E>$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][有根树]]

（2） $f:M\to (V_N\cup V_T)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

（3） $\prec\subset V/\{r\}\times V/\{r\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK188][拟序关系]]，其中 $r$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]

（4） 每个[[~/文档/note/离散数学/Disc_Math.org::MK285][分支]] $v\in M$ 及其[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]] $\mathcal{S}(v)$ 则存在[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $u_1\prec...\prec u_k$ 满足 $f(v)\to f(u_1)...f(u_k)\in P$

（5） 若 $\delta_a\prec\delta_b\prec\delta_c$ 则对于任意 $\delta_b$ 到 $\delta_d$ [[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]均有 $\delta_a\prec\delta_d\prec\delta_c$

则该代数结构定义为语法 $G$ 分析树，并定义自左向右的[[~/文档/note/离散数学/Disc_Math.org::MK285][树叶]]统称为该树的 *产出* 或 *边缘*

*** 对应[[MK3][字串]]<<MK28>>

任意分析树 $D=<M,E,\prec,f>$ 的[[~/文档/note/离散数学/Disc_Math.org::MK292][叶集]] $\mathcal{L}(M)$ 

存在基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $\delta_1\prec...\prec\delta_k$ 满足 $f(\delta_i)=X_i$
...
显然仅有[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]，则根据[[MK27][定义（2）]]可得有[[MK3][字串]] $f(r)=\alpha\in V_N$ 满足 $D\simeq\alpha$

假设当分支节点为 $n$ 时条件成立

则对于任意 $D=<M,E,\prec,f>$ 有 $n+1$ 个分支，取任意一个即[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$ 的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]

则根据[[MK37][定理4]]可得存在 $D_{M/\mathcal{S}(v)}\stackrel{v}\Rightarrow D$ 其中 $v$ 是[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$ 的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]] $\mathcal{S}(v)$ 为其[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点集]]

由于 $D_{M/\mathcal{S}(v)}$ 分支节点比 $D$ 少 $v$ 故根据假设存在 $D_{M/\mathcal{S}(v)}\simeq\alpha'=X_1...X_n$

定义 $D_{M/\mathcal{S}(v)}=<M',E',\prec',f'>$ 

则根据[[MK28][定义]] $\mathcal{L}(M')$ 存在基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $u_1\prec'...\prec' u_n$ 满足 $f'(u_i)=X_i$

进一步根据[[~/文档/note/离散数学/Disc_Math.org::MK192][定理]]有存在 $u_k=v$  

故根据[[MK33][分析树推导]] $\mathcal{L}(M)=(\mathcal{L}(M')-v)\cup\mathcal{S}(v)$ 

且 $\mathcal{S}(v)$ 有基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $\delta_1\prec...\prec\delta_m$ 以及 $f(\delta_i)=Y_i\in(V_N\cup V_T)$

进一步根据[[MK40][定理2]]可得 $u_1\prec...\prec u_n$ 以及 $f(u_i)=X_i$

根据[[MK27][定义（4）]]可知 $\mathcal{L}(M)$ 有基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $u_1\prec...\prec u_{k-1}\prec\delta_1\prec...\prec\delta_m\prec u_{k+1}...\prec u_n$ 
...
由于[[~/文档/note/离散数学/Disc_Math.org::MK192][排序唯一]]，且 $f$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，故 $f(\delta_i)$ 唯一，故对应的字串为 $f(\delta_1)...f(\delta_k)$

由于 $D\simeq\alpha$ 则有 $\alpha=f(\delta_1)...\f(\delta_k)$ 唯一

*** 分析树推导<<MK33>>

[[MK27][分析树]] $D_a=<M,E,\prec,f>$ 对于 $D_a$ 的任一[[~/文档/note/离散数学/Disc_Math.org::MK292][叶]] $v\in\mathcal{L}(M)$ 若有：
...
由于 $D_a$ 满足（1）故 $<M,E>$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][有根树]]

故根据[[~/文档/note/离散数学/Disc_Math.org::MK286][等价条件]]可得 $r$ 到 $v$ [[~/文档/note/离散数学/Disc_Math.org::MK244][有向可达]]且 $<M,E>$ 没有[[~/文档/note/离散数学/Disc_Math.org::MK238][弱圈]]
...
对于任意 $D_b$ 的[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]] $u\ne v$ 易证其亦为 $D_a$ 的分支，且 $D_a,D_b$ 的[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]]相同，定义为 $\mathcal{S}(u)$
...
若 $\delta_a\prec\delta_b\prec\delta_c,\{\delta_a,\delta_b,\delta_c\}\subset M$ 有 $u$ 是 $\delta_b$ 的有向可达[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]
...
则根据 $M',E'$ 的构造 $v$ 从[[~/文档/note/离散数学/Disc_Math.org::MK292][叶]]转化为[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]，且新增叶[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]] $\delta_1,...,\delta_n$ 则 $|\mathcal{L}(M')|=|\mathcal{L}(M)|-1+n$
...
根据[[MK33][推导]]定义可得不改变现有节点的[[~/文档/note/离散数学/Disc_Math.org::MK218][入度]]，故若 $D_a$ 中 $d^-(r)=0$

则 $D_b$ 中 $d^-(r)=0$ 又由于都是分析树，故均是[[~/文档/note/离散数学/Disc_Math.org::MK285][有根树]]，故树根相同

***** 推论<<MK32>>

对于任意[[MK27][分析树]] $D=<M,E,\prec,f>$ 定义[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]为 $r\in M$ 

则存在[[MK14][2型文法]] $G$ 中的[[MK18][推导]] $f(r)\Rightarrow^n\alpha$ 

其中 $n$ 为[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]节点个数， $\alpha\simeq D$ 是 $D$ [[MK28][对应]]的字串

****** 证明

对于任意无[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]节点的 $D$ ，易证 $f(r)=\alpha$ 显然成立

假设若 $M$ 中有 $n$ 个分支[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]时结论成立

则若 $M$ 中有 $n+1$ 个分支节点时，任取一个[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$ 的分支节点 $v$

则定义 $\mathcal{A}(v)$ 是 $v$ 的所有[[~/文档/note/离散数学/Disc_Math.org::MK244][有向可达]]的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]的集合
...
由于 $\mathcal{H}(v)=1$ 故 $v$ 不含有向可达[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]，则 $D_X$ 相比 $D$ 仅少分支 $v$ ，树根相同
...
（3） 定义 $v$ 在 $D_b$ 的[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点集]] $\mathcal{S}(v)$ 则其有基于 $\prec'$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $u_1\prec...\prec u_n$
...
（1） $f(r)=A\land D\simeq\alpha$ 其中 $r$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]

（2） $D$ 的[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]节点数是 $n$
...
满足 $D'\simeq\alpha'\land f(r)=A$ 以及 $D'$ 有 $n$ 个分支节点。其中 $r$ 是 $D'$ 的[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]
...
（2） $f(r)=s$ 其中 $r$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]] $s$ 是[[MK11][开始符]]

**** 定理4<<MK37>>

任意分析树 $D=<M,E,\prec,f>$ 定义 $K=\left\{v\big|\mathcal{H}(v)=1\land v\in M\right\}$ 即[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$ 的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]

取任一 $v\in K$ 定义 $\mathcal{A}(v)$ 为其所有[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]节点，定义 $N=M/(\mathcal{A}(v)/\{v\})$

则 $D_{N}$ 是 $D$ 的[[MK38][分析子树]]，且有 $D_N\stackrel{v}\Rightarrow D$ 

***** 证明

由于 $\mathcal{H}(v)=1$ 故 $\mathcal{S}(v)$ 是 $v$ 所有[[~/文档/note/离散数学/Disc_Math.org::MK244][有向可达]]的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]的集合

则根据[[MK39][定理1]]可得 $D_N$ 是[[MK27][分析树]]

由于 $v$ 是[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]，故满足条件（4），故易证 $D_N$ 经过 $v$ 的推导可得 $D$
...
若分析树 $D=<M,E,\prec,f>$ 有[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]] $v\in M/\{r\}$ 其中 $r$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]] 

定义 $Y=\mathcal{A}(v)\cup\{v\}$ 其中 $\mathcal{A}(v)$ 是 $v$ 的所有[[~/文档/note/离散数学/Disc_Math.org::MK244][有向可达]]的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]的集合
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK291][定理1]]可得 $<X,E_X>$ 是有根树

****** （2）

由于 $f_X\subset f$ 故 $f_X$ 亦为[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，故满足（2）

****** （3）

由于 $\prec_X\subset\prec$ 故有 $\prec_X$ 亦是[[~/文档/note/离散数学/Disc_Math.org::MK188][拟序关系]]故满足（3）

****** （4）

$D_X$ 中的任意[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]] $v\in X$ 以及[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]] $\mathcal{S}(v)\subset X$ 在 $D$ 中仍是对应的[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]和[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]]
...
若存在[[~/文档/note/离散数学/Disc_Math.org::MK200][双射函数]] $g:N_a\to N_b$ 其中 $N_a\subset M_a\land N_b\subset M_b$ 满足对于任意 $\{u,v\}\subset N_a$
...
（2） $f(r_a)=f(r_b)=s$ 即[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]均映射到[[MK11][开始符]]
...
[[MK44][单词]]的一种有穷[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]，并定义每一类划分对应一个种别码。一般种别有：
...
输出：[[MK44][单词]]的[[MK45][种别]] $t$ 以及单词自身值 $v$ 构成的二元组排列成的有穷[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]]
...
定义 $S$ 为[[MK66][自动机]]的状态集 $\delta$ 是映射[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，定义 $I\subset S$ 则其 $\epsilon$ 闭包记作 $\epsilon\text{-closure}(I)$ 

其构造定义为：

（1） $\forall a\in I\rightarrow a\in\epsilon\text{-closure}$

（2） 存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,\epsilon),...,\delta(s_{n},\epsilon)>,n<\infty$ 
...
对于任意[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,a_1),...,\delta(s_{n-1},a_n)>$ 满足：
...
（1） 无[[~/文档/note/离散数学/Disc_Math.org::MK213][重边]]的[[~/文档/note/离散数学/Disc_Math.org::MK221][有向图]] $G=<S,E>$

（2） [[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\rho(\mathcal{R}(\Sigma))$ 
...
一个[[MK44][单词]] $\alpha=a_1...a_n$ 可以被状态转换图接受，就表示存在[[~/文档/note/离散数学/Disc_Math.org::MK232][通道]] $t=<v_1,e_1,...,v_n,e_m,v_f>$ 满足：
...
定义[[~/文档/note/高等代数/Algb-3-Matrix.org][矩阵基础-矩阵的表述]] $M_{|S|\times|\Sigma|}[a_{sa}]$ 其中 $s\in S\land a\in\Sigma$ 
...
一个由[[MK3][字符串]]为[[~/文档/note/离散数学/Disc_Math.org::MK2][元素]]组成的[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $L$ ，满足该集合可由[[MK57][正规式]]表达
...
$r|s=s|r$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK39][集合交换律]]

**** 结合律

$r|(s|t)=(r|s)|t$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK40][集合结合律]]
...
根据[[MK64][单位元]]可得 $r\epsilon=r\leftrightarrow L(r)\times\{\epsilon\}=L(r)$ 进一步根据[[MK63][分配率]]、[[~/文档/note/离散数学/Disc_Math.org::MK40][结合律]]、[[~/文档/note/离散数学/Disc_Math.org::MK38][等利律]]
...
同理可证 $x\in(r|\epsilon)^*\rightarrow x\in r^*$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $r^*=(r|\epsilon)^*$ 
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK154][分配率]]有 $\left(\bigcup_{i=1}^\infty r^i\right)\left(\bigcup_{i=1}^\infty r^i\right)=\bigcup_{i=1}^\infty\left(r^i\left(\bigcup_{j=1}^\infty r^j\right)\right)=\bigcup_{i=1}^\infty\left(\bigcup_{j=1}^\infty \left(r^i r^j\right)\right)$
...
根据[[MK61][幂]]定义可得 $(r^*)^1=r^*$ 则有 $r^*\subset r^*r^*$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $r^*=r^*r^*$
...
同理根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $r^*=r^{ * *}$
...
$S$ ：是[[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]的，元素为状态的[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]]

$\Sigma$ ：[[MK48][输入带]]中[[MK3][字符串]]依据的[[MK1][字母表]]，满足 $\epsilon\not\in\Sigma$

$\delta$ ：若为为 $\delta:S\times\Sigma\cup\{\epsilon\}\to S$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，则定义为包含空边的DFA

    若为为 $\delta:S\times\Sigma\to S$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，则定义为 *不* 包含空边的DFA
...
则存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,a_1),\delta(s_1,a_2),...,\delta(s_{n-1},a_n)>$ 满足：
...
$\delta$ ：为 $\delta:S\times\mathcal{R}(\Sigma)\to\rho(S)$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，其中 $\rho(S)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK25][幂集]] $\mathcal{R}(\Sigma)$ 是 $\Sigma$ 产生的所有[[MK57][正规式]]集合
...
则存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,\sigma_1),\delta(s_1,\sigma_2),...,\delta(s_{m-1},\sigma_m)>$ 满足：
...
$\delta$ ：为 $\delta:S\times(\Sigma\cup\{\epsilon\})\times\Gamma\to S\times\Gamma^*$ 的动作[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

**** 动作函数<<MK72>>

动作[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $\delta$ 的自变量 $<<q,a>,z>\in S\times(\Sigma\cup\{\epsilon\})\times\Gamma$ 表示：
...
由于 $r(s_a,s_b)$ 的定义，故对于给定 $<s_a,s_b>$ 在 $f$ 中有唯一对应的 $r(s_a,s_b)$ 故 $f$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
（1） 显然 $t$ 是[[~/文档/note/离散数学/Disc_Math.org::MK232][通道]]
...
故类似可证 $L(M)\subset L(M')$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(M')$

***** （2）

对于任意[[MK53][状态转换图]] $M’=<<S,E>,\Sigma,f,T,F>$ 

由于 $<S,E>$ 是无[[~/文档/note/离散数学/Disc_Math.org::MK213][重边]]的[[~/文档/note/离散数学/Disc_Math.org::MK221][有向图]]，故有 $|S|<\infty,|E|<\infty$
...
根据 $S(s,\sigma)$ 构造显然对于给定 $<s,\sigma>$ 在 $\delta$ 中有唯一 $S(s,\sigma)$ 与之对应，故 $\delta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]

则定义 $M=<S,\Sigma,\delta,T,F>$ 满足[[MK69][NFA]]定义，则对于任意 $\alpha\in M$ 

根据[[MK70][定义]]存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,\sigma_1),...,\delta(s_{m-1},\sigma_m)>$ 满足：
...
（1） 是[[~/文档/note/离散数学/Disc_Math.org::MK232][通道]]
...
则类似可证 $L(M)\subset L(M')$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(M')$
...
根据[[MK70][定义]]对于任意 $\alpha\in L(M_2)$ 有[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $l=<\delta_2(s_0,\sigma_1),...,\delta_2(s_{m-1},\sigma_m)>$ 满足
...
最终得 $\forall\alpha\in L(M_2)\rightarrow \alpha\in L(M_1)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]可得 $L(M_2)\subset L(M_1)$

同理可得 $L(M_1)\subset L(M_2)$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]有 $L(M_2)= L(M_1)$
...
故有 $\forall\alpha\in L(R)\rightarrow\alpha\in L(M)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $L(r)\subset L(M)$

类似易证 $L(M)\subset L(r)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(r)$ 即[[MK73][等价]]
...
以下仅证明 $L(M_3)\subset L(M_2)$ 类似可证 $L(M_2)\subset L(M_3)$ 进而根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M_2)=L(M_3)$
...
（2） 对每一个 $I\in H$ 定义 $I'=\bigcup\left\{\epsilon\text{-closure}(I_0)\big|(<<s,a>,I_0>\in\delta_2)\land(s\in I)\right\}$ 为[[~/文档/note/离散数学/Disc_Math.org::MK34][广义并]]
...
故 $\delta_3(I,a)$ 有唯一映射 $I^*$ 故 $\delta_3:H\times\Sigma/\{\epsilon\}\to H$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] 
...
****** 存在对应[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]]<<MK81>>
...
存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta_3(I_0,a_1),...,\delta_3(I_{n-1},a_n)>$ 满足：
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $L(M_3)\subset L(M_2)$
...
对于任意 $\alpha=a_1...a_n\in L(M')$ 根据[[MK68][条件]]存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $r'=<\delta'(s_0,a_1),...,\delta'(s_{n-1},a_n)>$ 满足：

（1） $\left(s_0=t'\right)\land\left(\delta'(s_{n-1},a_n)\in F'\right)\land\left(s_i\in S',1\leq i\leq n\right)$ 

（2） $\delta'(s_{i-1},a_i)=s_i,1\leq i\leq n$

以下仅证 $L(M')\subset L(M)$ ，类似可证 $L(M)\subset L(M')$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(M')$
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $L(M’)\subset L(M)$
...
（2） 当已划分等价状态为 $I_k=\{I_0,...,I_n\}$ 时，对于 $I_i$ 对每一个 $a\in\Sigma$ 取 $I^{(a)}_i=\left\{\delta(s,a)|s\in I_i\right\}$
     ...
     反复运用改规则，直至 $|I_{k^*}|$ [[~/文档/note/离散数学/Disc_Math.org::MK3][基数]]不再增加

第二步进一步说明，若存在 $\{z_1,z_2\}\subset I_i$ 满足 $\delta(z_1,a)=z'_1\in I_u\in I_k,\delta(z_2,a)=z'_2\in I_v\in I_k$ 

由于已知 $I_u,I_v$ 中元素非[[MK52][等价状态]]则存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,a_1),...,\delta(s_{n-1},a_n)>$ 满足：
...
显然根据 $\delta$ 构造规则对于任意 $A\in V_N\land \sigma\in V_T^*$ 映射 $\delta$ 有且仅有一个相，故 $\delta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
对于任意 $\alpha=a_1...a_n\in L(M)$ 存在[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s_0,\sigma_1),...,\delta(s_{m-1},\sigma_m)>$ 满足：
...
故有 $\forall\alpha\in L(M)\rightarrow \alpha\in L(G)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $L(M)\subset L(G)$

类似易证 $L(G)\subset L(M)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(G)$
...
故根据[[MK68][定义]]有 $\alpha\in L(M)$ ，则有 $\forall\alpha\in L(M)\rightarrow \alpha\in L(G_R)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $L(M)\subset L(G_R)$

类似易证 $L(G_R)\subset L(M)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(G_R)$
...
则有 $\forall\alpha\in L(M)\rightarrow \alpha\in L(G_L)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $L(M)\subset L(G_L)$

类似易证 $L(G_L)\subset L(M)$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $L(M)=L(G_L)$
...
根据定义，最左归约是最右推导的逆过程。由于是[[MK14][上下文无关]]，故[[MK10][产生式]]左部仅含有一个[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

故若有[[MK20][句型]]其最右[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]不存在与任意[[MK10][产生式]]的左部，则其无法产生[[MK21][句子]]

故对于任意最右推导得的 $w\in L(G)$ 其被[[MK18][推导]]部分的必是当前[[MK20][句型]]中最右[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

****** 充分

假设若 $w\in L(G)$ 被最右归约时被[[MK19][归约]]的部分右边含有非终结符

则其逆过程，即被[[MK18][推导]]部分不是最右[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]，与最左归约是最左推导的逆过程的逆过程矛盾。
...
是 $s\Rightarrow \alpha\beta\omega$ 对应的[[MK27][分析树]]上[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]大于 $2$ 的[[~/文档/note/离散数学/Disc_Math.org::MK298][子树]]的末端
...
则根据[[MK32][定理3]]有 $D'=<M',E',\prec',f'>$ 满足 $D'\simeq\delta A\omega\land f(r')=s$ 其中 $r'$ 是 $D'$ 的[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]
...
若满足条件（1）（2），则定义 $D$ 的[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]是 $r$ ，若 $v\in K\land v=r$ 则显然直接短语是 $s$

若 $v\in K\land v\ne r$ 则显然 $v$ 是[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]，定义 $X=M/(\mathcal{A}(v)/\{v\}),Y=\mathcal{A}(v)\cup\{v\}$
...
定义 $K=\left\{v\big|\mathcal{H}(v)=1\land v\in M\right\}$ 即[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$ 的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]

定义 $K$ 基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK189][最小元]]为 $v$ ，定义 $v$ 的[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]] $\mathcal{S}(v)$ 及其基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $u_1\prec...\prec u_n$
...
由于是句型，故根据[[MK31][推论]]可得存在[[MK27][语法树]] $D=<M,E,\prec,f>$ 满足 $D\simeq\alpha\land f(r)=s$ 其中 $r$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]

若 $K=\varnothing$ 则易证 $|M|=1$ 故 $M=\{r\}$ 由于 $f(r)=s$ 则 $D\simeq s$ 

由于 $\alpha\ne s$ 则有 $s\Rightarrow^+\alpha$ 则易证 $K\ne\varnothing$ 且 $|K|<\infty$ 

则根据[[MK39][定理1]]可依次去除 $K$ 中 $|K|$ 个节点的所有[[~/文档/note/离散数学/Disc_Math.org::MK244][有向可达]]的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]组成 $D$ 的[[MK38][分析子树]]

定义为 $D'=<M',E',\prec',f'>$ 易证 $K =\mathcal{L}(M')$ 

故 $K$ 有基于 $\prec'$ 的[[~/文档/note/离散数学/Disc_Math.org::MK191][排列]] $u_1\prec'...\prec'u_{|K|}$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK192][定理]]得 $\forall u_i\in K$ 必在排列上正好出现一次

则 $u_1$ 必在排列最左，且 $\forall u_k\in K\land u_k\ne u_1$ 必有 $u_1\prec'...\prec'u_k$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK172][传递性]] $u_1\prec'u_k$

由于 $D'$ 是 $D$ 分析子树，则根据[[MK40][定理1]]可得 $u_1\prec u_k$ 对于任意 $u_k\in K\land u_k\ne u_1$  

故根据[[~/文档/note/离散数学/Disc_Math.org::MK189][定义]] $v$ 是 $K$ 基于 $\prec$ 的[[~/文档/note/离散数学/Disc_Math.org::MK189][最小元]]
...
同理有 $y_i\in\mathcal{L}(M)$ 满足 $f(y_i)=Y_i\land<v,y_i>\in E$ 由于 $v\prec v_\gamma$ 且 $v$ 到 $x_i$ [[~/文档/note/离散数学/Disc_Math.org::MK244][有向可达]]
...
其中 $r$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]] $s$ 是[[MK11][开始符]]，定义其[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]节点数为 $n$ 
...
故可构建[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:V_N\times V_T\to P$
...
对于[[MK14][上下文无关文法]] $G=<V_N,V_T,P,s>$ 若其[[MK10][产生式]]的右部不含两个连续的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

则定义该文法为算符文法，此时称任意[[MK8][终结符]]为算符

***** 定理<<MK101>>

算符文法的任意[[MK20][句型]]中不含两个连续的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

****** 证明

定义算符文法 $G=<V_N,V_T,P,s>$ 对于任意一步[[MK18][推导]]的句型 $\alpha_1$ 有 $s\Rightarrow\alpha_1$

则有[[MK10][产生式]] $s\to\alpha_1\in P$ 根据定义有 $\alpha_1$ 不含两个连续的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

假设对于任意 $n$ 步推导句型 $\alpha_n$ 满足不含两个连续的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

则对于任意 $n+1$ 步推导句型 $\alpha_{n+1}$ 有 $s\Rightarrow^*\alpha_n\Rightarrow\alpha_{n+1}$

由于算符文法是上下文无关文法，故仅会替换 $\alpha_n$ 中的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]
...
根据算符文法定义对于任意 $A\to\beta\in P$ 其中 $\beta$ 不含两个连续的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]

结合假设可得 $\alpha_n$ 中的非终结符不连续出现可得 $\omega_i$ 中无连续非终结符

故得 $\alpha_{n+1}=\omega_1z_1\beta z_2\omega_2$ 中不含两个连续的[[~/文档/note/离散数学/Disc_Math.org::MK282][非终结符]]
...
对于[[MK103][算符优先文法]] $G=<V_N,V_T,P,s>$ 定义[[~/文档/note/高等代数/Algb-3-Matrix.org][矩阵基础-矩阵的表述]] $M_{|V_T|\times|V_T|}[a_{ij}]$
...
易证存在[[~/文档/note/离散数学/Disc_Math.org::MK294][深度]]最大的[[~/文档/note/离散数学/Disc_Math.org::MK279][分支]] $A$ ，满足 $A$ 到 $a_{j-1}$ ， $A$ 到 $a_{j}$ 均[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]

存在[[~/文档/note/离散数学/Disc_Math.org::MK294][深度]]最大的[[~/文档/note/离散数学/Disc_Math.org::MK279][分支]] $Q$ ，满足 $Q$ 到 $a_{j+k}$ ， $A$ 到 $a_{j+k+1}$ 均[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]

******** $A$ 到 $a_{j-1}$ ， $Q$ 到 $a_{j+k+1}$ [[~/文档/note/离散数学/Disc_Math.org::MK245][长度]]为 $1$

假设 $A$ 到 $a_{j-1}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK235][有向通路]]的[[~/文档/note/离散数学/Disc_Math.org::MK245][长度]]大于 $1$ ，则有分支 $B$ 满足:
...
故假设不成立 $A$ 到 $a_{j-1}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK235][有向通路]]的[[~/文档/note/离散数学/Disc_Math.org::MK245][长度]]不大于 $1$ ，则等于 $1$

同理易证 $Q$ 到 $a_{j+k+1}$ [[~/文档/note/离散数学/Disc_Math.org::MK245][长度]]为 $1$

******** 存在分支 $B,R$

假设 $A$ 到 $a_j$ [[~/文档/note/离散数学/Disc_Math.org::MK245][长度]]是 $1$ ，则对应产生式有 $A\to\omega a_{j-1}a_{j}\delta$ 

根据[[MK102][定义]]有 $a_{j=1}\doteq a_j$ 与条件不符，则假设不成立 $A$ 到 $a_j$ 距离不是 $1$

故 $A$ 到 $a_j$ 距离大于 $1$ ，同理易证 $Q$ 到 $a_{j+k}$ [[~/文档/note/离散数学/Disc_Math.org::MK245][长度]]大于 $1$
...
假设 $B\ne R$ 由于 $\alpha$ 是[[MK20][句型]]，则有推导 $s\Rightarrow^*\alpha$ 根据[[MK30][定理1]]存在[[MK27][分析树]] $D$ 其树[[~/文档/note/离散数学/Disc_Math.org::MK285][根]]有 $f(r)=s$

根据[[MK39][定理3]]可得去除 $B,R$ 所有[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]节点后仍可构造分析树 $D'$

根据[[MK32][定理4]]有对应 $f(r)\Rightarrow^*\alpha'$ ，由于 $B,R$ 对应节点是[[~/文档/note/离散数学/Disc_Math.org::MK277][叶]]，故 $\alpha'$ 中包含 $B,R$
...
根据[[MK39][定理3]]可基于 $B,R$ 及其所有[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]节点构造分析树 $D',D^*$
...
则根据[[MK39][定理3]]可基于 $B$ 及其所有[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]节点构造分析树 $D^*$

易证存在[[~/文档/note/离散数学/Disc_Math.org::MK294][深度]]最大的[[~/文档/note/离散数学/Disc_Math.org::MK279][分支]]对应 $A$ 满足 $A$ 到 $a_n,a_{n-1}$ 均[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]
...
（1） [[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:V_T\to\mathbb{N}$

（2） [[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $g:V_T\to\mathbb{N}$
...
定义 $X=\left\{f_a\big|a\in V_T\right\},Y=\left\{g_a\big|a\in V_T\right\}$ 则定义[[~/文档/note/离散数学/Disc_Math.org::MK259][有向二分图]]：

（1） $V=X\cup Y$

（2） $E=\left\{<f_a,g_b>\big|a\gtrdot b\lor a\doteq b\right\}\cup\left\{<g_b,f_a>\big|a\lessdot b\lor a\doteq b\right\}$

若 $<V,E>$ 中不含[[~/文档/note/离散数学/Disc_Math.org::MK238][有向圈]]

则定义 $f(a),g(a)$ 的值分别为 $f_a,g_a$ [[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]节点的个数（包含自身）
...
则 $f_a,g_b$ 之间有且仅有[[~/文档/note/离散数学/Disc_Math.org::MK211][边]] $<f_a,g_b>$ 且由于无圈，故 $g_b$ 不可达 $f_a$ 
...
则存在 $u\in K'$ 是[[MK92][句柄分支]]，则满足 $u\prec v$ 则根据[[MK27][定义]]可得 $<M',E'>$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][有根树]]

又由于 $\{u,v\}\subset K'$ 故 $\mathcal{S}(u)\subset\mathcal{L}(M')\land\mathcal{S}(v)\subset\mathcal{L}(M')$ 

则无[[~/文档/note/离散数学/Disc_Math.org::MK238][弱圈]]，故 $\mathcal{S}(u)\cap\mathcal{S}(v)=\varnothing$ 又根据[[MK27][定义（5）]]由 $u\prec v$ 可得 $u'\prec v',\forall u'\in\mathcal{S}(u)\land \forall v'\in\mathcal{S}(u)$
...
对于[[MK14][上下文无关文法]] $G=<V_N,V_T,P,s>$ 定义其扩展项目为二元[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<A\to\beta_{(i)},\rho>$
...
且仅有一个[[~/文档/note/离散数学/Disc_Math.org::MK293][分支]]节点，则显然[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]是唯一分支节点。故根据[[MK92][句柄]]定义可得 $\beta$ 是句柄
...
则存在有 $v'\in\mathcal{L}(M)$ 满足 $f(v)=X_k$ 定义 $K=\left\{v\big|\mathcal{H}(v)=1\land v\in M\right\}$ 即 $D$ 中[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$ 的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]
...
且对于 $v'$ 有 $f(v')=X_k$ 定义 $K'=\left\{v\big|\mathcal{H}(v)=1\land v\in M'\right\}$ 则有 $v'\in K'$ 即在 $D'$ 中[[~/文档/note/离散数学/Disc_Math.org::MK295][高]]为 $1$

若 $k<p$ 则有 $v'\prec v$ 根据[[MK40][定理2]]有 $v'\prec' v$ 又由于显然任意 $u\in K'\land u\ne v'\land u\ne v\Rightarrow u\in K$

故有 $v\prec u$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK172][传递性]]有 $\forall u\in K'\land u\ne v\Rightarrow v'\prec u$

若 $k\geq p$ 则 $v\not\in K'$ 类似易证亦有 $\forall u\in K'\land u\ne v\Rightarrow v'\prec u$

故 $v'$ 是 $D'$ 的[[MK92][句柄分支]]，则定 $v'$ 为[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]的[[MK38][分析子树]]所[[MK28][对应]]的[[MK3][字串]]是[[MK92][句柄]]
...
则根据[[MK93][定理1]]有句柄分支 $v$ ，定义 $\mathcal{A}(v)$ 为其所有[[~/文档/note/离散数学/Disc_Math.org::MK245][有向可达]]节点，定义 $N=M/(\mathcal{A}(v)/\{v\})$

故根据[[MK37][定理4]]有 $D_N\stackrel{v}\Rightarrow D$ 且 $D_N=<M',E',\prec',f'>$ 是 $D$ 的[[MK38][分析子树]]

进一步根据[[MK34][定理2]]有 $D_N\simeq\alpha A\delta\land f'(v)=f(v)=A$ 显然 $D_N,D$ 有相同的[[~/文档/note/离散数学/Disc_Math.org::MK285][树根]]

故根据[[MK32][推论]]以及[[MK34][定理2]]有 $s\Rightarrow^*\alpha A\delta\Rightarrow\alpha\beta\delta$ 

********* (2)

定义 $D_N$ 及其句柄分支 $u$ ，假设 $\alpha$ 中包含句柄，则 $u$ 到 $v$ 不[[~/文档/note/离散数学/Disc_Math.org::MK244][可达]]

由于 $D_N$ 是分析树，故根据[[MK27][定义]] $<M',E'>$ 是[[~/文档/note/离散数学/Disc_Math.org::MK285][有根树]]，故根据[[~/文档/note/离散数学/Disc_Math.org::MK288][性质1]] $r$ 到 $v$ 可达

故存在 $u'\in\left\{v\big|\mathcal{H}(v)=1\land v\in M'\right\}$ 满足 $u'$ 到 $v$ [[~/文档/note/离散数学/Disc_Math.org::MK244][可达]]

又根据[[MK92][定义]]有 $u\prec' u'$ 由于 $D_N$ 是 $D$ 的[[MK38][分析子树]]，则根据[[MK40][定理2]]有 $u\prec u'$

根据[[MK27][定义（4）]]结合 $u'$ 到 $v$ [[~/文档/note/离散数学/Disc_Math.org::MK244][可达]]有 $u\prec v$

且由于 $u$ 到 $v$ 不[[~/文档/note/离散数学/Disc_Math.org::MK244][可达]]，故根据[[MK33][分析树推导]]可得 $u\in K$ 与句柄[[MK92][定义]]矛盾
...
又根据构造易证 $\delta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]故得 $\delta:S\times\Sigma\to\rho(S)$ 满足[[MK69][定义]]，故成立
...
则有[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $<\delta(s\to\beta_{(0)},\beta[1]),...,\delta(s\to\beta_{(|\beta|-1)},\beta[|\beta|]})>$ 满足
...
（3） 对 $S$ 中每个元素 $C(I)$ ：
     ...
     （a） 对其中每一个 $A\to\alpha X\beta_{(|\alpha|),[\rho]}$ 形式的[[MK141][扩展项目]]
          ...
          进一步增加[[~/文档/note/离散数学/Disc_Math.org::MK194][映射]]关系 $\delta(C(I),X)=C'$ 到原有的 $\delta$ 中
...
根据[[MK120][定理]]可知任意包含[[MK92][句柄]]的[[MK114][活前缀]]可以被 $M$ 识别，故显然存在不同的[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]]满足[[MK68][识别条件]]

定义为 $r=<\delta(s_0,a_1),...,\delta(s_{n-1},\alpha[n])>,r_2=<\delta(s'_0,a_1),...,\delta(s'_{n-1},\alpha[m])>$ 

根据[[MK68][识别条件]]开始状态均为 $s_0=t$ 故有 $s_0=s'_0$

由于 $\delta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]函数且第二个参数不为 $\epsilon$ ，故对于同意字符 $\alpha[1]$ 可得 $\delta(s_0,\alpha[1])$ 后继状态唯一
...
则可以确定唯一满足[[MK70][识别条件]]且识别包含[[MK92][句柄]]的[[MK114][活前缀]]的[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]]
...
根据[[MK120][定理]]以及[[MK77][等价性]]可知 $\lambda$ 可以被 $M$ 识别，即存在满足[[MK68][识别条件]]的[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $r=<\delta(s_0,\lambda[1]),...,\delta(s_{n-1},\lambda[n])>$

假设存在任意有序组 $<\delta(s'_0,\lambda[1]),...,\delta(s'_{n-1},\lambda[n])>$ 亦满足[[MK68][识别条件]]

根据根据[[MK68][识别条件]]开始状态只能为 $s_0=t$ ，故有 $s'_0=s_0$

且根据[[MK67][DFA定义]] $\delta:S\times\Sigma\cup\{\epsilon\}\to S$ 是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]函数且第二个参数不为 $\epsilon$
...
根据[[MK93][定理1]]可得 $D_1,D_2$ 有[[MK92][句柄]] $\beta_1,\beta_2$ 及其[[~/文档/note/离散数学/Disc_Math.org::MK74][父节点]] $\delta,\lambda$

根据LR($k$)文法定义可确定唯一句柄及其归约产生式，故得 $\beta_1=\beta_2\land f_1(\delta)=f_2(\lambda)$

则继续定义 $g_1=g_0\cup\{<\delta,\lambda>\}$ 易证 $g_1$ 是分析函数

根据[[MK39][定理1]]可得 $D_1,D_2$ 去除 $\delta,\lambda$ 对应的[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]]后是[[MK38][分析子树]] $D_{11},D_{21}$
...
由于是[[MK119][LR($k$)文法]]，则根据[[MK123][之前证明]]可得有唯一[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $r=<\delta(s_0,\alpha[1]),...,\delta(s_{n-1},\alpha[n])>$ 满足[[MK70][识别条件]]
...
同理可得对于句型 $\alpha_1$ 亦有有唯一[[~/文档/note/离散数学/Disc_Math.org::MK151][有序组]] $r_1=<\delta(s'_0,\alpha_1[1]),...,\delta(s'_{m-1},\alpha_1[m])>$ 满足[[MK70][识别条件]]
...
一个[[MK145][字符]]的属性是由其在[[MK27][分析树]]中的[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]]的[[MK144][属性]]决定的，称为综合属性

**** 继承属性<<MK143>>

一个[[MK145][字符]]的属性是由其在[[MK27][分析树]]中的[[~/文档/note/离散数学/Disc_Math.org::MK297][父节点]]或自身的其他[[MK144][属性]]决定的，称为综合属性

推广定义中，亦可依赖于其[[~/文档/note/离散数学/Disc_Math.org::MK299][兄弟节点]]的属性

*** 推论

（1） [[MK8][终结符]]无[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]]，故仅有[[MK142][综合属性]]，由[[MK85][词法分析]]过程提供

（2） [[MK9][非终结符]]可有[[MK142][综合属性]]和[[MK143][继承属性]]

（3） [[MK11][开始符]]无[[~/文档/note/离散数学/Disc_Math.org::MK297][父节点]]或[[~/文档/note/离散数学/Disc_Math.org::MK299][兄弟节点]]，故其[[MK143][继承属性]]必须预先给定
...
根据[[MK27][分析树]]定义（4）可得产生式左部为[[~/文档/note/离散数学/Disc_Math.org::MK285][分支]]节点，右部为该分支的[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]]
...
代表语法分析器构建完该[[MK145][字符]]对应的[[MK27][分析树]]上的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]后运行 $\{\}$ 中的内容
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK222][有向无圈图]] $G=<V,E>$ 其中：

（1） $V$ 为所有[[MK144][属性]]的集合

（2） $E$ 为依赖关系，其中 $<v_1,v_2>\in E,\{v_1,v_2\}\subset V$ 表示 $v_1$ 依赖于 $v_2$ 进行计算

则可根据[[~/文档/note/离散数学/Disc_Math.org::MK322][拓扑排序]]确定先后计算顺序，进行属性计算

*** 树遍历

对于无循环依赖的[[MK146][语义规则]]，循环遍历[[MK27][分析树]]的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]，计算可以计算的[[MK144][属性]]

多遍扫描直至所有属性计算完毕。

**** 实现

构造函数visitNode([[~/文档/note/离散数学/Disc_Math.org::MK209][节点]])包含：

（1） 计算当前可以计算的[[MK144][属性]]

（2） 对于某节点的子节点自左向右扫描

对于非[[~/文档/note/离散数学/Disc_Math.org::MK292][叶]]的[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]]递归调用visitNode([[~/文档/note/离散数学/Disc_Math.org::MK209][节点]])
...
对于[[MK27][分析树]] $D=<M,E,\prec,f>$ 的每个[[~/文档/note/离散数学/Disc_Math.org::MK285][分支]]节点 $M(v)$ 以及其[[~/文档/note/离散数学/Disc_Math.org::MK297][子节点]] $\mathcal{S}(v)$ 满足以下其中一条：
...
即[[~/文档/note/离散数学/Disc_Math.org::MK222][有向图无圈图]]
...
定义[[MK155][基本块]]为[[~/文档/note/离散数学/Disc_Math.org::MK209][节点]] $V=\{v_1,...,v_n\}$

若基本块 $v_i$ 可能跳转到 $v_j$ ，则定义[[~/文档/note/离散数学/Disc_Math.org::MK211][有向边]] $<v_i,v_j>$

所有有向边集合定义为 $E$

最终定义 $G=<V,E>$ 为[[MK155][基本块]]形成的[[~/文档/note/离散数学/Disc_Math.org::MK221][有向图]]
