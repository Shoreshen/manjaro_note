...
对于任意 $g:\mathbb{N}^{n+1}\to\mathbb{N}$ 是[[~/文档/note/离散数学/lssx.org::MK175][函数]]存在为一 $f$ 是 $g$ [[MK115][递归定义]]的
...
根据[[MK114][性质4]]可得以下[[~/文档/note/离散数学/lssx.org::MK514][关系]]均存在[[MK105][等价表达]] $\phi$ ，且根据[[MK138][推论]]对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$

任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 有 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi$
...
（1） $a=\prec SN(c_i)\succ$ 即第 $i$ 个[[~/文档/note/数理逻辑/sllj.org::MK108][常元符号]]
...
（1） 存在[[MK105][等价表达]] $\phi_*$

（2） 对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 有 $\left<\mathfrak{N},v\right>\vDash\phi_*$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_*$
...
根据[[MK111][性质5]]可得存在 $\phi_\to(x_1,x_2,x_3)$ 满足 $\left<\mathfrak{N},v\right>\vDash\phi_\to$ 的充要条件是 $v(x_1)\in S_{\phi,\to}$ 且 $\left<v(x_2),v(x_3)\right>\in S_{\phi,\to}$
...
仅证 $\text{PrpIA}$ 其余同理可证，对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 

根据[[MK138][推论]]可得 $\phi_\to$ 满足 $\left<\mathfrak{N},v\right>\vDash\phi_\to$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_\to$ ，即 $\left<\mathfrak{N},v\right>\vDash\phi_i$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_i$ 

又根据[[MK120][ $\text{Frml}$ 关系]]可得 $\phi_{\text{Frml}}$ 亦有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{Frml}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{Frml}}$ 

根据[[MK62][推论]]可得 $\phi=\left(\exists y_1...y_8\left(\left(\bigwedge_{i=0}^5\phi_i\right)\land\phi_{\text{Frml}}(y_3)\land\phi_{\text{Frml}}(y_5)\land\phi_{\text{Frml}}(y_6)\right)\right)$

亦有 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi$ 

***** 性质2<<MK122>>

$\text{LAX}_0$ 存在[[MK105][等价表达]] $\phi_{\text{LAX}_0}$ 且 对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$

有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{LAX}_0}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{LAX}_0}$
...
由于 $\text{LAX}_0$ 是[[MK118][逻辑公理关系]]的[[MK108][布尔或组合]]，且根据[[MK121][性质1]]可得被组合的[[~/文档/note/离散数学/lssx.org::MK514][关系]]的[[MK105][等价表达]] $\phi$

均满足 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi$ 。根据[[MK139][性质4]]可得 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{LAX}_0}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{LAX}_0}$

***** 性质3<<MK123>>

$\text{GLB}$ 存在[[MK105][等价表达]] $\phi_{\text{GLB}}$ 且对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$

有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{GLB}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{GLB}}$
...
根据[[MK138][推论]]可得 $S_{\phi,\forall}(a)$ 满足相关条件的[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]] $\phi_\forall(x_1,y_1,y_2),\phi_$ 有 $\left<\mathfrak{N},v\right>\vDash\phi_\forall$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_\forall$

根据[[MK122][性质2]]可得 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{LAX}_0}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{LAX}_0}$

根据[[MK116][拆分关系]]有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{Vrble}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{Vrble}}$

则根据上一步有 $\phi_{\test{GLB}}=\left(\exists y_2\left(\exists y_2\left(\phi_\forall(x_1,y_1,y_2)\land\phi_{\text{Vrble}}(y_1)\land\phi_{\text{LAX}_0}(y_2)\right)\right)\right)$

根据[[MK62][推论]]即有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{GLB}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{GLB}}$

***** 性质4<<MK127>>

$\text{LAX}$ 存在[[MK105][等价表达]] $\phi_{\text{LAX}}$ 且对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$

有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{LAX}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{LAX}}$
...
由于 $\text{LAX}$ 是 $\text{LAX}_0$ 与 $\text{GLB}$ 的[[MK108][布尔或组合]]，根据[[MK122][性质2]]以及[[MK123][性质3]]可得：

（1） $\left<\mathfrak{N},v\right>\vDash\phi_{\text{LAX}_0}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{LAX}_0}$

（2） $\left<\mathfrak{N},v\right>\vDash\phi_{\text{GLB}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{GLB}}$

根据[[MK139][性质4]]可得 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{LAX}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{LAX}}$

**** 有效[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]集合<<MK141>>

对于任意[[~/文档/note/数理逻辑/sllj.org::MK151][可数语言]] $\mathcal{L}_\mathcal{A}$ 的[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]集合 $\Gamma$ 若满足：

（1） 存在 $\mathcal{L}_{\mathcal{A}_{N}}$ 上的[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]] $\phi(x_1)$ 满足 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是存在 $\psi\in\Gamma$ 使得 $\lceil\psi\rceil=v(x_1)$

（2） 对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 有 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi$

     其中 $e(n)=\bar{I}(n),\forall n\in\mathbb{N}$

则称 $\Gamma$ 为有效[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]集合

***** 性质<<MK140>>

任意[[~/文档/note/数理逻辑/sllj.org::MK151][可数语言]] $\mathcal{L}_\mathcal{A}$ 的[[~/文档/note/数理逻辑/sllj.org::MK129][表达式]]集合 $\Gamma$ 是[[MK141][有效表达式集合]]

****** 证明

由于有限，故定义 $\gamma=\{\psi_1,...,\psi_n\}$

******* 存在[[MK105][等价表达]]

对于任意 $\psi_i$ 定义 $\text{Is}_\psi(x_1)=(x_1\hag{=}\tau_{\lceil\psi_i\rceil})$ 其中 $\tau_i$ 满足[[MK13][定义]]， $\lceil\psi_i\rceil$ 是 $\psi_i$ 的[[MK46][哥德尔数]]

显然有 $\left<\mathfrak{N},v\right>\vDash\text{Is}_{\psi_i}(x_1)$ 的充要条件是 $v(x_1) =\lceil\psi_i\rceil$ ，定义 $\phi=\left(\bigvee_{i=1}^n\psi_i(x_1)\right)$

显然 $\phi$ 满足[[MK141][条件（1）]]

******* 充要条件

上一步中 $\phi$ 不含[[~/文档/note/数理逻辑/sllj.org::MK106][量词]]，故根据[[MK60][引理4]]可得 $\left<\mathfrak{N},v\right>\vDash\phi$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{NLAX}$
...
（4） $\phi_{\text{Subst}}(x_1,x_2,x_3,x_4)$ 为[[MK125][ $\text{Subst}(a,b,c)$ 函数]]根据[[MK142][性质2]]得出的[[MK102][等价表达]]
...
根据[[MK138][推论]]、[[MK120][ $\text{Frml}$ ]]、[[MK62][推论]]、[[MK72][推论]]、[[MK142][性质2]]易证 $\left<\mathfrak{N},v\right>\vDash\phi_R$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_R$ 
...
根据[[MK149][之前证明]]、[[MK120][ $\text{Frml}$ ]]、[[MK120][ $\text{Free}$ ]]、[[MK62][推论]]、[[MK72][推论]]、[[MK142][性质2]]、[[MK137][引理]]
...
$\text{Subst}(a,b,c)$ 存在[[MK102][等价表达式]] $\phi_{\text{Subst}}(x_1,x_2,x_3,x_4)$ 且

对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 有 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{Subst}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{Subst}}$
...
根据[[MK115][性质4]]可得类似 $h(SN(f_s),SN((),x,SN()))=\prec SN(f_s),SN((),x,SN())\succ$ 存在[[MK102][等价表达]]

又由于类似 $SN(f_s)$ 均为常值函数，根据[[MK99][性质3]]可得常值函数是[[MK81][递归函数]]，根据[[MK77][定理1]]可得存在[[MK102][等价表达]]

又根据[[MK119][性质5]]以及[[MK114][推论]]易证类似 $\left<a_1,a_2\right>\in S_{\tau,+}(a)$ 以及 $f_1(a)=a_1,f_2(a)=a_2$ 存在[[MK102][等价表达]]

又显然由表达式有限易证[[MK117][条件（a~d）]]，故根据[[MK117][推论1]]即可得 $\text{Subst}(a,b,c)$ 存在[[MK102][等价表达式]]

******* 充要条件

对于任意 $\mathcal{L}_{\mathcal{A}_{N}}$ 的[[~/文档/note/数理逻辑/sllj.org::MK153][结构]] $\mathcal{M} =\left<M,I\right>\vDash T_{N}$ 任意 $\mathfrak{N}$ 的[[~/文档/note/数理逻辑/sllj.org::MK154][赋值]] $v$ 

根据[[MK115][性质4]]可得类似 $h(SN(f_s),SN((),x,SN()))=\prec SN(f_s),SN((),x,SN())\succ$ 其[[MK102][等价表达]] $\phi_h$

满足 $\left<\mathfrak{N},v\right>\vDash\phi_h$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_h$

又由于类似 $SN(f_s)$ 均为常值函数，根据[[MK99][性质3]]可得常值函数是[[MK81][递归函数]]，

根据[[MK134][推论1]]可得其[[MK102][等价表达]] $\phi_s$ 满足 $\left<\mathfrak{N},v\right>\vDash\phi_s$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_s$

根据[[MK138][推论]]易证类似 $\left<a_1,a_2\right>\in S_{\tau,+}(a)$ 以及 $f_1(a)=a_1,f_2(a)=a_2$ 的[[MK102][等价表达]] $\psi$

满足 $\left<\mathfrak{N},v\right>\vDash\psi$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\psi$

则根据[[MK117][推论1]]可得 $\phi_{\text{Subst}}(x_1,x_2,x_3,x_4)$ 满足 $\left<\mathfrak{N},v\right>\vDash\phi_{\text{Subst}}$ 的充要条件是 $\left<\mathcal{M},v\cdot e\right>\vDash\phi_{\text{Subst}}$
