...
（1） $P=\left\{P(a)\big|a\in V\right\}=M_{1\times n}$ 其中右边为 $1$ 行 $n$ 列的[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK6][矩阵]]

（2） $\mathcal{V}'=<M_{1\times n},K,\bar{+},\bar{\cdot}>$ 亦为[[MK1][线性空间]]且与 $\mathcal{V}$ [[MK75][同构]]，其中 $\bar{ +},\bar{\cdot}$ 分别为[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK2][矩阵加法]]和[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK3][矩阵数乘]]
...
根据[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK5][矩阵乘法]] $\vec{a}=\left[\begin{matrix}k_1&k_2&...&k_n\end{matrix}\right]\left[\begin{matrix}\vec{a}_1\\\vec{a}_2\\...\\\vec{a}_n\end{matrix}\right]$ 显然 $\left[\begin{matrix}k_1&k_2&...&k_n\end{matrix}\right]\in M_{1\times n}$ 故 $P\subset M_{1\times n}$
...
故根据[[~/OneDrive/离散数学/Disc_Math.org::MK21][自反性]]可得 $P=\left\{P(a)\big|a\in V\right\}=M_{1\times n}$ 

***** 证明（2）

根据[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK10][矩阵空间]]可得 $\mathcal{V}'=<M_{1\times n},K,\bar{+},\bar{\cdot}>$ 为[[MK1][线性空间]]，根据[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK20][矩阵空间的基]]可得 $\dim(\mathcal{V}')=n$
...
根据[[~/OneDrive/高等代数/Algb-3-Matrix.org::MK49][矩阵运算]] $\sum_{i=1}^nk_i\left[\begin{matrix}k_{b_i,1}&k_{b_i,2}&...&k_{b_i,n}\end{matrix}\right]=\left[\begin{matrix}\sum_{i=1}^nk_ik_{b_i,1}&\sum_{i=1}^nk_ik_{b_i,2}&...&\sum_{i=1}^nk_ik_{b_i,n}\end{matrix}\right]$
