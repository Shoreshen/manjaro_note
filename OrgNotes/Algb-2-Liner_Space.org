...
线性空间 $\mathcal{V}=<V,K,+,\cdot>$ ，若存在 $S\subset V,S\ne\varnothing$ 定义 $\text{span}(S)=\left\{\sum_{i=1}^n k_i\vec{a}_i\big|k_i\in K\land\vec{a}_i\in S\land n\in\mathbb{N}\right\}$ 
...
则称 $\mathcal{V}_1+\mathcal{V}_2$ 为直和，记为 $\mathcal{V}_1\oplus\mahtcal{V}_2$

**** 性质1<<MK69>>

以下四个条件：

（1） $\mathcal{V}_1+\mathcal{V}_2$ 为直和
...
移项得 $\vec{v}=\vec{b}_1-\vec{c}_1=\vec{c}_2-\vec{b}_2$ 显然 $\vec{b}_1-\vec{c}_1\in V_1,\vec{c}_2-\vec{b}_2\in V_2$ 即有 $\vec{v}\in V_1\cap V_2$

根据 $V_1\cap V_2=\{\vec{0}\}$ 即有 $\vec{0}=\vec{v}=\vec{b}_1-\vec{c}_1=\vec{c}_2-\vec{b}_2$ 故有 $\vec{b}_1=\vec{c}_1,\vec{c}_2=\vec{b}_2$ 即表述唯一
