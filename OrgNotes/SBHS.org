...
定义[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]] $\{A_i\}_{i\in\mathbb{N}}$ 其中[[~/文档/note/离散数学/Disc_Math.org::MK13][标志集]]是正整数

** 集合列上下确界

定义[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]] $\{A_i\}_{i\in\mathbb{N}}$

根据[[~/文档/note/离散数学/Disc_Math.org::MK29][集合族运算]]
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]] $\{A_i\}_{i\in\mathbb{N}}$ ，则根据[[~/文档/note/离散数学/Disc_Math.org::MK29][集合族运算]]
...
根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-包含]]可得 $\underline{\lim_{n\to\infty}}A_n\subset\overline{\lim_{n\to\infty}}A_n$ 
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]] $\{A_i\}_{i\in\mathbb{N}}$ 定义
...
则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-包含-定理1]]可得 $\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)=\cap_{i\geq 1}\left(\cup_{k\geq i}A_k\right)$ 
...
则有 $a\in\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)$ ，根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-包含]]可得 $\cap_{i\geq 1}\left(\cup_{k\geq i}A_k\right)\subset\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)$ 
...
根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-包含]]可得 $\cap_{i\geq 1}\left(\cup_{k\geq i}A_k\right)\subset\cup_{i\geq 1}\left(\cap_{k\geq i}A_k\right)$ 
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]] $\{A_i\}_{i\in\mathbb{N}}$ ，若[[MK1][上下极限]]相等，即 $\overline{\lim_{n\to\infty}}A_n=\underline{\lim_{n\to\infty}}A_n$
...
设 $T$ 是 $X$ 的非空子集的[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]]若满足：
...
设 $T$ 是 $X$ 的非空子集的[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]]
...
定义对于[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]] $A$ 的[[~/文档/note/离散数学/Disc_Math.org::MK35][广义并]]为 $\bigcup A$ 同理定义广义交为 $\bigcap A$

定义 $F\subset T$ 以及 $F^c=\left\{f^c\big|f\in F\right\}$ 根据 $T^c$ 定义显然有 $F^c\subset T^c$

则根据[[~/文档/note/离散数学/Disc_Math.org::MK331][集合族运算与补]]可得 $\left(\bigcup F\right)^c=\bigcap\left\{f^c\big|f\in F\right\}=\bigcap F^c$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK333][集合族运算与交并]]有 $Y\cap\bigcup F=\bigcup\left\{f\cap Y\big|f\in F\right\}=\bigcup F_Y$
...
定义 $Z=\left\{x\cap Y\big|x\in T^c\right\}$ 则根据下列证明以及[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $T_Y^c=Z$
...
则有 $Y-y=x\cap Y$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK334][补与减]]以及[[~/文档/note/离散数学/Disc_Math.org::MK39][交换律]]可得 $y^c\cap Y=x\cap Y$

故根据[[~/文档/note/离散数学/Disc_Math.org::MK335][补与并]]可得 $y\cap Y=x^c\cap Y$ 又由于 $t\subset Y\land y=Y-t$ 可得 $y\subset Y$
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK334][补与减]]、[[~/文档/note/离散数学/Disc_Math.org::MK328][德摩根律]]以及[[~/文档/note/离散数学/Disc_Math.org::MK327][分配律]]
...
对于满足[[~/文档/note/离散数学/Disc_Math.org::MK194][函数定义]]的函数 $f:X\to Y$ 

其 $G\subset Y$ 的原相定义为 $f^{-1}(G)=\left\{x\big|f(x)\in G\land x\in X\right\}$

注：原相不同于[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]]，逆函数可能不存在。此处仅标识相同，实际问题需要区分。

**** 性质<<MK135>>

定义[[~/文档/note/离散数学/Disc_Math.org::MK194][定义]] $f:X\to Y$ ，定义[[MK151][原相]]为 $f^{-1}(Y_\lambda)=\left\{x\big|f(x)\in Y_\lambda\land x\in X\right\}$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK194][函数定义]] $\forall x\in X\rightarrow\exists y\left(y\in Y\land f(x)=y\right)$ 故有以下证明

****** （1）

则对于任意 $x\in f^{-1}\left(\bigcup_{\lambda\in\Lambda} Y_\lambda\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK29][运算]]可得 $f(x)\in\bigcup_{\lambda\in\Lambda} Y_\lambda\rightarrow\exists \lambda^*\in\Lambda\rightarrow f(x)\in Y_{\lambda^*}$
...
同理对于任意 $x\in\bigcup_{\lambda\in\Lambda} f^{-1}(Y_\lambda)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK29][运算]]可得 $\exists\lambda^*\rightarrow x\in f^{-1}(Y_{\lambda^*})$ 进一步有 $f(x)\in Y_{\lambda^*}$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $f^{-1}\left(\bigcup_{\lambda\in\Lambda}Y_\lambda\right)=\bigcup_{\lambda\in\Lambda}f^{-1}\left(Y_\lambda\right)$ 

****** （2）

则对于任意 $x\in f^{-1}\left(\bigcap_{\lambda\in\Lambda} Y_\lambda\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK29][运算]]可得 $f(x)\in\bigcap_{\lambda\in\Lambda} Y_\lambda\rightarrow\forall \lambda\in\Lambda\rightarrow f(x)\in Y_{\lambda}$

即 $\forall\lambda\in\Lambda\rightarrow x\in f^{-1}(Y_{\lambda})$ 故得 $x\in\bigcap_{\lambda\in\Lambda} f^{-1}(Y_\lambda)$

同理对于任意 $x\in\bigcap_{\lambda\in\Lambda} f^{-1}(Y_\lambda)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK29][运算]]可得 $\forall\lambda\in\Lambda\rightarrow x\in f^{-1}(Y_{\lambda})$ 即 $\forall\lambda\in\Lambda\rightarrow f(x)\in Y_{\lambda}$

故得 $f(x)\in\bigcap_{\lambda\in\Lambda} Y_\lambda$ 即 $x\in f^{-1}\left(\bigcap_{\lambda\in\Lambda} Y_\lambda\right)$

故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $f^{-1}\left(\bigcap_{\lambda\in\Lambda}Y_\lambda\right)=\bigcap_{\lambda\in\Lambda}f^{-1}\left(Y_\lambda\right)$

****** （3）

则对于任意 $x\in f^{-1}\left(Y^c\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK29][运算]]可得 $f(x)\in Y^c\leftrightarrow f(x)\not\in Y$

故对于任意 $x\in f^{-1}(Y^c)\leftrightarrow f(x)\not\in Y\leftrightarrow x\not\in f^{-1}(Y)\leftrightarrow x\in(f^{-1}(Y))^c$

故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $f^{-1}(Y^c)=(f^{-1}(Y))^c$

*** 连续函数<<MK115>>

[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:X\to Y$ 其中 $X,Y$ [[MK39][拓扑空间]]
...
（2） $\{f_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
根据[[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]可得存在 $N_{x_0}$ 满足对于任意 $n>N_{x_0},x\in E$ 均有 $d(f_n(x),f(x))<\frac{\delta(x_0)}{3}$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $K=f^{-1}(S)$ 又由于 $K=\bigcup_{x\in f^{-1}(S)}u(x)$ 且 $u(x)\in\tau_X$
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK310][代数结构]] $<X,d>$ 运算 $d:X\times X\to\mathbb{R}$ 满足：
...
此处 $\rightarrow$ 为[[~/文档/note/离散数学/Disc_Math.org::MK60][蕴含]]，对于空集 $\vec{x}\in\varnothing$ 永假

则根据真值表 $\forall x\in\varnothing\rightarrow\exists\delta(O(x,\delta)\subset\varnothing)$ 永真，故空集为开集

***** 全集

对于任意 $x'\in O(x,\delta)$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]均有 $x'\in X$ 故根据定义必有 $O(x,\delta)\subset X$
...
（3） [[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个元素的并封闭 $A_i\in\sigma(X)\rightarrow\bigcup_{i=1}^\infty A_i\in\sigma(X)$
...
根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的计算-性质]]中德摩根率可得 $\bigcap_{i=1}^\infty S_i=((\bigcap_{i=1}^\infty S_i)^c)^c=\left(\bigcup_{i=1}^\infty S_i^c\right)^c$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK334][补与减]]可得 $S_1-S_2=S_1\cap S^c_2$ 根据[[MK50][定义]]中（3）以及[[MK67][交封闭]]得 $S_1\cap S_2^c\in\sigma(X)$
...
根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-相关定义-函数定义]]可得对于任意 $x\in E$ 均有 $y\in K$ 满足 $f(x)=y$
...
则对于任意 $x\in g\left(\bigcup_{i=1}^\infty X_i\right)$ 根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的计算-运算]]可得 $f(x)\in\bigcup_{i=1}^\infty X_i\leftrightarrow\exists i\in\mathbb{N}\rightarrow f(x)\in X_i$
...
故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-ZFC公理化集合论-外延公理]]可得 $g\left(\bigcup_{i=1}^\infty X_i\right)=\bigcup_{i=1}^\infty g(X_i)$
...
故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-ZFC公理化集合论-外延公理]]可得 $\left(g(X)\right)^c=g(X^c)$
...
对于集合 $X$ 的任意[[~/文档/note/离散数学/Disc_Math.org::MK20][子集]] $F\subset X$ 定义 $G=\left\{F\cap g\big|g\in\sigma(X)\right\}$ 则 $G$ 是 $F$ 上的[[MK50][ $\sigma$ 代数]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK327][分配律]]可得 $F\cap\left(\bigcup_{i=1}^\infty x_i\right)=\bigcup_{i=1}^\infty(x_i\cap F)=\bigcup_{i=1}^\infty f_i\in G$
...
（1）[[~/文档/note/离散数学/Disc_Math.org::MK328][德摩根律]]

（2）[[~/文档/note/离散数学/Disc_Math.org::MK78][德摩根律]]

（3）[[~/文档/note/离散数学/Disc_Math.org::MK77][分配率]]
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]] $g^{c_F}=x^{c_X}\cap F\in G$
...
定义 $L=\left\{Y\cap x\big|x\in\sigma_\Phi(X)\right\}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]证明以下结论，故有 $L=\sigma_{\Psi}(Y)$
...
根据[[~/文档/note/离散数学/Disc_Math.org][命题逻辑-命题公式-逻辑等价-逻辑等价式举例]]-分配率有 $Y\cap\left(\bigcup_{i=1}^\infty A_i\right)\in\sigma_{\Psi}(Y)$
...
同理可证 $\sigma_{\mathcal{C}}(X)\subset\mathcal{B}(X)$ 故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-子集-自反性]]可得 $\sigma_{\mathcal{C}}(X)=\mathcal{B}(X)$ 
...
（3） 可数可加性： $\rho(\bigcup_{i=1}^\infty A_i)=\sum_{i=1}^\infty\rho(A_i),A_i\in\Gamma$ 注意此处 $i$ 为[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个，且当 $i\ne j$ 时 $A_i\cap A_j=\varnothing$

则称 $\rho$ 是 $X$ 上的测度，其中 $\Gamma$ 是可测集。

** 外测度<<MK61>>

定义集合 $X$ 则定义映射 $\varphi:\rho(X)\to\mathbb{R}^+\cup\{\infty\}$ 其中 $\rho(X)$ 是 $X$ 的[[~/文档/note/离散数学/Disc_Math.org::MK25][幂集]]
...
定义结构 $<X,\varphi>$ 其中 $E$ 为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $\varphi$ 是[[MK61][外侧度]]
...
若结构体 $<X,\varphi>$ 其中 $X$ 为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $\varphi$ 是 $X$ 上的[[MK61][外测度]]，则定义该结构体为 $X$ 的测度空间
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK329][集合计算]]易证得 $((A/S)\cap Y)\cup(A/Y)=A/S$
...
定义[[MK212][外侧度空间]] $<X,\varphi>$ 其中 $X$ 为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $\varphi$ 是[[MK61][外侧度]]
...
则根据可测集定义，[[MK61][次可加性]]以及[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的计算-性质]]中分配率、结合律、补与减有：
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK328][德摩根律]] $\left(S^c_j\cup\left(\bigcup_{i=1}^{j-1} S_i\right)^c\right)^c=S_j\cap\left(\bigcup_{i=1}^{j-1} S_i\right)^c=S_j/\left(\bigcup_{i=1}^{j-1} S_i\right)=S'_j$ 
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK21][定理1]]可得 $\bigcup_{i=1}^\infty S_i=\bigcup_{i=1}^\infty S'_i$
...
直线（ $\mathbb{R}$ ）上的开集可表示为[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的[[MK42][构成区间]]的并
...
对每一个构成区间任取一个有理数，则构成[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-特殊的函数类型-单射]]

进一步根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-基数]]可得 $|T|\leq|\mathbb{Q}|$ 
...
由于是[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]，故 $x$ 是[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]故有 $\exists\delta>0\land\delta\in\mathbb{R}\rightarrow(x-\delta,x+\delta)\subset G$ 故 $A\ne\varnothing$
...
若 $\alpha\in G$ 由于 $G$ 是[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]，则存在 $O(\alpha,\delta)\subset G$

结合上述证明可得 $(\alpha-\delta,\beta)\subset G$ 与下确界定义矛盾，故 $\alpha\not\in G$ 同理可证 $\beta\not\in G$

故 $(\alpha,\beta)$ 是 $x$ 在 $G$ 上的构成区间，即 $(\alpha,\beta)\in T$ 故 $x\in G'$

综上所属 $\forall x\in G'\rightarrow x\in G\land \forall x\in G\rightarrow x\in G'$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $G'=G$

**** 推论<<MK155>>

对于[[MK143][广义实数]]定义上的直线，开集可有由[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的实数[[MK42][构成区间]]的并之后，与 $\pm\infty$ 的组合并组成

***** 证明

根据[[MK152][定理3]]可得广义实数 $\mathbb{R}_e$ 上的开集由 $\mathbb{R}$ 上的开集与 $\pm\infty$ 的组合并组成

由于 $\mathbb{R}$ 上的开集可有由[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的实数[[MK42][构成区间]]的并表示。
...
对于任意闭集 $K\in\mathbb{R}$ 根据[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-集合定义-部分定理-定理1]]可得其补集 $K^c$ 是开集
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK34][完备集]]可得不含孤立点的闭集是完备集。

假设点 $x$ 是[[~/文档/note/数学分析/Chap11Note.org::MK14][孤立点]]，则根据定义存在 $\delta>0$ 使得去心领域 $O(x,\delta)/x$ 不属于 $S$

根据[[MK48][闭集构造]]可得任意闭集均可表示为为直线 $\mathbb{R}$ 去掉至多可数个开区间的并。

根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]]得 $S$ 的补集 $S^c$ 是开集
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK40][结合律]]可得 $E'_ {n+1}=\bigcup_{\lambda\in\Lambda_{n+1}}[a_{\lambda},b_\lambda]$ 
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $E_n-E'_ n=\bigcup_{\lambda\in\Lambda_n}\left(\left[a_\lambda, a_\lambda+\frac{b_\lambda-a_\lambda}{3}\right] \cup\left[b_\lambda-\frac{b_\lambda-a_\lambda}{3},b_\lambda\right]\right)$
...
又根据[[~/文档/note/离散数学/Disc_Math.org::MK359][连续减]]可得 $E'_n=E'_0-\bigcup_{i=1}^{n-1} E_i$
...
由于三分集是无限划分，故表达的二进制小数可延伸至[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]位

又根据[[MK349][包含端点]]可得所有 $E'_n$ 的端点均属于 $P$ ，故实数 $[0,1]$ 内的所有点均有对应的映射

即 $\sigma:P\to[0,1]$ 是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]，则根据[[~/文档/note/离散数学/Disc_Math.org::MK3][基数]]可得 $|P|\geq|[0,1]|$ 又根据[[MK36][定理0]]以及传递性可得 $|P|\geq|\mathbb{R}|$

由于 $P$ 是从 $\mathbb{R}$ 上取的，故显然有 $|P|\leq|\mathbb{R}|$ 根据基数定义中[[~/文档/note/离散数学/Disc_Math.org::MK4][伯恩斯坦定理]] $|P|=|\mathbb{R}|$
...
对于任意[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]] $G\subset\mathbb{R}^n\land n<\infty$ 其可表述为[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的半开闭[[MK13][区间]]的并
...
则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-至多可数集-定理2]]可得 $H_0$ 是可数集
...
由于 $\Gamma_k\subset H_k$ 且 $H_k$ 可数，则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-基数-无限集]]可得 $\Gamma_k$ 至多可数

则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-至多可数集-定理1]]可得 $\bigcup_{i=0}^\infty\Gamma_i$ 亦为至多可数

且根据构造，每个 $J\in\bigcup_{i=0}^\infty\Gamma_i$ 是区间，且两两互不相交 

**** 证明结论

根据[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-集合定义-开集]]定义，对于任意 $x\in G$ 均存在 $\delta\in\mathbb{R}\land\delta>0$ 满足 $O(x,\delta)\subset G$ 
...
综上所述根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-ZFC公理化集合论-外延公理]]可得 $G=\bigcup_{i=0}^\infty\left(\bigcup_{J\in\Gamma_i}J\right)$
...
对于任意 $\{a,b\}\subset\mathbb{R}$ 有二元[[~/文档/note/离散数学/Disc_Math.org::MK304][运算]] $a+b$ 与 $a\cdot b$ 定义为加法，乘法，满足：
...
（4） 存在加/乘法[[~/文档/note/离散数学/Disc_Math.org::MK311][幺元]]： $\exists 0\in\mathbb{R}\forall a\in\mathbb{R}\left(0+a=a\right)\land\exists1\in\mathbb{R}\forall a\in\mathbb{R}\left(1\cdot a=a\right)$

（5） 存在加/乘法[[~/文档/note/离散数学/Disc_Math.org::MK314][逆元]]： $\forall a\in\mathbb{R}\rightarrow\exists (-a)\in\mathbb{R}\left(-a+a=0\right)\land\forall (a\in\mathbb{R}\land a\ne0)\rightarrow\exists a^{-1}\in\mathbb{R}\left(a^{-1}\cdot a=1\right)$
...
即 $-0=0$ 因为 $0+0=0$ 且根据[[~/文档/note/离散数学/Disc_Math.org::MK316][性质2]]可得逆元唯一
...
加法幺元 $0$ 是乘法[[~/文档/note/离散数学/Disc_Math.org][抽象代数-特殊元素-零元]]
...
根据[[~/文档/note/离散数学/Disc_Math.org][抽象代数-特殊元素-逆元-性质2]]可得逆元唯一，故有 $(-1)\cdot a=a$
...
则 $(-b)$ 是 $a$ 的[[~/文档/note/离散数学/Disc_Math.org::MK314][逆元]]，且有 $-b$ 亦定义为 $b$ 的逆元

由于加法满足结合律，故根据[[~/文档/note/离散数学/Disc_Math.org][抽象代数-特殊元素-逆元-性质3]]可得 $a,b$ 逆元的逆元均为 $a,b$ 本身 

由于 $a,b$ 的逆元均为 $-b$ 根据[[~/文档/note/离散数学/Disc_Math.org][抽象代数-特殊元素-逆元-性质2]]可得 $-b$ 的逆元唯一，故有 $a=b$

**** 相等是等价关系<<MK11>>

根据法[[~/文档/note/离散数学/Disc_Math.org][关系与函数-特殊关系-等价关系]]若 $\{a,b\}\subset\mathbb{R}$ 则 $a=b$ 满足自反性，对称性以及传递性
...
由于加法是[[~/文档/note/离散数学/Disc_Math.org][抽象代数-代数的构建-运算]]故满足单值性，则有 $a-b+b-c=0+0$
...
对于任意 $\{a,b,c\}\subset\mathbb{R}$ 存在[[~/文档/note/离散数学/Disc_Math.org][关系与函数-二元关系]] $>$ 满足：
...
定义[[~/文档/note/离散数学/Disc_Math.org][关系与函数-二元关系]] $\geq$ 为 $a\geq b{|\!\!\!=\!\!\!|}a>b\lor a=b$
...
（1） $a=b$ 根据[[~/文档/note/离散数学/Disc_Math.org][抽象代数-代数的构建-运算]]单值性有 $a+c=b+c$
...
由于 $c<0$ 则根据[[MK4][域公理5]]可得存在[[~/文档/note/离散数学/Disc_Math.org::MK314][逆元]] $c'$ 且根据[[MK17][逆元等价]]可得 $(-1)c'=c$
...
由于 $-1$ 是 $1$ 的加法[[~/文档/note/离散数学/Disc_Math.org::MK314][逆元]]，进一步根据[[MK17][逆元等价]]可得 $(-1)(-1)=1$

且 $1$ 是乘法[[~/文档/note/离散数学/Disc_Math.org::MK311][幺元]]，故有 $bc>ac$
...
根据[[MK14][大于等于]]传递性有 $a\leq x\leq b$ 故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-包含]]可得 $\left[a,\frac{a+b}{2}\right]\subset[a,b]$
...
***** 开区间是[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]<<MK277>>

对于任意 $(a,b)\land\{a,b\}\subset\mathbb{R}$ 若 $a\not<b$ 则有 $(a,b)=\varnothing$ 根据是[[~/文档/note/数学分析/Chap11Note.org::MK15][定理8]]可得是开集

若 $a<b$ 则对于任意 $x\in(a,b)$ 可得 $a<x<b$ 定义 $\delta=\min\left(\frac{b-x}{2},\frac{x-a}{2}\right)$

易证得 $(x-\delta,x+\delta)\subset(a,b)$ 故 $x$ 是[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]，根据 $x$ 的任意性可得 $(a,b)$ 是[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]
...
根据[[~/文档/note/离散数学/Disc_Math.org][命题逻辑-命题公式-命题公式关系-逻辑等价-举例-德摩根律]]可得等价命题 $\forall i\in I\rightarrow (a<i\lor a\geq i+1)$
...
综上所述，数列 $\{a^{S_n}\}$ 单调递增且有上界，根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]可得 $\lim_{n\to\infty}a^{S_n}\in\mathbb{R}$
...
（1） [[~/文档/note/数学分析/Chap11Note.org::MK9][确界存在定理]]（确界亦为实数）

（2） [[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]（收敛于实数）

（3） [[~/文档/note/数学分析/Chap11Note.org::MK20][闭区间套定理]]（收敛于实数） + [[MK19][阿基米德性质]]

（4） 有限覆盖定理：闭[[MK13][区间]] $[a,b]$ 上的开覆盖 $H$ 中存在有限个开区间，构成 $[a,b]$ 上的一个覆盖

（5） 聚点定理：若 $S\in\mathbb{R}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]且有界，则必有[[~/文档/note/数学分析/Chap11Note.org::MK8][聚点]]

（6） [[~/文档/note/数学分析/Chap11Note.org::MK21][柯西收敛原理]]（收敛于实数） + [[MK19][阿基米德性质]]
...
根据[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-Euclid空间基本定理-Heine-Borel定理-前提定义-开覆盖]]的定义

故任意 $U\in H$ 是满足[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-开集与闭集-开集定义]]的集合
...
其中 $C$ 是一个满足[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-开集与闭集-开集定义]]的开集

则根据开集定义可知 $\xi$ 是[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-开集与闭集-点的定义-内点]]，故 $\exists\epsilon>0\rightarrow (\xi-\epsilon,\xi+\epsilon)\subset C$
...
根据[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-开集与闭集-点的定义-聚点-充要条件1]]
...
显然 $\{na\}\sim\mathbb{N}$ 即为可数集，根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-可数集]]可知 $\{na\}$ 是无限集
...
定义 $\{x_n\}$ 是满足 $\forall \epsilon>0,\exists N,\forall n,m>N\Rightarrow |x_n-x_m|<\epsilon$ 的[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-可数集]]
...
实数上的任意[[MK13][区间]]均与实数[[~/文档/note/离散数学/Disc_Math.org::MK26][对等]]

**** 证明

***** 单一开区间

定义区间 $(a,b)\subset\mathbb{R}$ 显然函数 $\tan(x)$ 是[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-特殊的函数类型-双射]]函数
...
则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-基数-伯恩斯坦定理]]可得 $|[a,b]|=|\mathbb{R}|$
...
实数集合 $\mathbb{R}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK324][不可数集]]

**** 证明

根据[[MK36][定理0]]可得 $\mathbb{R}\sim(0,1)$ 假设 $(0,1)$ 区间与 $\mathbb{N}^+$ [[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-对等]]，则存在双射函数 $\sigma$
...
即 $a$ 不在数列中，则不存在 $\sigma(a)$ 故不满足[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-相关定义-函数定义]]与 $\sigma$ 是双射函数矛盾

即假设不成立 $(0,1)$ 不可数，根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-对等-定理]]其为等价关系。

根据等价关系传递性可得 $\mathbb{R}$ 不可数

**** 推论1

定义 $A_N$ 是[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]]其中指标集 $N$ ，满足：

（1） 任意 $A_n\land n\in N$ 均与 $\mathbb{R}$ [[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-对等]]

（2） 任意 $\{n,m\}\subset N$ 均有 $A_n\cap A_m=\varnothing$

（2） $N$ 是[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-至多可数集]]
...
根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-基本定义-直积-性质-基数]]可得 $\left|\prod_{n\in N}A_n\right|\geq |A_n|=|\mathbb{R}|$

对于任意 $a\in \prod_{n\in N}A_n$ 其元素均为[[~/文档/note/离散数学/Disc_Math.org][关系与函数-基本定义-有序组]]，故有 $<a^{(1)},a^{(2)},....>$ 的表达式
...
根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-至多可数集-定理1-证明]]可得对于 $i,j$ 均为整数时 $\alpha$ 是双射函数

根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-函数的计算-函数求逆]]可得存在你函数 $\alpha^{-1}(k)=<i,j>$ 亦为双射函数
...
则根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-特殊的函数类型-单射-蕴含双射]]可得存在 $S\subset\mathbb{R}$ 使得 $f:\prod_{n\in N}A_n\to S$ 是双射函数

故根据基数定义有 $\left|\prod_{n\in N}A_n\right|\leq|\mathbb{R}|$ 故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-基数-伯恩斯坦定理]]有 $\left|\prod_{n\in N}A_n\right|=|\mathbb{R}|$ 

**** 推论3

定义 $A_i=\{0,1,...,K\}$ 是[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-有限集]]，则有 $\left|\prod_{i=1}^\infty A_i\right|=|\mathbb{R}|$

***** 证明

若 $|B_i|=|\mathbb{R}|$ 则显然 $|B_i|\geq|A_i|$ 根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-基本定义-直积-性质-基数保序]]可得 $\left|\prod_{i\in I}A_i\right|\leq\left|\prod_{i\in I}B_i\right|$
...
则根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-函数-特殊的函数类型-单射-蕴含双射]]可得 $\left|\prod_{i=1}^\infty A_i\right|\geq|\mathbb{R}|$

故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-基数-伯恩斯坦定理]]有 $\left|\prod_{n\in N}A_n\right|=|\mathbb{R}|$ 

**** 推论4

根据[[MK37][推论2]]， $n$ 维[[~/文档/note/数学分析/Chap11Note.org][欧式空间]] $\mathbb{R}^n$ 亦与 $\mathbb{R}$ 对等
...
由于 $n\in\mathbb{N}\rightarrow n\geq1$ ，故有 $\frac{1}{n}\leq 1$ ，且易证 $\alpha^{m-i}\tbinom{m}{i}>0$ ，故根据[[~/文档/note/数学分析/Chap10Note.org::MK3][二项式展开]]可得
...
显然与 $\alpha$ 是上[[~/文档/note/离散数学/Disc_Math.org::MK326][确界]]的定义不符，故假设不成立

***** 假设 $\alpha^m>t$

[[MK255][同理]]由于 $\frac{1}{n}\leq 1$ 以及 $\alpha^{m-i}\tbinom{m}{i}>0$ 且易证 $\left(-\frac{1}{n}\right)^{2i}>0\land\left(-\frac{1}{n}\right)^{2i+1}<0$ ，故根据[[~/文档/note/数学分析/Chap10Note.org::MK3][二项式展开]]可得
...
整理后可得 $\alpha^m-\frac{1}{n^*}A>t$ [[MK255][同理]]可得 $\left(\alpha-\frac{1}{n^*}\right)^m>t$ 与[[~/文档/note/离散数学/Disc_Math.org::MK326][确界]]定义矛盾，假设不成立
...
满足 $t>\alpha$ 且 $e^t<A<a$ 显然与上[[~/文档/note/离散数学/Disc_Math.org::MK326][确界]]的定义不符，故假设不成立
...
定义为[[~/文档/note/数学分析/Chap11Note.org::MK7][实数内点定义]]的扩展，即对于集合 $S\subset\mathbb{R}_e$ 其内点为 $\exists \delta>0\land\delta\in\mathbb{R}_e\rightarrow O(x,\delta)\subset S$ 

*** 开集<<MK148>>

定义为在 $\mathbb{R}_e\cup \{-\infty,+\infty\}$ 满足[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]的集合，即 $S\subset\mathbb{R}_e$ 且有包含的点均为[[MK147][内点]]的集合

**** 定理1<<MK149>>

对于任意 $S\subset\mathbb{R}$ 若 $+\infty\in S$ 则 $+\infty$ 为 $S$ 的[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]。 $-\infty$ 同理

***** 证明

则取 $\delta=1>0$ 根据[[MK144][运算]]有 $+\infty\pm\delta=+\infty$ 故有 $(b-\delta,b+\delta)=(+\infty, +\infty)$

根据[[MK146][定义]]可得 $(+\infty, +\infty)=\varnothing$ 又根据[[~/文档/note/离散数学/Disc_Math.org::MK23][定理4]]可得 $\varnothing\subset S$

即 $+\infty$ 是[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]，同理可证 $-\infty$ 也是内点
...
对于 $S\subset\mathbb{R}$ 中的任意一点 $x\in S$ ，若在 $\mathbb{R}$ 上是[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]，则 $\exists \delta>0\land\delta\in\mathbb{R}\rightarrow O(x,\delta)\subset S$
...
对于 $S\subset\mathbb{R}$ 中的存在非[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]] $x$ ，则有 $\forall\delta>0\land\delta\in\mathbb{R}\rightarrow O(x,\delta)\not\subset S$
...
对于 $\mathbb{R}_e$ 上的数列 $\{x_n\}$ 其[[~/文档/note/数学分析/Chap9Note.org::MK2][上下极限]]可表述为：
...
对于任意 $i\in\mathbb{N}$ 定义 $X_i=\left\{x_k\big|k\geq i\land k\in\mathbb{N}\right\},S_i=\sup(X_i)$ 根据[[~/文档/note/数学分析/Chap11Note.org::MK9][确界存在定理]]可得 $S_i$ 存在
...
进一步由于 $X_k\subset\mathbb{R}_e$ 故可得 $x_i=-\infty,\forall i>k$ 故 $\{x_k,x_{k+1},...\}$ 是[[~/文档/note/数学分析/Chap11Note.org::MK16][子列]]且 $-\infty$ 是[[~/文档/note/数学分析/Chap9Note.org::MK1][极限点]]

且 $\{x_1,...,x_{k-1}\}$ 为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限集]]，且[[~/文档/note/数学分析/Chap11Note.org::MK16][子列]]定义为取无限个。

故任意子列的极限点均为 $-\infty$ 根据[[~/文档/note/数学分析/Chap9Note.org::MK2][定义]]可知是上极限
...
若不为空，则任取 $x_{k_1}\in X_i\cap\mathbb{R}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]有 $x_{k_1}<+\infty$

继续对 $S_{k_1+1}$ 重复上述步骤，以此类推可得数列 $x_{k_1},x_{k_2},...\a$ 其极限为 $+\infty$

综上所述，存在 $\{x_n\}$ 的子列极限为 $+\infty$ 由于 $+\infty$ 是最大[[MK143][广义实数]]，故必为[[~/文档/note/数学分析/Chap9Note.org::MK2][上极限]]
...
由于 $I$ 为下确界，故根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界定理]]可知 $\lim_{i\to\infty}S_i=I$ 且由于 $S_n\geq I$ 
...
进一步根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]可得存在 $x_{k_1}\rightarrow I\leq x_{k_1}\leq S_{n_1}\rightarrow x_{k_1}-I<\epsilon_1$

取 $\epsilon_2=\left(\frac{1}{2}\right)^2$ 同理可得存在 $N_2$ 满足极限定义，则取 $n_2=\max(N_2,k_1)$

即有 $S_{n_2}-I<\epsilon_2$ 则[[~/文档/note/离散数学/Disc_Math.org::MK326][同理]]可得存在 $x_{k_1}\rightarrow x_{k_2}-I<\epsilon_2$

依次类推可得[[~/文档/note/数学分析/Chap11Note.org::MK16][子列]] $\{x_{k_i}\}$ 满足 $\lim_{i\to\infty}x_{k_1}=I$ 即 $I$ 是数列的[[~/文档/note/数学分析/Chap9Note.org::MK1][极限点]]

****** 是最大极限点

假设存在[[~/文档/note/数学分析/Chap11Note.org::MK16][子列]] $\{x_{n_i}\}$ 满足 $\lim_{i\to\infty}x_{n_1}=I'>I$

由于 $n_i$ 有无限个且 $n_i\in\mathbb{N}$ 则 $\{n_i\}$ 存在[[~/文档/note/离散数学/Disc_Math.org::MK185][序关系]]，不妨设 $i<j\rightarrow n_i<n_j$
...
故与 $S_n=\sup(X_n)$ 矛盾，假设不成立。即不存在[[~/文档/note/数学分析/Chap11Note.org::MK16][子列]] $\{x_{n_i}\}$ 满足 $\lim_{i\to\infty}x_{n_1}=I'>I$

则 $I$ 是最大[[~/文档/note/数学分析/Chap9Note.org::MK1][极限点]]，即为[[~/文档/note/数学分析/Chap9Note.org::MK2][上极限]]

**** 引理1

对于 $\mathbb{R}_e$ 上的数列 $\{x_n\}$ 其[[~/文档/note/数学分析/Chap9Note.org::MK2][上下极限]]的等价表述为：
...
故显然有 $\alpha_i\leq\alpha_j$ 即 $A=\{\alpha_i\}$ 为单调递减数列，则根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]必收敛于数列的下确界
...
上极限： $\overline{\lim_{i\to\infty}}f_i(x)=\lim_{i\to\infty}\sup\left\{f_i(x)\big|i\geq n\right\}$ 其中 $\sup\{A\}$ 表示函数集合 $A$ 的[[~/文档/note/离散数学/Disc_Math.org::MK342][函数上确界]]

下极限： $\underline{\lim_{i\to\infty}}f_i(x)=\lim_{i\to\infty}\inf\left\{f_i(x)\big|i\geq n\right\}$ 其中 $\inf\{A\}$ 表示函数集合 $A$ 的[[~/文档/note/离散数学/Disc_Math.org::MK342][函数下确界]]
...
定义 $g_n(x)=\inf\left\{-f_i(x)\big|i\geq n\right\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK342][函数下确界]]则有 $\underline{\lim_{i\to\infty}}-f_i(x)=\lim_{n\to\infty}g_n(x)$

则根据定义对于任意 $x'$ 均有 $g_n(x')=\inf\left\{-f_i(x')\big|i\geq n\right\}$

根据[[~/文档/note/离散数学/Disc_Math.org::MK343][定理6]]可得 $-\inf\left\{-f_i(x')\big|i\geq n\right\}=\sup\left\{(-1)\cdot(-f_i(x'))\big|i\geq n\right\}$
...
根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-包含-定理4]]可得对于任意 $\epsilon>0\land\epsilon\in\mathbb{R}$ 均有 $\varnothing\subset I$
...
在[[MK52][勒贝格测度]]定义下，任意有界[[MK13][区间]] $I=\prod_{i=1}^n[a_i,b_i]\subset\mathbb{R}^n$ 其中乘法为[[~/文档/note/离散数学/Disc_Math.org::MK153][直积]]
...
对于任意 $i\in\mathbb{N}^+$ 定义 $K_i=\prod_{j=1}^n[-i,i]$ 其中 $n$ 为欧式空间的维数，乘法为[[~/文档/note/离散数学/Disc_Math.org][关系与函数-基本定义-直积]]
...
故 $\left\{\sum_{i=1}^\infty |I_i|\big|E\subset\bigcup_{i=1}^\infty I_i\right\}$ 有下界，根据[[~/文档/note/数学分析/Chap11Note.org][实数系基本定理-确界存在定理]]必有下确界
...
定义 $I_i=\prod_{j=1}^n[a_{i,j},b_{i,j}]$ 此处乘法为[[~/文档/note/离散数学/Disc_Math.org][关系与函数-基本定义-直积]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK340][定理4]]可得 $m^*(\alpha E)=\alpha^n\inf\left\{\sum_{i=1}^\infty |I_i|\big|E\subset\bigcup_{i=1}^\infty I_i\right\}=\alpha^n m^*(E)$
...
（3） $G\in G_\delta$ 即 $G$ 是[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个开集的交（可测）
...
根据[[~/文档/note/数学分析/Chap11Note.org::P2][定理3]]可得 $E'_n=\bigcup_{i=1}^\infty I_{n,i}$ 亦为开集，进一步定义 $E_n=\bigcap_{i=1}^n E'_n$ 易证：
...
且由于 $\forall n\in\mathbb{N}\rightarrow E\subset E_n$ 则 $\forall x\in E,\forall n\in\mathbb{N}\rightarrow x\in E_n$ 即根据[[~/文档/note/离散数学/Disc_Math.org::MK35][广义交]]定义有 $E\subset G$
...
任意[[MK81][可测集]] $E\subset\mathbb{R}^n\land\varphi(E)<\infty$ 均有 $E=G-E_0$ 其中 $G\in G_\delta$ 是[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个开集的交, $E_0$ 是[[MK126][零测集]]
...
显然 $X\times Y\subset \left(\bigcup_{i=1}^\infty I^p_i\right)\times\left(\bigcup_{i=1}^\infty I^q_i\right)$ 且根据[[~/文档/note/离散数学/Disc_Math.org::MK154][分配律]]可得 $\left(\bigcup_{i=1}^\infty I^p_i\right)\times\left(\bigcup_{i=1}^\infty I^q_i\right)=\bigcup_{i=1}^\infty\bigcup_{j=1}^\infty(I^p_j\times I^q_j)$

根据[[~/文档/note/离散数学/Disc_Math.org::MK346][定理1]]可得 $\bigcup_{i=1}^\infty\bigcup_{j=1}^\infty(I^p_j\times I^q_j)$ 仍为据[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个区间的并，由于均为[[MK81][可测集]]，则根据[[MK56][可数可加性]]
...
可测及对于[[~/文档/note/离散数学/Disc_Math.org::MK29][运算]]中定义的计算有以下性质：
...
其中乘法为[[~/文档/note/离散数学/Disc_Math.org::MK153][直积]]，则 $\forall x\in\mathbb{R}^p$ 有 $f(x)=\begin{cases}\varphi(I^q)&x\in I^p\\0&x\not\in I^p\end{cases}$
...
若 $E$ 是开集，则根据[[MK83][开集构造]]可得存[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的半开闭[[MK13][区间]]满足 $E=\bigcup_{i\in Z}I_i,Z\subset\mathbb{N}$
...
且 $p+q<\infty$ 则有 $X\times Y$ 是 $<\mathbb{R}^{p+q},\varphi>$ 上的[[MK81][可测集]]，其中乘法为[[~/文档/note/离散数学/Disc_Math.org::MK153][直积]]

***** 证明

****** 开集的直积是开集<<MK291>>

若 $X,Y$ 均为[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]则对于任意 $(\vec{x}_0,\vec{y}_0)\in X\times Y$ 其中 $\vec{x}_0\in X,\vec{y}_0\in Y$
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK25][距离定义]]有 $\sqrt{\sum_{i=1}^p(x_i-x_{0,i})^2+\sum_{i=1}^q(y_i-y_{0,i})^2}<\delta$
...
即 $(\vec{x}_0,\vec{y}_0)$ 是 $X\times Y$ 的[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]，又由于 $(\vec{x}_0,\vec{y}_0)$ 任意性可得 $X\times Y$ 是 $\mathbb{R}^{p+q}$ 上的[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]

****** 闭集的直积是闭集<<MK293>>

若 $X,Y$ 均为[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集]]，则根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]] $X^c,Y^c$ 均为开集，根据[[~/文档/note/离散数学/Disc_Math.org::MK344][直积与补]]可得 $(X\times Y)^c=\mathbb{R}^p\times Y^c\cup X^c\times\mathbb{R}^q$

根据[[~/文档/note/数学分析/Chap11Note.org::MK26][全集是开集]]可得 $\mathbb{R}^p,\mathbb{R}^q$ 均为开集，根据[[MK291][之前证明]]可得 $(X\times Y)^c$ 是 $\mathbb{R}^{p+q}$ 上的[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]

根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]]可得 $X\times Y$ 是闭集
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK345][直积与差]]可得 $(G\times G')-(F\times F')=G\times(G'-F')\cup(G-F)\times G'$
...
进一步根据[[~/文档/note/离散数学/Disc_Math.org::MK154][分配律]]易证 $\left(\bigcup_{n=1}^\infty I_n\right)\times\left(\bigcup_{n=1}^\infty I'_n\right)=\bigcup_{i=1}^\infty\left(\bigcup_{j=1}^\infty I_i\times I'_j\right)$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $X\times Y=\bigcup_{i=1}^\infty(X_i\times Y_i)$ 结合 $\bigcup_{i=1}^\infty(X_i\times Y_i)$ 可测
...
则定义 $G=\bigcup_{i=1}^\infty I_i$ 根据[[~/文档/note/数学分析/Chap11Note.org::P2][定理3]]可得 $G$ 仍为开集
...
对于任意 $i\in\mathbb{N}^+$ 定义 $K_i=\prod_{j=1}^n[-i,i]$ 其中 $n$ 为欧式空间的维数，乘法为[[~/文档/note/离散数学/Disc_Math.org::MK153][直积]]
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $G-E\subset\bigcup_{i=1}^\infty(G-E)$
...
即 $x\in G-E$ 同理根据[[~/文档/note/离散数学/Disc_Math.org::MK20][定义]]有 $\bigcup_{i=1}^\infty(G-E)\subset G-E$

则根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $G-E=\bigcup_{i=1}^\infty(G-E)$
...
由于 $G/E^c=E/G^c$ 且由于 $G$ 是开集，则根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]]可得 $G^c$ 是闭集
...
定义 $\Gamma$ 表示 $\mathbb{R}^n$ 所有开集的[[~/文档/note/离散数学/Disc_Math.org::MK12][集合族]]，定义 $\Theta$ 为所有闭集的集合族，若 $E\subset\mathbb{R}^n$ 则：
...
同理 $F_i$ 为闭集，结合[[MK84][计算]]中（1）以及[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]]可得亦可测
...
若 $E\subset\mathbb{R}^n$ 是有界的[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集]]且 $0<m^*(E)<\infty$ 定义 $D=\left\{\vec{x}-\vec{y}\big|\vec{x}\in E\land \vec{y}\in E\right\}$
...
故根据下确界定义，存在[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-集合定义-开集]] $G$ 使得 $K\subset G\land m^*(G)<2m^*(K)$

取 $G$ 的补集 $G^c$ 根据[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-集合定义-部分定理-定理1]]可得 $G^c$ 为闭集且 $G^c\cap K=\varnothing$

***** 证明距离大于零

定义 $d(G^c,K)$ 为集合间的[[MK89][度量]]，此时若 $d(G^c,K)=0$ 则必然存在 $\vec{x}$ 满足 $\forall\delta>0,\exists\vec{y}\in G^c\rightarrow y\in O(\vec{x},\delta)$

根据[[~/文档/note/数学分析/Chap11Note.org][构造Euclid空间-点的定义-聚点-充要条件1]]可得 $\vec{x}$ 是 $G^c$ 的聚点，结合闭集定义可得 $\vec{x}\in G^c$
...
定义[[~/文档/note/离散数学/Disc_Math.org][关系与函数-二元关系]] $R=\left\{<x,y>\big|x\in\mathbb{R}\land y\in\mathbb{R}\land x-y\in\mathbb{Q}\right\}$ 即两个相差有理数的实数，显然有：
...
故可得 $R$ 是[[~/文档/note/离散数学/Disc_Math.org::MK176][等价关系]]，根据[[~/文档/note/离散数学/Disc_Math.org::MK180][定理1]]可得 $R$ 划分 $\mathbb{R}$

***** 定义集合<<MK96>>

定义集合 $V$ 为从每个上述划分中选取一个代表元素，根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-ZFC公理化集合论-选择公理]]可得 $V$ 存在

根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-至多可数集-定理-定理1-推论]]可得有理数是可数集
...
由于 $R$ 可形成 $\mathbb{R}$ 上的[[~/文档/note/离散数学/Disc_Math.org][关系与函数-特殊关系-划分]]，故对于任意 $x\in\mathbb{R}$ 均有一个划分与其对应

根据 $V$ 的定义存在 $y\in V\rightarrow y\in[x]_R$ 且必然 $x-y\in\mathbb{Q}$ 根据有利数可列性有 $x-y=q_k$ 继而有 $x\in V_k$

故有 $\mathbb{R}\subset\bigcup_{i=1}^\infty V_i$ 又由于显然 $\mathbb{R}\supset\bigcup_{i=1}^\infty V_i$ 则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-子集-定理1]]可得 $\mathbb{R}=\bigcup_{i=1}^\infty V_i$

由于 $E\subset\mathbb{R}$ 故有 $E\cap \bigcup_{i=1}^\infty V_i=E$ 

根据的[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的计算-性质-集合族运算与交并]]可得 $\bigcup_{i=1}^\infty(E\cap V_i)=E\cap\bigcup_{i=1}^\infty V_i$
...
故可得 $R$ 是[[~/文档/note/离散数学/Disc_Math.org][关系与函数-特殊关系-等价关系]]，根据[[~/文档/note/离散数学/Disc_Math.org][关系与函数-特殊关系-划分-定理-定理1]]可得 $R$ 划分 $\mathbb{R}$
...
故定义集合 $V$ 为从每个上述划分中选取一个 $[0,1]$ 中的代表元素，根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合定义-ZFC公理化集合论-选择公理]]可得 $V$ 存在

取 $[-1,1]$ 中所有的有理数，根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-至多可数集-定理-定理1-推论]]可得有理数是可数集

进一步根据[[MK43][稠密性]]可得 $[-1,1]$ 中所有有理数的集合为[[~/文档/note/离散数学/Disc_Math.org][集合论-集合分类-无限集]]
...
故有 $\forall x\in[0,1]\rightarrow x\in V_u\subset\bigcup_{i=1}^\infty V_k$ 则根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-子集]]可得 $[0,1]\subset\bigcup_{k=1}^\infty V_k$
...
非空[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集]]上的有限函数必有界

**** 证明

对于任意 $E\subset\mathbb{R}^n$ 是非空闭集，任意 $f:E\to\mathbb{R}$ 为 $E$ 到 $\mathbb{R}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
以此类推，可以有 $E_1,E_2,...\a$ 显然满足[[~/文档/note/数学分析/Chap11Note.org::KTDL][闭区间套]]条件
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK18][向量值函数连续]]，在不考虑边界点的情况下（只考虑 $B$ 的[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]）
...
（2） 对于任意 $C\subset B$ 且 $C$ 为[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]，则 $f^{-1}(C)=\left\{\vec{x}\big|f(\vec{x})\in C\right\}$ 仍为开集 
...
故根据[[~/文档/note/离散数学/Disc_Math.org][集合论-集合的关系-子集]]定义可得 $O(\vec{x}_0,\delta)\subset\left\{\vec{x}\big|\left|f(\vec{x})-f(\vec{x}_0)\right|<\epsilon\right\}$
...
若 $f^{-1}(C)=\varnothing$ 则根据[[~/文档/note/数学分析/Chap11Note.org::MK15][定理8]]可得空集是开集，即开集 $C$ 的原相是开集
...
综上所述，对于任意 $\vec{x}_0\in C$ 均存在 $\delta>0\rightarrow O(\vec{x}_0,\delta)\subset C$ 即 $C$ 的所有点均为[[~/文档/note/数学分析/Chap11Note.org::MK7][内点]]

故根据[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]定义 $C$ 是开集。即（1）推出（2）
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK19][定理2]]可得领域为开集，即 $O(f(\vec{x}_0),\epsilon)$ 是开集
...
故根据[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]定义有 $\eixsts\delta>0\rightarrow O(\vec{x},\delta)\subset\left\{\vec{x}\big|\left|f(\vec{x})-f(\vec{x}_0)\right|<\epsilon\right\}$

定义原相 $g(K)=\left\{k\big|f(k)\in K\right\}$ 故推出（1）

*** 引理1

若存在[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个[[MK106][连续函数]] $f_i(x), i\in I$ 定义 $\phi(x)=\inf\left\{f_i(x)\big|i\in I\right\},\psi(x)=\sup\left\{f_i(x)\big|i\in I\right\}$

即为 $f_i(x)$ 的上下[[~/文档/note/离散数学/Disc_Math.org::MK326][确界]]，则 $\phi(x),\psi(x)$ 不一定为[[MK106][连续函数]]
...
故集合 $L=\left\{f(x)\big|a<x<x_0\right\}$ 有上界，根据[[~/文档/note/数学分析/Chap11Note.org::MK9][确界存在定理]]存在上确界 $A=\sup(L)$
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK339][定理1]]可得 $A\leq f(x_0)\leq B$ 当 $A=f(x_0)=B$ 时显然有 $\lim_{x\to x_0}f(x)=f(x_0)$

即点 $x_0$ [[MK106][连续]]，与条件不符，故根据[[MK5][三岐性]]必有 $B>A$

*** 定理2<<MK335>>

[[MK13][区间]] $(a,b)$ 上的单调函数 $f(x)$ 定义域 $Y\subset\mathbb{R}$ 的不连续点集是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]有 $B_{x_0}\leq f(x')\leq A_{x_1}$ 于是乎同样取 $r(x_1)$ 可得 $r(x_1)>A_{x_1}>B_{x_0}>r(x_0)$

同理可证若 $x_1<x_0$ 则有 $r(x_1)<r(x_0)$

综上所述，对于任意一个 $x_0\in E$ 均有唯一对应的有理数 $r(x_0)\in\mathbb{Q}$

即存在 $K\subset\mathbb{Q}$ 使得 $|E|=|K|$ [[~/文档/note/离散数学/Disc_Math.org::MK26][对等]]，根据[[~/文档/note/离散数学/Disc_Math.org::MK355][定理8]]可得 $|K|\leq|\mathbb{Q}|$

又根据[[~/文档/note/离散数学/Disc_Math.org::MK325][推论]]可得 $\mathbb{Q}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK48][可数集]]，则易证 $E$ 为[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]] 

** 康托函数<<MK109>>

若[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $F$ 满足： 

（1） 将[[MK107][康托三分集]] $P$ 映射成[[MK51][外测度]]为正的[[MK81][可测集]]

（2） 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]函数

（3） 其[[~/文档/note/离散数学/Disc_Math.org::MK203][逆]]函数 $F^{-1}$ [[MK106][连续]]
...
即为单射函数，故满足[[~/文档/note/离散数学/Disc_Math.org::MK200][双射]]定义

***** 逆函数连续

****** $f(x)$ 连续

******* 递增且[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]<<MK112>>
...
由于 $f(x)$ 值域为 $[0,1]$ 且[[~/文档/note/离散数学/Disc_Math.org::MK198][满射]]，故存在 $x'$ 满足 $f(x')=a$ 
...
根据[[MK111][之前证明]]可得 $F(x)$ 是双射函数，故根据[[~/文档/note/离散数学/Disc_Math.org::MK203][定义]]可得逆函数 $F^{-1}(y)$ 存在
...
定义为 $f:E\to\mathbb{R}\cup\{-\infty,+\infty\}$ 的[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，其中 $\mathbb{R}\cup\{-\infty,+\infty\}$ 为[[MK143][广义实数]]

**** 有限函数<<MK383>>

若[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]满足 $f:E\to\mathbb{R}$ 则定义为有限函数

**** 有界函数<<MK386>>

若[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to X\subset\mathbb{R}$ 满足：
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK37][可数性质]]可得 $\forall z\in\bigcap_{i=1}^\infty \left(a-\frac{1}{i},+\infty\right]\leftrightarrow\left(\forall i\in\mathbb{N}\rightarrow z\in\left(a-\frac{1}{i},+\infty\right]\right)$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $\bigcap_{i=1}^\infty \left(a-\frac{1}{i},+\infty\right]=[a,\infty]$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK37][可数性质]]可得 $\forall z\in\bigcap_{i=1}^\infty \left(i,\infty\right]\leftrightarrow\left(\forall i\in\mathbb{N}\rightarrow z\in\left(i,+\infty\right]\right)$
...
故 $z=\infty\rightarrow z\in\{\infty\}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $\bigcap_{i=1}^\infty \left(i,+\infty\right]&=\{\infty\}$

** 绝对连续函数<<MK384>>

设 $f(x)$ 是 $[a,b]$ 上的[[MK383][有限函数]]，若对于任意 $\epsilon>0$ 均存在 $\delta>0$ 满足

任取[[~/文档/note/离散数学/Disc_Math.org:MK48][至多可数]]个 $[a,b]$ 上互不相交的开区间 $\{(a_i,b_i)\}$ 若满足 $\sum_{i=1}^n(b_i-a_i)<\delta$

则均有 $\sum_{i=1}^n|f(a_i)-f(b_i)|<\epsilon$ 。则称 $f(x)$ 是 $[a,b]$ 上的绝对连续函数

*** 定理1<<MK388>>

设 $f(x)$ 在 $[a,b]$ 上[[MK237][勒贝格可积]]，则函数 $$F(x)=\int_{[a,x]}f(t)dt$$ 是[[MK384][绝对连续函数]]

其中 $x\in[a,b]$

**** 证明

由于[[MK237][勒贝格可积]]故有 $$\int_{[a,b]}f^+(x)dx<\infty\land\int_{[a,b]}f^-(x)dx<\infty$$

根据[[MK198][引理1]]可得 $f^+(x),f^-(x)$ 均为非负可测函数，则根据[[MK227][推论1]]可得对于任意 $a\leq x\leq b$

均有 $$\int_{[a,x]}f^+(t)dt<\infty\land\int_{[a,x]}f^-(t)dt<\infty$$ 则根据[[MK4][封闭性]]可得 $F(x)<\infty$

故有 $F(x)$ 是 $[a,b]$ 上的[[MK383][有限函数]]。则对于任意 $\epsilon>0$ 根据[[MK263][绝对连续性]]可得存在 $\delta>0$

对于对于任意[[MK174][可测集]] $A$ 满足 $A\subset E\land \varphi(A)<\delta$ 则有 $$\int_A|f(x)|dx<\epsilon$$

故对于任意互不相交的开区间 $\{(a_i,b_i)\}$ 根据[[MK262][线性]]有 $$\left|F(a_i)-F(b_i)\right|=\left|\int_{[a_i,b_i]}f(x)dx\right|$$

根据[[MK262][线性]]以及[[MK372][推论]]

有 $$\sum_{i=1}^n\left|F(a_i)-F(b_i)\right|=&\sum_{i=1}^n\left|\int_{[a_i,b_i]}f(x)dx\right|\leq&\sum_{i=1}^n\int_{[a_i,b_i]}|f(x)|dx\leq&\int_{\bigcup_{i=1}^n[a_i,b_i]}|f(x)|dx$$

根据[[MK82][区间可测]]、[[MK79][正规性]]以及[[MK57][次可加性]]有 $\varphi\left(\bigcup_{i=1}^n[a_i,b_i]\right)\leq\sum_{i=1}^n\varphi((a_i,b_i))=\sum_{i=1}^n(b_i-a_i)<\delta$

则有 $$\int_{\bigcup_{i=1}^n[a_i,b_i]}|f(x)|dx<\epsilon$$ 即 $$\sum_{i=1}^n\left|F(a_i)-F(b_i)\right|<\epsilon$$ 即是绝对连续函数

*** 定理2<<MK387>>

设 $f(x)$ 是 $[a,b]$ 上的[[MK384][绝对连续函数]]，则 $f(x)$ 是 $[a,b]$ 上的[[MK350][有界变差函数]]

**** 证明

由于是绝对连续函数，故对于 $\epsilon=1$ 存在 $\delta>0$ 对于任意[[~/文档/note/离散数学/Disc_Math.org:MK48][至多可数]]个互不相交的开区间 $\{(a_i,b_i)\}$

若满足 $\sum_{i=1}^n(b_i-a_i)<\delta$ 则均有 $\sum_{i=1}^n|f(a_i)-f(b_i)|<\epsilon$

由于 $\delta\in\mathbb{N}\land\delta>0$ 易证存在整数 $N$ 满足 $\frac{b-a}{N}<\delta$ 并平均划分 $[a,b]$ 为 $N$ 个区间

定义为 $[a_i,b_i]$ ，其中 $a_1=a,b_{N}=b,a_{i+1}=b_i$ ，且每个区间长度 $b_i-a_i=\frac{b-a}{N}$

则对于 $[a_i,b_i]$ 上的任意[[~/文档/note/离散数学/Disc_Math.org::MK360][有理划分]] $T=\{[a_{ij},b_{ij}]\}$ 根据条件均满足 $Z_{T,[a_i,b_i]}(f)<1$

故根据[[~/文档/note/离散数学/Disc_Math.org::MK339][定理2]]可得 $\sup(Z_{[a_i,b_i]}(f))\leq1$ 其中 $Z_{[a_i,b_i]}(f)=\left\{Z_{T,[a_i,b_i]}(f)\big|T\in\mathcal{T}_i\right\}$ 即 $\overunderset{b_i}{a_i}{V}(f)\leq1$

根据[[MK356][性质4]]可得 $\overunderset{b}{a}{V}(f)=\overunderset{b_1}{a_1}{V}(f)+\overunderset{b}{a_2}{V}(f)$ 同理又有 $\overunderset{b}{a}{V}(f)=\overunderset{b_1}{a_1}{V}(f)+\overunderset{b_2}{a_2}{V}(f)+\overunderset{b}{a_3}{V}(f)$

依次类推，根据数学归纳法易证对于任意 $n\in\mathbb{N}$ 均有 $\overunderset{b}{a}{V}(f)=\sum_{i=1}^n\overunderset{b_i}{a_i}{V}(f)$

由于 $N\in\mathbb{N}$ 则有 $\overunderset{b}{a}{V}(f)=\sum_{i=1}^N\overunderset{b_i}{a_i}{V}(f)$ 又由于 $\overunderset{b_i}{a_i}{V}(f)\leq1$ 故有 $\overunderset{b}{a}{V}(f)\leq N$

则根据[[MK350][定义]]可得 $f(x)$ 是有界变差函数

*** 定理3<<MK395>>

函数 $f(x)$ 在 $[a,b]$ 上满足：

（1） $f(x)$ 是[[MK384][绝对连续函数]]

（2） $f'(x)=0$ 在 $[a,b]$ 上[[MK190][几乎处处]]成立

则有 $f(x)=f(a)$ 是常值函数

**** 证明

根据条件（2）定义 $E\subset[a,b]$ 满足 $\varphi([a,b]-E)=0\land \forall x\in E\rightarrow f'(x)=0$

对于任意 $x_0\in[a,b]$ 若 $x_0=a$ 则有 $f(x_0)=f(a)$ 否则

定义 $E_{x_0}=E\cap[a,x_0]$ ，易证 $f(x)$ 在 $[a,x_0]$ 上亦为绝对连续，任取 $\epsilon>0$

***** 前置证明<<MK391>>

故对于任意 $\epsilon>0$ 存在 $\delta$ 任取[[~/文档/note/离散数学/Disc_Math.org:MK48][至多可数]]个 $[a,x_0]$ 上互不相交的开区间 $\{(a_i,b_i)\}$

若满足 $\sum_{i=1}^n(b_i-a_i)<\delta$ 则有 $\sum_{i=1}^n|f(a_i)-f(b_i)|<\epsilon$

由于 $f'(x)=\lim_{h\to0}\frac{f(x+h)-f(x)}{h}$ 则对于任意 $x\in E_{x_0}$ 均有 $\lim_{h\to0}\frac{f(x+h)-f(x)}{h}=0$

即 $\forall\epsilon^*>0,\exists\tau,\forall |h-0|<\min(\tau,1)\rightarrow \left|\frac{f(x+h)-f(x)}{h}\right|<\epsilon^*$

进一步取 $\epsilon^*=\frac{\epsilon}{b-a}$ 则有 $|f(x+h)-f(x)|<\frac{\epsilon}{b-a}|h|$

***** 构建区间

定义 $I_{x_0}=\left\{[x,x+h]\big|0<|h|<\min(\tau,1)\land x\in E_{x_0}\land x+h\in[a,x_0]\right\}$ 显然满足：

（1） $\varphi([x,x+h])>0$

（2） $\forall x\in E_{x_0},\forall\epsilon>0,\exists I_x=\left[x,x+\min\left(0.9,\frac{\epsilon}{2}\right)\right]\in I_{x_0}\rightarrow \phi(I_x)<\epsilon$

根据[[MK317][定义]]可得 $I_{x_0}$ 是 $E_{x_0}$ 的维塔利覆盖，根据[[MK390][推论]]存在互不相交的有限区间集 $Z_{x_0}=\{I_{i,x_0}\}$

满足 $\varphi(E_{x_0}-\bigcup_{i=1}^n I_{i,x_0})<\delta$ 定义 $I_{i,x_0}=[u_i,u_i+h_i]$

易证 $[a,x_0]-E_{x_0}\subset [a,b]-E\land \varphi([a,b]-E)=0$ 根据[[MK][子集零测]]可得 $\varphi([a,x_0]-E_{x_0})=0$

易证 $[a,x_0]-\bigcup_{i=1}^nI_{i,x_0}\subset \left(E_{x_0}-\bigcup_{i=1}^n I_{i,x_0}\right)\cup ([a,x_0]-E_{x_0})$ 根据[[MK57][次可加性]]以及[[MK84][计算]]

有 $\varphi([a,x_0]-\bigcup_{i=1}^nI_{i,x_0})\leq\varphi\left(E_{x_0}-\bigcup_{i=1}^n I_{i,x_0}\right)+\varphi([a,x_0]-E_{x_0})=\varphi\left(E_{x_0}-\bigcup_{i=1}^n I_{i,x_0}\right)$

即有 $\varphi([a,x_0]-\bigcup_{i=1}^nI_{i,x_0})<\delta$

定义 $K_{x_0}=[a,x_0]-\bigcup_{i=1}^nI_{i,x_0}$ 由于 $I_{i,x_0}$ 是闭区间且有限，故易证 $K_{x_0}$ 亦为有限个开区间的并

故易证 $K_{x_0}=(a,u_1)\cup\left(\bigcup_{i=1}^{n-1}(u_{i}+h_i,u_{i+1})\right)\cup (u_{n+1},x_0)$

***** 证明结论

由于 $\varphi(K)<\delta$ 根据[[MK391][之前证明]]

可得 $|f(u_1)-f(a)|+\sum_{i=1}^{n-1}|f(u_{i+1})-f(u_i+h_i)|+|f(x_0)-f(u_n+h_n)|<\epsilon$

又由于 $I_{i,x_0}$ 互不相交且 $I_{i,x}\subset[a,x_0]\subset[a,b]$ 故有 $\bigcup_{i=1}^nI_{i,x_0}\subset[a,b]$

根据[[MK84][计算]] $\varphi(\bigcup_{i=1}^nI_{i,x_0})=\sum_{i=1}^n\varphi(I_{i,x_0})=\sum_{i=1}^n|h_i|\leq\varphi([a,b])=b-a$

根据[[MK391][之前证明]]即有

\begin{aligned}
&|f(u_1)-f(a)|+\sum_{i=1}^{n-1}|f(u_{i+1})-f(u_i+h_i)|+|f(x_0)-f(u_n+h_n)|+\sum_{i=1}^n|f(u_i+h_i)-f(u_i)|\\
\leq&\epsilon+\sum_{i=1}^n|h_i|\frac{\epsilon}{b-a}\\
=&\epsilon+\frac{\epsilon}{b-a}\sum_{i=1}^n|h_i|\\
\leq&\epsilon+\frac{\epsilon}{b-a}(b-a)\\
=&2\epsilon
\end{aligned}

又由于 $n$ 有限，则易证上式中为有限个绝对值和，故根据[[MK22][三角不等式]]

\begin{aligned}
&|f(u_1)-f(a)|+\sum_{i=1}^{n-1}|f(u_{i+1})-f(u_i+h_i)|+|f(x_0)-f(u_n+h_n)|+\sum_{i=1}^n|f(u_i+h_i)-f(u_i)|\\
\geq&\left|(f(u_1)-f(a))+\sum_{i=1}^{n-1}(f(u_{i+1})-f(u_i+h_i))+(f(x_0)-f(u_n+h_n))+\sum_{i=1}^n(f(u_i+h_i)-f(u_i))\right|\\
=&\left|(f(u_1)-f(a))-f(u_1)+f(u_n+h_n)+(f(x_0)-f(u_n+h_n))\right|\\
=&\left|f(x_0)-f(a)\right|
\end{aligned}

综上所述，对于任意 $\epsilon>0$ 均有 $|f(x_0)-f(a)|\leq2\epsilon$ 即可得 $f(x_0)-f(a)=0$

又由于 $x_0$ 的任意性可得 $f(x)=f(a)$ 是常值函数

*** 定理4<<MK394>>

函数 $f(x)$ 是 $[a,b]$ 上的[[MK384][绝对连续函数]]的充要条件为在 $[a,b]$ 上：

（1） [[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数]] $f'(x)$ [[MK190][几乎处处]]存在，且
...
根据[[MK387][定理2]]可得 $f(x)$ 是 $[a,b]$ 上的[[MK350][有界变差函数]]

根据[[MK385][定理2]]可得有界变差函数满足：

（1） 导数 $f'(x)$ 在 $[a,b]$ 上几乎处处存在

（2） 其导数 $f'(x)$ 在 $[a,b]$ 上[[MK237][勒贝格可积]]

***** 必要

根据[[MK388][定理1]]可得若 $f'(x)$ 在 $[a,b]$ 上[[MK237][勒贝格可积]]，则函数 $$F(x)=\int_{[a,x]}f'(t)dt$$ 是[[MK384][绝对连续函数]]

根据[[MK389][定理2]]可得 $$f(x)=\int_{[a,x]}f'(t)dt+f(a)=F(x)+f(a)$$

易证常值函数绝对连续，故根据[[MK382][运算]]有 $f(x)$ 亦为绝对连续函数

*** 运算<<MK392>>

若 $f(x),g(x)$ 是 $[a,b]$ 上的[[MK384][绝对连续函数]]则 $f(x)+g(x),f(x)-g(x),cf(x)$ 均为绝对连续函数
...
若 $f(x),g(x)$ 绝对连续，则有对于任意 $\epsilon$ 存在 $\delta_f,\delta_g$ 满足对于任意互不相交

的有限个开区间 $\{(a_i,b_i)\}$ 满足 $\sum_{i=1}^n(b_i-a_i)<\min(\delta_f,\delta_g)$

均有 $\sum_{i=1}^n|f(a_i)-f(b_i)|<\frac{\epsilon}{2}\land \sum_{i=1}^n|g(a_i)-g(b_i)|<\frac{\epsilon}{2}$ 则根据[[MK22][三角不等式]]

有 $\sum_{i=1}^n|(f(a_i)+g(a_i))-(f(b_i)+g(b_i))|\leq\sum_{i=1}^n\left(|f(a_i)-f(b_i)|+|g(a_i)-g(b_i)|\right)$

即 $\sum_{i=1}^n|(f(a_i)+g(a_i))-(f(b_i)+g(b_i))|\leq\sum_{i=1}^n|f(a_i)-f(b_i)|+\sum_{i=1}^n|g(a_i)-g(b_i)|<\epsilon$

故 $f(x)+g(x)$ 亦为绝对连续函数

***** 数乘

若 $f(x)$ 绝对连续，则有对于任意 $\epsilon$ 存在 $\delta$ 满足对于任意互不相交

的有限个开区间 $\{(a_i,b_i)\}$ 满足足 $\sum_{i=1}^n(b_i-a_i)<\delta$ 均有 $\sum_{i=1}^n|f(a_i)-f(b_i)|<\frac{\epsilon}{|c|}$

则有  $\sum_{i=1}^n|cf(a_i)-cf(b_i)|=|c|\sum_{i=1}^n|f(a_i)-f(b_i)|<\epsilon$
...
对于任意一个 $[a,b]$ 上的[[~/文档/note/离散数学/Disc_Math.org::MK360][有理划分]] $T=\{[a_0,a_1],[a_1,a_2],...\}$
...
定义 $[a,b]$ 上的所有有理划分集合为 $\mathcal{T}$ ，定义 $Z_{[a,b]}(f)=\left\{Z_{T,[a,b]}(f)\big|T\in\mathcal{T}\right\}$

则定义 $\overunderset{b}{a}{V}(f)=\sup(Z_{[a,b]}(f))$ 是 $f(x)$ 在 $[a,b]$ 上的全变差
...
即由 $T$ 的任意性以及[[~/文档/note/离散数学/Disc_Math.org::MK339][定理2]]可得 $\overunderset{b}{a}{V}(f)\leq\overunderset{c}{a}{V}(f)+\overunderset{b}{c}{V}(f)$
...
即由 $T$ 的任意性以及[[~/文档/note/离散数学/Disc_Math.org::MK361][定理7]]可得 $\overunderset{b}{a}{V}(f)\geq\overunderset{c}{a}{V}(f)+\overunderset{b}{c}{V}(f)$
...
对于任意增函数 $f(x)$ 根据[[MK335][定理2]]可得其不连续点是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]
...
设 $f(x)$ 是闭区间 $[a,b]$ 上的[[MK350][有界变差]]函数，则：
...
显然 $g(x),h(x)$ 是闭区间 $[a,b]$ 上的单调函数，故根据[[MK382][勒贝格定理]]有：

（1） $g(x),h(x)$ 在 $[a,b]$ 上[[MK190][几乎处处]]存在[[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数]]

（2） 导函数 $g'(x),h'(x)$ 在 $[a,b]$ 上均[[MK237][勒贝格可积]]

则根据导数运算法则有 $f'(x)=g'(x)-h'(x)$ 即 $f'(x)$ 亦几乎处处存在

根据[[MK262][线性]]可得 $$\int_{[a,b]}f'(x)dx=\int_{[a,b]}g'(x)dx-\int_{[a,b]}h'(x)dx$$

由于勒贝格可积，故有 $$\int_{[a,b]}g'(x)dx<\infty\land\int_{[a,b]}h'(x)dx<\infty$$

根据[[MK4][封闭性]]可得 $$\int_{[a,b]}f'(x)dx<\infty$$ 即 $f'(x)$ 亦为勒贝格可积函数

** 可测函数<<MK134>>

定义[[MK212][外侧度空间]] $<X,\varphi>$ 及[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\mathbb{R}_e,E\subset X$ 其中 $\mathbb{R}_e=\mathbb{R}\cup\{-\infty,+\infty\}$ 为[[MK143][广义实数]]
...
由于是[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]，则对于任意 $x\in E$ 可得存在唯一 $f(x)\in\mathbb{R}_e$ 满足 $<x,f(x)>\in f$ 
...
根据[[MK155][推论]]可得任意 $\mathbb{R}_e$ 上的开集可有由[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的实数[[MK42][构成区间]]的并之后，与 $\pm\infty$ 的组合并组成

根据定义构成区间为开区间，且则根据[[MK158][之前证明]]可得开区间的原相可测

结合[[MK135][性质]]可得[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的实数[[MK42][构成区间]]的并的原相，等价于原相的并

故根据[[MK65][Caratheodory定理]]可得由[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个不相交的实数[[MK42][构成区间]]的并的原相可测
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $S=S'$ 由于 $f(x),g(x)$ 均为[[MK134][可测函数]]，进一步根据[[MK154][等价定义]]
...
同样根据[[MK50][定义（3）]]以及[[~/文档/note/离散数学/Disc_Math.org::MK325][有理数可数]]可得 $S'$ 可测，即 $S$ 可测

**** 定理4<<MK177>>

定义结构 $<E,\varphi>$ 其中 $E$ 为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $\varphi$ 是[[MK61][外侧度]]

定义[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]集 $K=\{E_i\}\subset\rho(E)$ 对于任意 $E_i\in K$ 均满足：

（1） $E_i$ 是 $<X,\varphi>$ 上的[[MK174][外测度可测集]]

（2） $\{E_i\}$ 是对 $E$ 的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]
...
定义结构 $<E,\varphi>$ ，其中 $E$ 为[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $\varphi$ 是[[MK61][外侧度]]，定义 $f:E\to\mathbb{R}_e$ 为非负[[MK133][广义实值函数]]。则有：

（1） 若 $f(x)$ 为[[MK134][可测函数]]，则存在递增的非负[[MK178][简单函数]]列 $\{\phi_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $f(x)$ 即 $\lim_{i\to\infty}\phi_i(x)=f(x)$

（2） 若满足（1）且 $f(x)$ [[MK202][有界]]，则 $\{\phi_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
对于任意 $k>K$ 均有 $f(x)-\phi_k(x)<\epsilon$ 即当 $f(x)\in\mathbb{R}$ 时函数项级数 $\{\phi_i\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][收敛]]于 $f(x)$

若 $f(x)=+\infty$ 则有 $\lim_{k\to\infty}\phi_k(x)=+\infty$

综上所述函数项级数 $\{\phi_i\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][收敛]]于 $f(x)$
...
即函数项级数 $\{\phi_i\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
定义[[MK212][外侧度空间]] $<X,\varphi>$ 及[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\mathbb{R}_e,E\subset X$
...
类似易证 $\left(f^{-1}((a,\infty])\cap A\right)\subset g^{-1}((a,+\infty])$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $g^{-1}((a,+\infty])=\left(f^{-1}((a,\infty])\cap A\right)$
...
定义[[MK212][外侧度空间]] $<X,\varphi>$ 及[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\mathbb{R}^+,E\subset X$
...
若存在[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]个[[MK134][可测函数]] $f_i(x), i\in\mathbb{N}\land x\in E$

定义 $\phi(x)=\inf\left\{f_i(x)\big|i\in\mathbb{N}\right\},\psi(x)=\sup\left\{f_i(x)\big|i\in\mathbb{N}\right\}$

即为 $f_i(x)$ 的上下[[~/文档/note/离散数学/Disc_Math.org::MK326][确界]]，则 $\phi(x),\psi(x)$ 仍为[[MK134][可测函数]]
...
则根据下[[~/文档/note/离散数学/Disc_Math.org::MK326][确界]]定义有 $\forall i\in\mathbb{N}\rightarrow f_i(x)>a$ 即 $\forall i\in\mathbb{N}\rightarrow f_i(x)\in(a,+\infty]\rightarrow\forall i\in \mathbb{N}(x\in f_i^{-1}((a,+\infty])$

根据[[~/文档/note/离散数学/Disc_Math.org::MK35][广义交]]可得 $x\in\bigcap_{i\in I}f_i^{-1}((a,+\infty])$ 综上所述 $\forall x\in \phi^{-1}((a,+\infty])\rightarrow x\in\bigcap_{i\in I}f_i^{-1}((a,+\infty])$

类似易证 $\forall x\in\bigcap_{i\in I}f_i^{-1}((a,+\infty])\rightarrow \phi^{-1}((a,+\infty])$

故根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]] $\phi^{-1}((a,+\infty])=\bigcap_{i\in I}f_i^{-1}((a,+\infty])$

由于 $f_i(x)$ 是可测函数，故根据[[MK134][定义]]可得 $f_i^{-1}((a,+\infty])$ 是[[MK65][外测度可测集]]

根据[[MK65][Caratheodory定理]]可知[[MK65][外测度可测集]]构成[[MK50][ $\sigma$ 代数]]，由于 $I$ 是在[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]
...
对于[[~/文档/note/离散数学/Disc_Math.org::MK44][可数]]个[[MK134][可测函数]] $f_i(x), i\in\mathbb{N}$ 其上定义其[[MK267][下极限函数]] $\phi(x)=\overline{\lim_{i\to\infty}}f_i(x),\psi(x)=\underline{\lim_{i\to\infty}}f_i(x)$

则 $\phi(x),\psi(x)$ 仍为[[MK134][可测函数]]

***** 证明

则对于给定 $x\in\mathbb{R}_e$ 有[[~/文档/note/离散数学/Disc_Math.org::MK1][集合]] $\{f_i(x)\}$ 其中 $i\in\mathbb{N}$ 
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集定义]]可得 $\{+\infty\}$ 是闭集，故根据[[MK197][等价条件]]可得对于连续函数 $f^{-1}(\{\infty\}})$ 是闭集

根据[[MK207][闭集可测]]可得 $f^{-1}(\{\infty\}})$ 是[[MK174][可测集]]

根据[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]易证得 $(a,+\infty)$ 为 $\mathbb{R}$ 上的开集，根据[[MK105][等价定义]]可得原相 $f^{-1}((a,+\infty))$ 必为 $\mathbb{R}^n$ 上的开集
...
若不为空集，则取 $x_0$ 为$f^{-1}((a,+\infty])=\varnothing$ 的[[~/文档/note/离散数学/Disc_Math.org::MK326][下确界]]
...
定义[[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]集 $K=\{E_i\}\subset\rho(E)$ 对于任意 $E_i\in K$ 均满足：
...
由于 $E_i$ 是 $E$ 的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]，易证 $A_i$ 是 $A$ 的划分
...
则对于任意 $x\in E$ 由于是[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]则必然存在 $i$ 满足 $x\in E_i$ ，同理存在 $j$ 满足 $x\in E_j$
...
（1） 存在 $E^*$ 满足 $\varphi(E^*)=0$ 且当 $x\in E-E^*$ 时有 $\{f_k(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $f(x)$
...
（2） 在 $E-E_\delta$ 上有 $\{f_k(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
***** 余集[[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]

集合 $E-E_\delta$ 当 $E$ 为全集时等于 $E_\delta^c$ 即自身的补集

即 $\left(\bigcup_{i=1}^\infty\bigcup_{k\geq N_{\delta,i}}^\infty\left\{x\in E\big||f_k(x)-f(x)|>\frac{1}{i}\right\}\right)^c$ ，则根据[[~/文档/note/离散数学/Disc_Math.org::MK331][广义并与补]]可得
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK331][量词与计算]]可得 $E-E_\delta=\left\{x\in E\big|\forall i\in\mathbb{N},\exists N_{\delta,i},\forall k>N_{\delta,i}\rightarrow|f_k(x)-f(x)|<\frac{1}{i}\right\}$
...
即[[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]定义，证毕
...
（2） 在 $\bar{E}-\bar{E}_\delta$ 上 $\{f_k(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
则根据[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]定义，其不收敛的点集为 $E^*=\left\{x\big|\exists\epsilon,\forall N,\exists k>N\rightarrow |f_k(x)-f(x)|\geq\epsilon\right\}$

即根据[[~/文档/note/离散数学/Disc_Math.org::MK331][量词与计算]]可得 $E^*=\bigcup_{\epsilon>0}\bigcap_{N\in\mathbb{N}}\bigcup_{k\geq N}^\infty\left\{x\big||f_k(x)-f(x)|\geq\epsilon\right\}$
...
[[MK189][依测度收敛]]无法导出[[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]或[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]
...
由于 $x$ 的任意性，可得不存在 $x\in E$ 使得 $\{f_k(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]

故 $\{f_k(x)\}$ 处处不收敛，即不是[[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]或[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]
...
均有 $x\in\left\{x\in E\big||f(x)-g(x)|<\frac{1}{n}\right\}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK20][子集定义]]
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK332][子集与运算]]、[[~/文档/note/离散数学/Disc_Math.org::MK331][补与交]]、[[MK61][单调性]]以及[[MK61][次可数可加性]]可得
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $\left\{x\in E\big||f(x)-g(x)|>\frac{1}{n}\right\}=\left\{x\in E\big|f(x)\ne g(x)\right\}$

即有 $\varphi\left(\left\{x\in E\big|f(x)\ne g(x)\right\}\right)=0$ 

*** 引理3

[[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]无法导出[[MK189][依测度收敛]]
...
该子列[[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $f(x)$

由于[[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]与 $f(x)=1$ 故子列 $\{f_{k_s}(x)\}$ 亦收敛于 $f(x)=1$
...
即 $x\in E$ 上[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]与 $f(x)=1$
...
若 $\{f_k(x)\}$ [[MK189][依测度收敛]] $f(x)$ 则存在子列 $\{f_{k(s)}(x)\}$ [[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $f(x)$
...
则对于任意 $s>\hat{N}$ 均有 $|f_{k(s)}(x)-f(x)|<\frac{1}{u}<\epsilon$ 即当 $x\in Z$ 时 $\{f_{k(s)}(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]与 $f(x)$

**** 不收敛点集是零测集

根据[[MK193][之前证明]]可知收敛点集为 $Z$ ，则不收敛点集为其补集 $Z^c$

则根据[[~/文档/note/离散数学/Disc_Math.org::MK331][补与交并]]可得 $$Z^c=\bigcap_{N\in\mathbb{N}}\bigcup_{s\geq N}\left\{x\in E\bigg||f_{k(s)}(x)-f(x)|>\frac{1}{s}\right\}$$

对于任意 $n\in\mathbb{N}$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK31][交定义]]可得 $$Z^c\subset\bigcup_{s\geq n}\left\{x\in E\bigg||f_{k(s)}(x)-f(x)|>\frac{1}{s}\right\}$$
...
综上所述，不一致收敛的点是零测集，即 $\{f_{k(s)}(x)\}$ [[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
由于 $E\subset\mathbb{R}^n$ 则定义 $<\mathbb{R}^n, \tau(\mathbb{R}^n)>$ 为其[[MK39][拓扑]]，其中 $\tau(\mathbb{R}^n)$ 是 $\mathbb{R}^n$ 上所有[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]的集合
...
（1） [[~/文档/note/离散数学/Disc_Math.org::MK179][划分]] $\{E_1,...,E_s\}$ 满足 $E=\bigcup_{i=1}^s E_i$
...
则根据[[MK200][推论]]可得存在简单函数列 $\{\phi_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $g(x)$ 则
...
则[[MK203][类似可证]] $F$ 是 $<E, \tau(E)>$ 上的[[MK129][闭集]]，且进一步根据[[~/文档/note/离散数学/Disc_Math.org::MK328][德摩根律]]以及[[MK61][次可数可加性]]可得
...
故根据 $\{\phi_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $g(x)$ 可得在 $F$ 上 $\{\phi'_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $g'(x)$
...
则根据[[MK213][定义]]、[[~/文档/note/离散数学/Disc_Math.org::MK327][分配率]]以及[[MK56][可数可加性]]有
...
则根据[[MK73][定理]]、[[~/文档/note/离散数学/Disc_Math.org:MK333][集合族并]]以及极限的四则运算有
...
由于是非负[[MK178][简单函数]]，则定义 $f(x)$ 的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]集合为 $\{E_i\}$ ， $g(x)$ 则为 $\{E_j\}$
...
由于是[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]故有对于任意 $i,j$ 均有 $E_i\subset E\land E_j\subset E$ 则根据[[MK213][定义]]、[[~/文档/note/离散数学/Disc_Math.org::MK327][分配律]]、[[~/文档/note/离散数学/Disc_Math.org::MK336][同一律]]
...
又根据[[~/文档/note/离散数学/Disc_Math.org::326][确界定义]]易证 $$\int_E f(x)\chi_{A}(x)dx=\sup\left\{\int_E\phi(x)dx\bigg|\phi(x)\in\mathcal{Z}_E(f(x)\chi_{A}(x))\right\}\leq\int_A g(x)dx$$
...
若有界，则根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]可得 存在 $a\in\mathbb{R}$ 满足 $\lim_{i\to\infty}f_i(x')=a$
...
对于任意 $x\in E_i$ 均有 $f_{i+1}(x)\geq f_i(x)\geq c\phi(x)$ 故有 $x\in E_{i+1}$ ，根据[[~/文档/note/离散数学/Disc_Math.org::MK20][子集定义]]可得 $E_i\subset E_i$
...
又由于对于任意 $x\in E^*$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK34][定义]]存在 $i\in\mathbb{N}^+$ 满足 $x\subset E_i$

进一步根据 $E_i$ 定义可得 $E_i\subset E'$ 故有 $E^*\subset E'$

综上所述，根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $E^*=E'$ 即 $E'=\bigcup_{i=1}^\infty E_i$
...
定义 $I_i=\left\{f_k(x)\big|k\geq n\land k\in\mathbb{N}^+\right\}$ 以及 $D_i(x)=\inf\left\{I_i\}$ 即函数集合 $I_i$ 的[[~/文档/note/离散数学/Disc_Math.org::MK342][函数下确界]]
...
故根据[[~/文档/note/离散数学/Disc_Math.org::326][确界定义]]易证 $$\int_{A\cup B}f(x)dx=\sup\left\{\int_E\phi(x)\bigg|\phi(x)\in\mathcal{Z}_{A\cup B}(f(x))\right\}\leq\int_Af(x)dx+\int_Bf(x)dx$$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK339][定理2]]可得 $\sup\{M\}\leq\int_{A\cup B}f(x)dx$

根据[[~/文档/note/离散数学/Disc_Math.org::MK338][定理3]]有 $\sup\{M\}=\sup\{M_A\}+\sup\{M_B\}=\int_Af(x)dx+\int_Bf(x)dx$
...
则根据[[~/文档/note/离散数学/Disc_Math.org::MK5][外延公理]]可得 $B=A$
...
故根据[[~/文档/note/离散数学/Disc_Math.org::MK340][定理4]]可得 $$\sup\left\{\alpha\int_E\psi(x)dx\bigg|\psi(x)\in\mathcal{Z}_E(f(x))\right\}=\alpha\sup\left\{\int_E\psi(x)dx\bigg|\psi(x)\in\mathcal{Z}_E(f(x))\right\}$$
...
[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\mathbb{R}_e,E\subset X$ 是 $<X,\varphi>$ 上的[[MK134][可测函数]]，且 $E$ 为[[MK174][可测集]]
...
（3） 若 $$\int_Ef^+(x)dx<\infty\land\int_Ef^-(x)dx<\infty$$ 即均有限时，称 $f(x)$ 在 $E$ 勒贝格可积
...
若 $\varphi(E)=0\land E\ne\varnothing$ 则对于任意[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\mathbb{R}_e$ 均有 $f(x)\in\mathcal{L}(E)$
...
若[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f:E\to\mathbb{R}_e$ 满足 $f(x)\in\mathcal{L}(E)$ 则 $f(x)$ 在 $E$ 上[[MK190][几乎处处]]有限
...
又由[[MK198][引理]]可得 $f^+(x),f^-(x)$ 均为非负可测函数，显然 $|f(x)|=f^+(x)+f^-(x)$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]可得对于任意 $s>0$ 均有 $\phi(x)\in\mathcal{Z}_{E'}(f(x))$ 满足 $$\int_{E'}\phi(x)dx\leq\int_{E'}f(x)dx<\int_{E'}\phi(x)dx+s$$
...
（2） [[MK190][几乎处处]]满足 $\lim_{n\to\infty}f_n(x)=f(x)$ 即[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $f(x)$
...
******* [[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]

根据[[MK251][性质2]]可得若 $F(x)$ [[MK247][勒贝格可积]]，则 $F(x)$ 在 $E$ 上[[MK190][几乎处处]]有限

则定义 $x\in E'$ 时 $F(x)$ 有限，根据几乎处处性质有 $\varphi(E-E')=0$

进一步有 $S_n(x)$ 在 $E'$ 上[[~/文档/note/数学分析/Chap10Note.org::MK5][绝对收敛]]，则根据[[~/文档/note/数学分析/Chap10Note.org::MK4][引理]]可得 $S_n(x)$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]
...
若[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]] $f(x,t)$ 满足：

（1） $f:E\times[a,b]\to\mathbb{R}$ 为实值函数

（2） 对于任意 $t'\in(a,b)$ 均有 $f(x,t')\in\mathcal{L}(E)$ [[MK237][勒贝格可积]]

（3） 对于任意 $x'\in E$ 均有 $f(x',t)$ 在 $t\in(a,b)$ 上[[~/文档/note/大学物理/Note/DiffEq.org::MK20][可导]]
...
对于任意 $x'\in E$ ，由于条件（3），根据根据[[~/文档/note/大学物理/Note/DiffEq.org::MK1][可导必连续]]可得 $f(x',t)$ 在 $t\in(a,b)$ 上[[MK106][连续]]

由于 $t'\in(a,b)\land\forall n(t'+h_n\in(a,b))$ 故可得 $f(x',t)$ 在 $t\in[t',t'+h_n]$ 上连续 $t\in(t',t'+h_n)$ 上可导

则根据[[~/文档/note/大学物理/Note/DiffEq.org::MK5][中值定理]]可得存在 $\theta\in[0,1]$ 满足 $g(x')=\frac{f(x',t'+h_n)-f(x,t')}{h_n}=\frac{\partial f(x',t' +\theta h_n)}{\partial t}$
...
进一步根据 $\{h_n\}$ 的任意性以及[[~/文档/note/数学分析/Chap7Note.org::MK9][引理]]可得 $$\lim_{h\to0}\left\{\frac{\int_Ef(x,t'+h)dx-\int_Ef(x,t')dx}{h}\right\}=\int_E\frac{\partial f(x,t')}{\partial t}dx$$

根据[[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数定义]]可得 $$\frac{d}{d t}\left(\int_Ef(x,t')dx\right)=\int_E\frac{\partial f(x,t')}{\partial t}dx$$
...
（1） $\Omega(E)=\sup\left\{|f(s)-f(t)|\big|\{s,t\}\subset E\right\}$ 是集合的[[~/文档/note/数学分析/Chap7Note.org::MK16][振幅]]

（2） $\omega_f(x)$ 是点的[[~/文档/note/数学分析/Chap7Note.org::MK16][振幅]]
...
则固定任意 $\epsilon>0$ ，对于任意 $x_0\not\in\bigcup_{n=1}^\infty P_n$ 定义 $\omega_f(x_0)$ 是 $x_0$ 点的[[~/文档/note/数学分析/Chap7Note.org::MK16][振幅]]

根据[[~/文档/note/数学分析/Chap7Note.org::MK15][引理4]]可得存在 $\Delta>0$ 对于任意 $|b-a|<\Delta\land x_0\in(a,b)$ 均有 $\Omega([a,b])-\omega_f(x_0)<\epsilon$
...
又根据[[~/文档/note/数学分析/Chap7Note.org::MK17][引理3]]以及 $x_0\in(x_{n',i-1},x_{n',i})$ 可得 $\Omega([x_{n',i-1},x_{n',i}])\geq\omega_f(x_0)$
...
即对于任意 $x_0\not\in\bigcup_{n=1}^\infty P_n$ 有 $\phi_n(x)$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $\omega_f(x)$

又根据[[~/文档/note/数学分析/Chap7Note.org::MK14][定义]]可得 $P_n=\{x_i\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]，则易证 $\forall n\in\mathbb{N}\rightarrow\varphi(P_n)=0$

则根据[[MK278][可数零测]]可得 $\varphi\left(\bigcup_{n=1}^\infty P_n\right)=0$ 。故可得 $\phi_n(x)$ [[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $\omega_f(x)$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK339][定理2]]可得 $\Omega([u,v])\leq 2M+1$ 由 $u,v$ 的任意性可得 $\forall n\in\mathbb{N},\forall x\in[a,b]\rightarrow|\phi_n(x)|\leq 2M+1$
...
根据[[~/文档/note/数学分析/Chap7Note.org::MK14][定义]]可得 $P_n=\{x_i\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]，则易证 $\forall n\in\mathbb{N}\rightarrow\varphi(P_n)=0$
...
结合 $\varphi(E^*)=0$ 可得 $\phi_n(x)$ [[MK190][几乎处处]]有[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $\omega_f(x)$
...
闭区间 $[a,b]\subset\mathbb{R}$ 上的[[MK202][有界]]函数 $f(x)$ [[~/文档/note/数学分析/Chap7Note.org::MK6][黎曼可积]]的充要条件是

$f(x)$ 在 $[a,b]$ 上[[MK190][几乎处处]]连续

***** 证明

根据[[~/文档/note/数学分析/Chap7Note.org::MK18][推论3]]可得若黎曼可积，其充要条件是
...
即 $$(\mathcal{L})\int_{[a,b]}\omega_f(x)dx=0$$ 由于 $\omega_f(x)$ 是[[~/文档/note/数学分析/Chap7Note.org::MK16][振幅]]，故根据其定义非负

则根据[[MK281][性质8]]可得 $\omega_f(x)$ 不为零的点是[[MK126][零测集]]是 $$(\mathcal{L})\int_{[a,b]}\omega_f(x)dx=0$$ 的充要条件

又根据[[~/文档/note/数学分析/Chap7Note.org::MK19][引理5]]可得 $\omega_f(x)\ne0$ 充要条件是函数 $f(x)$ 在 $x$ 点不连续

综上所述，易证 $f(x)$ 在 $[a,b]$ 上几乎处处连续是[[~/文档/note/数学分析/Chap7Note.org::MK6][黎曼可积]]的充要条件
...
根据[[~/文档/note/数学分析/Chap7Note.org::MK21][推论2]]可得单调有界函数黎曼可积，则根据定理可得几乎处处连续

**** 定理3：黎曼可积与勒贝格可积<<MK288>>

闭区间 $[a,b]\subset\mathbb{R}$ 上的[[MK202][有界]]函数 $f(x)$ [[~/文档/note/数学分析/Chap7Note.org::MK6][黎曼可积]]的，则有：

（1） $f(x)$ 在 $E=[a,b]$ 上[[MK237][勒贝格可积]]

（2） $$(\mathcal{L})\int_{[a,b]}f(x)dx=(\mathcal{R})\int_a^bf(x)dx$$ 即[[~/文档/note/数学分析/Chap7Note.org::MK6][黎曼积分]]等于[[MK237][勒贝格积分]]
...
若满足 $\lim_{n\to\infty}\lambda_n=0$ 则根据[[~/文档/note/数学分析/Chap7Note.org::MK6][黎曼可积]]定义 $$(\mathcal{R})\int_a^bf(x)dx=\lim_{n\to\infty}\sum_{i=1}^{|P_n|-1}f(\xi_{n,i})(x_{n,i}-x_{n,i-1})$$
...
（1） $\forall A>a$ 均有 $f(x)$ 在 $[a,A]$ 上[[MK202][有界]]且[[~/文档/note/数学分析/Chap7Note.org::MK6][黎曼可积]]
...
最终根据[[~/文档/note/数学分析/Chap8Note.org::MK2][反常积分定义]]可得 $$\lim_{n\to\infty}(\mathcal{R})\int_a^{A_n}f(x)dx=(\mathcal{R})\int_a^\infty f(x)dx$$

**** 定理4：几何意义<<MK312>>

若 $f(x)$ 为[[MK174][外侧度可测集]] $E\subset\mathbb{R}^n$ 上的非负[[~/文档/note/离散数学/Disc_Math.org::MK194][函数]]
...
根据定义有 $f(x)=\sum_{i=1}^s c_i\chi_{E_i}(x)$ ，其中 $\{E_i\}$ 是对 $E$ 的[[~/文档/note/离散数学/Disc_Math.org::MK179][划分]]且 $E_i$ 是 $\mathbb{R}^n$ 上的[[MK81][可测集]]
...
若 $f(x)$ 是[[MK134][可测函数]]，则根据[[MK230][定理5]]可得存在递增[[MK178][简单函数]]列 $\{\phi_i(x)\}$ [[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]于 $f(x)$

对于任意 $<x,y>\in G(E,f)$ 有 $y<f(x)$ ，则由于[[~/文档/note/数学分析/Chap10Note.org::MK2][逐点收敛]]存在 $i'$ 满足 $y<\phi_{i'}(x)$

即 $<x,y>\in G(E,\phi_i)$ 故有 $G(E,f)\subset\bigcup_{i=1}^\infty G(E,\phi_i)$

由于递增函数，且逐点收敛，故根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]易证 $\forall x\rightarrow f(x)=\sup\{\phi_i(x)\}$

即 $\forall i\rightarrow f(x)\geq\phi_i(x)$ 则对于任意 $<x,y>\in\bigcup_{i=1}^\infty G(E,\phi_i)$ 均有 $x\in E\land y<f(x)$

即 $<x,y>\in G(E,f)$ 则有 $\bigcup_{i=1}^\infty G(E,\phi_i)\subset G(E,f)$ 最终根据[[~/文档/note/离散数学/Disc_Math.org::MK21][自反性]]可得 $G(E,f)=\bigcup_{i=1}^\infty G(E,\phi_i)$
...
根据[[~/文档/note/离散数学/Disc_Math.org::MK347][差分配]] $E-E\cap R=(E-E)\cup(E-R)=E-R$ 由于 $E\subset\mathbb{R}^n$ 即有 $E-R\subset\mathbb{R}^n-R$ 
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]可得存在 $\delta>0$ 满足 $(x-\delta,x+\delta)\subset U$
...
则存在[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]集 $\{I_n\}\subset V$ 满足:

（1） $\forall\{i,j\}\subset\mathbb{N}\rightarrow I_i\cap I_j=\varnothing$

（2） $\varphi\left(E-\bigcup_{i}^\infty I_n\right)=0$

（3） $\varphi\left(\bigcup_{i=1}^\infty I_i\right)=\sum_{i=1}^\infty \varphi(I_i)<\infty$
...
显然根据区间定义有 $I_i\subset\overline{I}_i$ 故易证 $\bigcup_{i=1}^\infty I_i\subset\bigcup_{i=1}^\infty\overline{I}_i$ 则根据[[~/文档/note/离散数学/Disc_Math.org::MK332][子集性质]]有 $\bigcup_{i=1}^\infty \overline{I}_i=\bigcup_{i=1}^\infty I_i\cup\left(\bigcup_{i=1}^\infty\overline{I}_i-\bigcup_{i=1}^\infty I_i\right)$

进一步根据[[~/文档/note/离散数学/Disc_Math.org::MK347][差分配]]以及[[~/文档/note/离散数学/Disc_Math.org::MK327][分配率]]易证 $\left(E-\bigcup_{i}^\infty \overline{I}_i\right)\cup\left(\bigcup_{i=1}^\infty\overline{I}_i-\bigcup_{i=1}^\infty I_i\right)=E-\bigcup_{i}^\infty I_i$
...
由于 $\forall I\in W$ 均有 $I\subset U$ 故根据[[MK60][单调性]] $\varphi(I)\leq\varphi(U)<\infty$ 根据[[~/文档/note/离散数学/Disc_Math.org::MK339][定理2]]可得 $r_n\leq\varphi(U)<\infty$

若 $E-\bigcup_{i=1}^nI_i=\varnothing$ 则 $\{I_1,...,I_n\}$ 满足条件

若 $E-\bigcup_{i=1}^nI_i\ne\varnothing$ 则存在 $x\in E-\bigcup_{i=1}^nI_1$

根据[[MK319][之前定义]]可得 $I_i\in W$ 均是[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集]]，则根据[[~/文档/note/数学分析/Chap11Note.org::MK28][定理6]]可得 $\bigcup_{i=1}^n I_i$ 是[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集]]，即根据[[~/文档/note/数学分析/Chap11Note.org::P1][定理1]] $\left(\bigcup_{i=1}^n I_i\right)^c$ 是[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]

根据[[~/文档/note/离散数学/Disc_Math.org::MK334][补与减]]可得 $E-\bigcup_{i=1}^nI_i=E\cap\left(\bigcup_{i=1}^nI_i\right)^c$ 即 $x\in\left(\bigcup_{i=1}^n I_i\right)^c$

则根据[[MK320][引理]]可得存在 $I^*\in W\land I^*\in\left(\bigcup_{i=1}^n I_i\right)^c$ 即 $K_n$ 非空，则 $r_n$ 有定义

根据[[~/文档/note/离散数学/Disc_Math.org::MK326][确界定义]]存在 $I_{n+1}$ 满足 $\varphi(I_{n+1})>\frac{r_n}{2}\land I_{n+1}\in K_n$
...
进一步根据[[MK82][区间可测]]以及[[MK656][Caratheodory定理]]可得 $\varphi\left(\bigcup_{i=1}^\infty I_i\right)=\sum_{i=1}^\infty \varphi(I_i)<\infty$ 即证明（3）

**** 证明零测<<MK325>>

对于任意 $y\in E-\bigcup_{i=1}^\infty I_i$ 均满足对于任意 $k>1$ 有 $y\not\in\bigcup_{i=1}^k I_i$ 即 $y\in\left(\bigcup_{i=1}^k I_i\right)^c$

根据上一步证明类似可证 $\left(\bigcup_{i=1}^k I_n\right)^c$ 是[[~/文档/note/数学分析/Chap11Note.org::MK10][开集]]，则根据[[MK320][引理]]可得存在 $I^*\in W\land y\in I^*$
...
则根据[[MK322][之前定义]]对于任意 $n\in\mathbb{N}$ 有 $I^*\in K_n$ 则 $\varphi(I^*)\leq r_n$ 进一步根据[[MK322][之前证明]]可得 $\sum_{i=1}^\infty \varphi(I_i)<\infty$

根据[[MK54][非负性]]易证 $S_z=\sum_{i=1}^z \varphi(I_i)$ 单调递增，故根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]可得 $S_z$ 收敛

最终根据[[~/文档/note/数学分析/Chap9Note.org::MK5][推论4]]可得 $\lim_{z\to\infty}\varphi(I_z)=0$ 由于 $I_z>\frac{r_{z-1}}{2}$ 即可得 $\lim_{z\to\infty}r_z=0$
...
根据[[MK324][之前证明]] $S_z=\sum_{i=1}^z \varphi(I_i)$ 为收敛级数，则根据[[~/文档/note/数学分析/Chap9Note.org::MK5][推论3]]可得 $\lim_{k\to\infty}\sum_{i=k}^\infty\varphi(I_i)=0$
...
则对于任意 $\epsilon>0$ 存在[[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]个区间 $I_1,I_2,...,I_n}$ 使得

（1） $\forall\{i,j\}\subset\mathbb{N}\rightarrow I_i\cap I_j=\varnothing$

（2） $\varphi\left(E-\bigcup_{i}^n I_n\right)<\epsilon$

**** 证明

根据[[MK327][覆盖定理]]可得存在 $\{I_i\}$ 满足 $\varphi(E-\bigcup_{i=1}^\infty I_i)=0$ 以及 $\varphi\left(\bigcup_{i=1}^\infty I_i\right)=\sum_{i=1}^\infty \varphi(I_i)<\infty$

根据[[MK54][非负性]]易证 $S_z=\sum_{i=1}^z \varphi(I_i)$ 单调递增，故根据[[~/文档/note/数学分析/Chap11Note.org::MK17][单调有界数列定理]]可得 $S_z$ 收敛

故有 $\lim_{z\to\infty}S_z=\sum_{i=1}^\infty \varphi(I_i)=\varphi(E)$ 故根据极限定义 $\forall\epsilon>0,\exists N,\forall n>N\rightarrow \varphi(E)-S_n<\epsilon$

则有 $\varphi(E)-\sum_{i-1}^{N+1}\varphi(I_i)<\epsilon$ 由于递增 $\sum_{i=1}^{N+1} \varphi(I_i)\leq\sum_{i=1}^\infty \varphi(I_i)<\infty$

由于[[MK82][区间可测]]故根据[[MK84][计算（3）]]以及[[MK84][计算（2）]]可得 $\varphi(E)-\sum_{i-1}^{N+1}\varphi(I_i)=\varphi(E)-\varphi(\sum_{i-1}^{N+1}I_i)=\varphi(E-\sum_{i-1}^{N+1}I_i)$

最存在 $I_1,...,I_{N+1}$ 满足 $\varphi(E-\sum_{i-1}^{N+1}I_i)<\epsilon$
...
则根据[[~/文档/note/数学分析/Chap11Note.org::MK30][推论]]可得必有收敛子列 $\lim_{i\to\infty}d_{n_i}=A$
...
若不存在[[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数]]，则必有两个[[MK326][列导数]]不相等

**** 证明

假设所有列导数的极限都相等，定义函数 $g(h)=\frac{f(x+h)-f(x)}{h}$

则根据[[~/文档/note/数学分析/Chap11Note.org::MK31][海涅定理]]可得若 $\lim_{h\to0}g(h)=A$ 故存在[[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数]]
...
由于 $\{h_n\}$ 是[[~/文档/note/离散数学/Disc_Math.org::MK43][无限集]]且 $\forall n\in\mathbb{N}\rightarrow h_n\ne0$ ，则至少存在一个同号子列 $\{h'_n\}$ ，易证同样[[MK326][满足条件]]
...
根据[[MK327][维塔利覆盖定理]]可得存在[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数]]集 $\{\Delta_i(x_i)\}\subset V$ 满足 $\varphi\left(f(E)-\bigcup_{i}^\infty \Delta_i(x_i)\right)=0$
...
故假设不成立，即不存在 $x_1\ne x_2$ 使得 $f(x_1)=f(x_2)$ ，故 $f(x)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK195][单射函数]]

显然 $f(x)$ 亦是[[~/文档/note/离散数学/Disc_Math.org::MK198][满射函数]]，则 $f(x)$ 亦是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射函数]]，故存在[[~/文档/note/离散数学/Disc_Math.org::MK203][逆函数]] $f^{-1}(y)$ 且亦为严格递增函数
...
由于 $f(x)$ 是[[~/文档/note/离散数学/Disc_Math.org::MK200][双射函数]] $E=E^*\cap Z'$ 故根据[[~/文档/note/离散数学/Disc_Math.org::MK356][相分离]]可得 $f(E)=f(E^*)\cup f(Z')$

由于 $f(x)$ 双射，故 $f(Z')\sim Z'$ 根据[[MK335][定理2]]可得 $Z'$ 是[[~/文档/note/离散数学/Disc_Math.org::MK48][至多可数集]]，则 $f(Z')$ 以为至多可数集
...
（1） $f(x)$ 在 $[a,b]$ 上[[MK190][几乎处处]]存在[[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数]]（可以是无穷）
...
又根据[[~/文档/note/离散数学/Disc_Math.org::MK358][推论2]]可得 $\mathbb{Q}^+\times\mathbb{Q}^+$ 亦为可数集，故根据[[MK278][可数并零测]]可得 $\varphi\left(\bigcup_{<p,q>\in\mathbb{Q}\times\mathbb{Q}}E_{p,q}\right)=0$
...
故当 $x\not\in E\land x\in[a,+\infty)$ 根据[[~/文档/note/数学分析/Chap11Note.org::MK31][海涅定理]]可得 $\lim_{n\to\infty}\frac{f_z(x+\frac{1}{n})-f_z(x)}{\frac{1}{n}}=f'_z(x)$
...
即 $f(x)$ 在 $E$ 上的[[~/文档/note/大学物理/Note/DiffEq.org::MK20][导数]]为无穷
...
显然 $|f_i(x)|\leq\frac{1}{2^n}$ 且 $\sum_{i=1}^\infty\frac{1}{2^i}<\infty$ 故根据[[~/文档/note/数学分析/Chap10Note.org::MK6][判别法]]可得 $\sum_{i=1}^\infty f_i(x)$ [[~/文档/note/数学分析/Chap10Note.org::MK1][一致收敛]]于 $f(x)$
...
由于 $x_0\in G_k$ 则根据[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]存在 $\delta_k$ 对于任意 $0<h<\delta_k$ 均有 $[x,x_0+h]\subset G_k$
...
根据[[~/文档/note/数学分析/Chap11Note.org::MK10][开集定义]]可得存在 $\delta>0$ 满足 $(x-\delta,x+\delta)\subset Z$
...
易证 $\varphi(Z_1)=\varphi(Z_2)=0$ 且根据[[MK178][定义]] $\phi_1(x),\phi_2(x)$ 将集合划分为[[~/文档/note/离散数学/Disc_Math.org::MK42][有限]]集
...
又根据[[~/文档/note/数学分析/Chap7Note.org::K3][康拓定理]]可得 $f(x)$ 在 $F$ 上一致连续
...
\begin{aligned}
|F'(x_0)-f(x_0)|=&\left|\lim_{h\to 0}\frac{1}{h}\left(\int_{[a,x_0+h]}f(x)dx-\int_{[a,x_0]}f(x)dx\right)-f(x_0)\right|\\
=&\left|\lim_{h\to 0}\frac{1}{h}\int_{[x_0,x_0+h]}f(x)dx-f(x_0)\right|\\
=&\left|\lim_{h\to 0}\frac{1}{h}\left(\int_{[x_0,x_0+h]}f(x)dx-hf(x_0)\right)\right|\\
=&\left|\lim_{h\to 0}\frac{1}{h}\int_{[x_0,x_0+h]}f(x)-f(x_0)dx\right|\\
=&\left|\lim_{h\to 0}\frac{1}{h}\int_{[x_0,x_0+h]}f(x_0+t)-f(x_0)dt\right|
\end{aligned}
...
有 $-\epsilon<f(\vec{x})-f(\vec{x}_0)<\epsilon$ 根据[[MK372][推论]]以及[[MK213][积分定义]]有

\begin{aligned}
&\frac{1}{h}\int_{[x_0,x_0+h]}f(x_0+t)-f(x_0)dt\\
\Rightarrow&\frac{1}{h}\int_{[x_0,x_0+h]}-\epsilon dt\leq\frac{1}{h}\int_{[x_0,x_0+h]}f(x_0+t)-f(x_0)dt\leq\frac{1}{h}\int_{[x_0,x_0+h]}\epsilon dt\\
\Rightarrow&-\frac{1}{h}h\epsilon\leq\frac{1}{h}\int_{[x_0,x_0+h]}f(x_0+t)-f(x_0)dt\leq\frac{1}{h}h\epsilon\\
\Rightarrow&-\epsilon\leq\frac{1}{h}\int_{[x_0,x_0+h]}f(x_0+t)-f(x_0)dt\leq\epsilon\\
\end{aligned}

综上所述，对于任意 $\epsilon>0$ 存在 $\delta$ 对于任意 $h<\delta$ 均有 $$\left|\frac{1}{h}\int_{[x_0,x_0+h]}f(x_0+t)-f(x_0)dt-0\right|<\epsilon$$
...
又根据定义 $E$ 可测， $f(x)$ 可测，故根据[[MK361][鲁津定理]]可得存在[[~/文档/note/数学分析/Chap11Note.org::MK13][闭集]] $F$ 满足：
...
由于 $F$ 是闭集，根据[[~/文档/note/数学分析/Chap11Note.org::P4][定理5]]可得 $F\cap[-\infty,x],F\cap[x,+\infty]$ 均为闭集

进一步由于[[~/文档/note/数学分析/Chap11Note.org::MK35][定理9]]可得 $S(x)\in F\cap[-\infty,x]\land I(x)\in F\cap[x,+\infty]$ 继而 $S(x)\in F\land I(x)\in F$
...
设 $f(x)$ 在 $[a,b]$ 上[[MK237][勒贝格可积]]，则其[[MK377][不定积分]] $$F(x)=\int_{[a,x]}f(t)dt+C$$ 其中 $C\in\mathbb{R}$ 是任意常数
...
设 $f(x)$ 是 $[a,b]$ 上的[[MK384][绝对连续函数]]，则有 $$f(x)=\int_{[a,x]}f'(t)dt+f(a)$$

**** 证明

定义 $$h(x)=\int_{[a,x]}f'(t)dt-f(x)$$ 则有 $$h'(x)=\frac{d}{dx}\left(\int_{[a,x]}f'(t)dt\right)-f'(x)$$

根据[[MK393][定理1]]可得 $$h'(x)=f'(x)-f'(x)=0$$ 即对于任意 $x\in[a,b]$ 均有 $h'(x)=0$

根据条件 $f(x)$ 是[[MK384][绝对连续函数]]，根据[[MK394][定理3]]可得 $f'(x)$ 在 $[a,b]$ 上[[MK237][勒贝格可积]]

根据[[MK388][定理1]]可得 $$\int_{[a,x]}f'(t)dt$$ 是[[MK384][绝对连续函数]]，故根据[[MK392][运算]]可得 $$h(x)=\int_{[a,x]}f'(t)dt-f(x)$$ 是绝对连续函数

进一步根据[[MK395][定理3]]可得 $h(x)=h(a)=-f(a)$ 即有 $$-f(a)=\int_{[a,x]}f'(t)dt-f(x)$$

故最终可得 $$f(x)=\int_{[a,x]}f'(t)dt+f(a)$$
