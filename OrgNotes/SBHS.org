...
定义[[~/OneDrive/离散数学/Disc_Math.org::MK12][集合族]] $\{A_i\}_{i\in\mathbb{N}}$ 其中[[~/OneDrive/离散数学/Disc_Math.org][集合论-集合定义-集合族-标志集]]是正整数
...
定义对于[[~/OneDrive/离散数学/Disc_Math.org::MK12][集合族]] $A$ 的[[~/OneDrive/离散数学/Disc_Math.org][集合论-计算-广义并]]为 $\bigcup A$ 同理定义广义交为 $\bigcap A$
