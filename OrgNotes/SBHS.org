...
假设 $z\in\mathbb{R}$ 则根据[[MK19][阿基米德性质]]存在 $i\in\mathbb{N}>z$ 即 $z\not\in(i,\infty]$ 矛盾
...
定义 $E[f>a]=\left\{x\big|f(x)>a\land x\in E\right\}$ 以及 $\mathcal{M}\subset\rho(X)$ 是 $X$ 上所有的[[MK65][外测度可测集]]族
...
若[[MK133][广义实值函数]] $f:E\to\mathbb{R}\cup\{-\infty,+\infty\},E\subset X$ 是[[MK134][可测函数]]
