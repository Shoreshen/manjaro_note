...
根据[[~/OneDrive/数学分析/Chap11Note.org::MK25][距离定义]]有 $\sqrt{\sum_{i=1}^p(x_i-x_{0,i})^2+\sum_{i=1}^q(y_i-y_{0,i})^2}<\delta$ 即 $\sum_{i=1}^p(x_i-x_{0,i})^2+\sum_{i=1}^q(y_i-y_{0,i})^2<\delta^2$ 
