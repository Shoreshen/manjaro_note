...
设 $\mathcal{V}=\left<V,K,\hat{+},\hat{\cdot}\right>$ 是[[~/文档/note/抽象代数/cxds.org::MK338][域]] $\mathcal{K}=\left<K,\mathfrak{g}\right>$ 上的[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK1][线性空间]]，对于任意 $\sigma\in\text{Hom}(\mathcal{V},\mathcal{V})$ [[MK4][线性变换]]
...
（1） $\ker(f(\sigma))=\ker(f_1(\sigma))\bar{+}\ker(f_2(\sigma))$

（2） [[MK22][核空间]] $\mathcal{V}_{f(\sigma)}=\left<\ker(f(\sigma)),K,\hat{ +},\hat{\cdot})\right>,\mathcal{V}_{f_1(\sigma)}=\left<\ker(f_1(\sigma)),K,\hat{ +},\hat{\cdot})\right>,\mathcal{V}_{f_2(\sigma)}=\left<\ker(f_2(\sigma)),K,\hat{ +},\hat{\cdot})\right>$
...
（3） $\bar{+}$ 为[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK86][子空间加法]]
...
****** $\ker(f_1(\sigma))\bar{+}\ker(f_2(\sigma))\subset \ker(f(\sigma))$
...
对于任意 $a\in \ker(f_1(\sigma))\bar{ +}\ker(f_2(\sigma))$ 有 $a_1\in \ker(f_1(\sigma)),a_2\in \ker(f_2(\sigma))$ 满足 $a=a_1\hat{ +}a_2$ 根据上述证明有 $\{a_1,a_2\}\in \ker(f(\sigma))$

由于 $\ker(f(\sigma))$ 对于 $\hat{+}$ 封闭，故可得 $a=a_1\hat{ +}a_2\in \ker(f(\sigma))$

****** $\ker(f(\sigma))\subset \ker(f_1(\sigma))\bar{+}\ker(f_2(\sigma))$ <<MK67>>
...
则对于任意 $a\in \ker(f(\sigma))$ 根据[[MK9][相等]]以及[[MK5][加法]]可得 $a=\sigma_1(a)=I(f_\times)(u(\sigma), f_1(\sigma))(a)\hat{+}I(f_\times)(v(\sigma), f_2(\sigma))(a)$
...
满足 $I(f_\times)(u(\sigma), f_1(\sigma))(a)\hat{+}I(f_\times)(v(\sigma), f_2(\sigma))(a)=a$ 即 $a\in \ker(f_1(\sigma))\bar{ +}\ker(f_2(\sigma))$

故有 $\ker(f(\sigma))\subset \ker(f_1(\sigma))\bar{+}\ker(f_2(\sigma))$ 
...
则根据[[MK9][相等]]以及[[MK5][加法]]有 $a=\sigma_1(a)=I(f_\times)(u(\sigma), f_1(\sigma))(a)\hat{+}I(f_\times)(v(\sigma), f_2(\sigma))(a)$

根据[[MK9][相等]]、[[MK17][乘法]]可得 $a=\sigma_1(a)=u(\sigma)(f_1(\sigma)(a))\hat{+}v(\sigma)(f_2(\sigma)(a))$ 由于 $a\in\ker(f_1(\sigma)\cap f_2(\sigma))$

故根据[[MK22][零元映射]]有 $a=\sigma_1(a)=u(\sigma)(0)\hat{+}v(\sigma)(0)=0\hat{ +}0=0$ 即 $\ker(f_1(\sigma)\cap f_2(\sigma))=\{0\}$

则根据[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK69][性质1]]可得 $\mathcal{V}_{f_1(\sigma)}\bar{+}\mathcal{V}_{f_2(\sigma)}$ 为[[~/文档/note/高等代数/Algb-2-Liner_Space.org::MK83][直和]]，结合结论（1）有 $\mathcal{V}_{f(\sigma)}=\mathcal{V}_{f_1(\sigma)}\oplus\mathcal{V}_{f_2(\sigma)}$
