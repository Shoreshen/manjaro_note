...
设 $\mathcal{V}=<V,K,+,\cdot>$ 是[[~/OneDrive/高等代数/Algb-1-Liner_sys_func.org::MK24][数域]] $K$ 上的[[~/OneDrive/高等代数/Algb-2-Liner_Space.org::MK1][线性空间]] $\sigma:V\to V$ 是 $\mathcal{V}$ 上的线性变换
