...
任意[[MK12][交换环]] $\mathcal{U}=\left<U,+,\cdot\right>$ 存在乘法[[~/OneDrive/离散数学/Disc_Math.org::MK313][零元]]，且等于[[MK10][环定义]]中加法幺元
...
有环 $U,V$ 若存在[[~/OneDrive/离散数学/Disc_Math.org::MK200][双射函数]] $\sigma:U\rightarrow V$ 满足对于任意 $\{a,b\}\subset U$ ：
...
根据[[~/OneDrive/离散数学/lssx.org::MK107][笛卡尔积]]以及[[~/OneDrive/离散数学/lssx.org::MK111][基础定义]]定义关系 $R=\left\{\left<a,b\right>\in Z\times Z\big|a\mod m=b\mod m\right\}$

根据[[~/OneDrive/离散数学/lssx.org::MK113][等价关系]]可知 $R$ 满足自反性，对称性以及传递性，故 $R$ 为等价关系

则根据[[~/OneDrive/离散数学/lssx.org::138][定理1]] $R$ 的[[~/OneDrive/离散数学/lssx.org::MK133][等价类]]划分 $\mathbb{Z}$
...
故定义集合 $U=\left\{\overline{x}\big|x\in\mathbb{Z}\right\}$ 由于 $m$ 的余数是小于 $m$ 的整数，故 $U$ 的[[~/OneDrive/离散数学/lssx.org::MK35][基数]]是 $|U|=m$
